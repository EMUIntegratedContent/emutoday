	...
	var calendarGenerators = {
		google: function (event) {
			...
			return (
				...
				href +
				'">Google Calendar</a> <span class="hint">(Web Link)</span>'
			)
		},
		...
		ics: function (event, eClass, calendarName) {
			...
			if (eClass === "icon-ical") {
				hint =
					"(Universal for Apple Calendar, Yahoo, Thunderbird, and desktop apps)"
			} else {
				hint = "(Web Link)"
			}
			...
			return (
				...
				'">' +
				calendarName +
				'</a> <span class="hint">(Web Link)</span>'
			)
		},

		ical: function (event) {
			return this.ics(event, "icon-ical", "Download .ics File")
		},
