...
exports.default = {
    ...
    methods: {
        ...
        getTokens: function getTokens() {
            ...
            _axios2.default.get('/oauth/personal-access-tokens').then(function (response) {
        ...
        getScopes: function getScopes() {
            ...
            _axios2.default.get('/oauth/scopes').then(function (response) {
        ...
        store: function store() {
            ...
            _axios2.default.post('/oauth/personal-access-tokens', this.form).then(function (response) {
                _this3.form.name = '';
                _this3.form.scopes = [];
                _this3.form.errors = [];
        ...
        revoke: function revoke(token) {
            ...
            _axios2.default.delete('/oauth/personal-access-tokens/' + token.id).then(function (response) {
                _this4.getTokens();
            });
        }
    }
...
var _PersonalAccessTokens2 = _interopRequireDefault(_PersonalAccessTokens);
...
new Vue({
    ...
    components: { PersonalAccessTokens: _PersonalAccessTokens2.default }
});

},{"./components/passport/PersonalAccessTokens.vue":99,"vue":97}]},{},[100]);

//# sourceMappingURL=vue-oauth-personal-access-tokens.js.map
