...
var __vueify_style__ = __vueify_insert__.insert("\n.action-link[_v-bbad7bcc] {\n    cursor: pointer;\n}\n\n.m-b-none[_v-bbad7bcc] {\n    margin-bottom: 0;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-bbad7bcc=\"\">\n    <div _v-bbad7bcc=\"\">\n        <div class=\"panel panel-default\" _v-bbad7bcc=\"\">\n            <div class=\"panel-heading\" _v-bbad7bcc=\"\">\n                <div style=\"display: flex; justify-content: space-between; align-items: center;\" _v-bbad7bcc=\"\">\n                    <span _v-bbad7bcc=\"\">\n                        Personal Access Tokens\n                    </span>\n\n                    <a class=\"action-link\" @click=\"showCreateTokenForm\" _v-bbad7bcc=\"\">\n                        Create New Token\n                    </a>\n                </div>\n            </div>\n\n            <div class=\"panel-body\" _v-bbad7bcc=\"\">\n                <!-- No Tokens Notice -->\n                <p class=\"m-b-none\" v-if=\"tokens.length === 0\" _v-bbad7bcc=\"\">\n                    You have not created any personal access tokens.\n                </p>\n\n                <!-- Personal Access Tokens -->\n                <table class=\"table table-borderless m-b-none\" v-if=\"tokens.length > 0\" _v-bbad7bcc=\"\">\n                    <thead _v-bbad7bcc=\"\">\n                        <tr _v-bbad7bcc=\"\">\n                            <th _v-bbad7bcc=\"\">Name</th>\n                            <th _v-bbad7bcc=\"\"></th>\n                        </tr>\n                    </thead>\n\n                    <tbody _v-bbad7bcc=\"\">\n                        <tr v-for=\"token in tokens\" _v-bbad7bcc=\"\">\n                            <!-- Client Name -->\n                            <td style=\"vertical-align: middle;\" _v-bbad7bcc=\"\">\n                                {{ token.name }}\n                            </td>\n\n                            <!-- Delete Button -->\n                            <td style=\"vertical-align: middle;\" _v-bbad7bcc=\"\">\n                                <a class=\"action-link text-danger\" @click=\"revoke(token)\" _v-bbad7bcc=\"\">\n                                    Delete\n                                </a>\n                            </td>\n                        </tr>\n                    </tbody>\n                </table>\n            </div>\n        </div>\n    </div>\n\n    <!-- Create Token Modal -->\n    <div class=\"modal fade\" id=\"modal-create-token\" tabindex=\"-1\" role=\"dialog\" _v-bbad7bcc=\"\">\n        <div class=\"modal-dialog\" _v-bbad7bcc=\"\">\n            <div class=\"modal-content\" _v-bbad7bcc=\"\">\n                <div class=\"modal-header\" _v-bbad7bcc=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-bbad7bcc=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-bbad7bcc=\"\">\n                        Create Token\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-bbad7bcc=\"\">\n                    <!-- Form Errors -->\n                    <div class=\"alert alert-danger\" v-if=\"form.errors.length > 0\" _v-bbad7bcc=\"\">\n                        <p _v-bbad7bcc=\"\"><strong _v-bbad7bcc=\"\">Whoops!</strong> Something went wrong!</p>\n                        <br _v-bbad7bcc=\"\">\n                        <ul _v-bbad7bcc=\"\">\n                            <li v-for=\"error in form.errors\" _v-bbad7bcc=\"\">\n                                {{ error }}\n                            </li>\n                        </ul>\n                    </div>\n\n                    <!-- Create Token Form -->\n                    <form class=\"form-horizontal\" role=\"form\" @submit.prevent=\"store\" _v-bbad7bcc=\"\">\n                        <!-- Name -->\n                        <div class=\"form-group\" _v-bbad7bcc=\"\">\n                            <label class=\"col-md-4 control-label\" _v-bbad7bcc=\"\">Name</label>\n\n                            <div class=\"col-md-6\" _v-bbad7bcc=\"\">\n                                <input id=\"create-token-name\" type=\"text\" class=\"form-control\" name=\"name\" v-model=\"form.name\" _v-bbad7bcc=\"\">\n                            </div>\n                        </div>\n\n                        <!-- Scopes -->\n                        <div class=\"form-group\" v-if=\"scopes.length > 0\" _v-bbad7bcc=\"\">\n                            <label class=\"col-md-4 control-label\" _v-bbad7bcc=\"\">Scopes</label>\n\n                            <div class=\"col-md-6\" _v-bbad7bcc=\"\">\n                                <div v-for=\"scope in scopes\" _v-bbad7bcc=\"\">\n                                    <div class=\"checkbox\" _v-bbad7bcc=\"\">\n                                        <label _v-bbad7bcc=\"\">\n                                            <input type=\"checkbox\" @click=\"toggleScope(scope.id)\" :checked=\"scopeIsAssigned(scope.id)\" _v-bbad7bcc=\"\">\n\n                                                {{ scope.id }}\n                                        </label>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-bbad7bcc=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-bbad7bcc=\"\">Close</button>\n\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"store\" _v-bbad7bcc=\"\">\n                        Create\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- Access Token Modal -->\n    <div class=\"modal fade\" id=\"modal-access-token\" tabindex=\"-1\" role=\"dialog\" _v-bbad7bcc=\"\">\n        <div class=\"modal-dialog\" _v-bbad7bcc=\"\">\n            <div class=\"modal-content\" _v-bbad7bcc=\"\">\n                <div class=\"modal-header\" _v-bbad7bcc=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-bbad7bcc=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-bbad7bcc=\"\">\n                        Personal Access Token\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-bbad7bcc=\"\">\n                    <p _v-bbad7bcc=\"\">\n                        Here is your new personal access token. This is the only time it will be shown so don't lose it!\n                        You may now use this token to make API requests.\n                    </p>\n\n                    <pre _v-bbad7bcc=\"\"><code _v-bbad7bcc=\"\">{{ accessToken }}</code></pre>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-bbad7bcc=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-bbad7bcc=\"\">Close</button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-bbad7bcc", module.exports)
  } else {
    hotAPI.update("_v-bbad7bcc", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
