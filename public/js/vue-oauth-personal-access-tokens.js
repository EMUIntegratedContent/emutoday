...
var __vueify_style__ = __vueify_insert__.insert("\n.action-link[_v-1dce264f] {\n    cursor: pointer;\n}\n\n.m-b-none[_v-1dce264f] {\n    margin-bottom: 0;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-1dce264f=\"\">\n    <div _v-1dce264f=\"\">\n        <div class=\"panel panel-default\" _v-1dce264f=\"\">\n            <div class=\"panel-heading\" _v-1dce264f=\"\">\n                <div style=\"display: flex; justify-content: space-between; align-items: center;\" _v-1dce264f=\"\">\n                    <span _v-1dce264f=\"\">\n                        Personal Access Tokens\n                    </span>\n\n                    <a class=\"action-link\" @click=\"showCreateTokenForm\" _v-1dce264f=\"\">\n                        Create New Token\n                    </a>\n                </div>\n            </div>\n\n            <div class=\"panel-body\" _v-1dce264f=\"\">\n                <!-- No Tokens Notice -->\n                <p class=\"m-b-none\" v-if=\"tokens.length === 0\" _v-1dce264f=\"\">\n                    You have not created any personal access tokens.\n                </p>\n\n                <!-- Personal Access Tokens -->\n                <table class=\"table table-borderless m-b-none\" v-if=\"tokens.length > 0\" _v-1dce264f=\"\">\n                    <thead _v-1dce264f=\"\">\n                        <tr _v-1dce264f=\"\">\n                            <th _v-1dce264f=\"\">Name</th>\n                            <th _v-1dce264f=\"\"></th>\n                        </tr>\n                    </thead>\n\n                    <tbody _v-1dce264f=\"\">\n                        <tr v-for=\"token in tokens\" _v-1dce264f=\"\">\n                            <!-- Client Name -->\n                            <td style=\"vertical-align: middle;\" _v-1dce264f=\"\">\n                                {{ token.name }}\n                            </td>\n\n                            <!-- Delete Button -->\n                            <td style=\"vertical-align: middle;\" _v-1dce264f=\"\">\n                                <a class=\"action-link text-danger\" @click=\"revoke(token)\" _v-1dce264f=\"\">\n                                    Delete\n                                </a>\n                            </td>\n                        </tr>\n                    </tbody>\n                </table>\n            </div>\n        </div>\n    </div>\n\n    <!-- Create Token Modal -->\n    <div class=\"modal fade\" id=\"modal-create-token\" tabindex=\"-1\" role=\"dialog\" _v-1dce264f=\"\">\n        <div class=\"modal-dialog\" _v-1dce264f=\"\">\n            <div class=\"modal-content\" _v-1dce264f=\"\">\n                <div class=\"modal-header\" _v-1dce264f=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-1dce264f=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-1dce264f=\"\">\n                        Create Token\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-1dce264f=\"\">\n                    <!-- Form Errors -->\n                    <div class=\"alert alert-danger\" v-if=\"form.errors.length > 0\" _v-1dce264f=\"\">\n                        <p _v-1dce264f=\"\"><strong _v-1dce264f=\"\">Whoops!</strong> Something went wrong!</p>\n                        <br _v-1dce264f=\"\">\n                        <ul _v-1dce264f=\"\">\n                            <li v-for=\"error in form.errors\" _v-1dce264f=\"\">\n                                {{ error }}\n                            </li>\n                        </ul>\n                    </div>\n\n                    <!-- Create Token Form -->\n                    <form class=\"form-horizontal\" role=\"form\" @submit.prevent=\"store\" _v-1dce264f=\"\">\n                        <!-- Name -->\n                        <div class=\"form-group\" _v-1dce264f=\"\">\n                            <label class=\"col-md-4 control-label\" _v-1dce264f=\"\">Name</label>\n\n                            <div class=\"col-md-6\" _v-1dce264f=\"\">\n                                <input id=\"create-token-name\" type=\"text\" class=\"form-control\" name=\"name\" v-model=\"form.name\" _v-1dce264f=\"\">\n                            </div>\n                        </div>\n\n                        <!-- Scopes -->\n                        <div class=\"form-group\" v-if=\"scopes.length > 0\" _v-1dce264f=\"\">\n                            <label class=\"col-md-4 control-label\" _v-1dce264f=\"\">Scopes</label>\n\n                            <div class=\"col-md-6\" _v-1dce264f=\"\">\n                                <div v-for=\"scope in scopes\" _v-1dce264f=\"\">\n                                    <div class=\"checkbox\" _v-1dce264f=\"\">\n                                        <label _v-1dce264f=\"\">\n                                            <input type=\"checkbox\" @click=\"toggleScope(scope.id)\" :checked=\"scopeIsAssigned(scope.id)\" _v-1dce264f=\"\">\n\n                                                {{ scope.id }}\n                                        </label>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-1dce264f=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-1dce264f=\"\">Close</button>\n\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"store\" _v-1dce264f=\"\">\n                        Create\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- Access Token Modal -->\n    <div class=\"modal fade\" id=\"modal-access-token\" tabindex=\"-1\" role=\"dialog\" _v-1dce264f=\"\">\n        <div class=\"modal-dialog\" _v-1dce264f=\"\">\n            <div class=\"modal-content\" _v-1dce264f=\"\">\n                <div class=\"modal-header\" _v-1dce264f=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-1dce264f=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-1dce264f=\"\">\n                        Personal Access Token\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-1dce264f=\"\">\n                    <p _v-1dce264f=\"\">\n                        Here is your new personal access token. This is the only time it will be shown so don't lose it!\n                        You may now use this token to make API requests.\n                    </p>\n\n                    <pre _v-1dce264f=\"\"><code _v-1dce264f=\"\">{{ accessToken }}</code></pre>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-1dce264f=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-1dce264f=\"\">Close</button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1dce264f", module.exports)
  } else {
    hotAPI.update("_v-1dce264f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/passport/PersonalAccessTokens.vue":98,"vue":96}]},{},[99]);
