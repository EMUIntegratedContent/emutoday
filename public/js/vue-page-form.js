...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<!-- Modal -->\n<div id=\"deleteModal\" class=\"modal fade\" role=\"dialog\" _v-77a3ff0f=\"\">\n  <div class=\"modal-dialog\" _v-77a3ff0f=\"\">\n    <!-- Modal content-->\n    <div class=\"modal-content\" _v-77a3ff0f=\"\">\n      <div class=\"modal-header\" _v-77a3ff0f=\"\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" _v-77a3ff0f=\"\">×</button>\n        <h4 class=\"modal-title\" _v-77a3ff0f=\"\">Delete hub page</h4>\n      </div>\n      <div class=\"modal-body\" _v-77a3ff0f=\"\">\n        <p _v-77a3ff0f=\"\">Are you sure you want to delete this hub page? Type the word <strong _v-77a3ff0f=\"\">\"delete\"</strong> to confirm.</p>\n        <div class=\"form-group\" _v-77a3ff0f=\"\">\n          <label for=\"deleteConfirm\" class=\"sr-only\" aria-hidden=\"true\" _v-77a3ff0f=\"\">Type \"confirm\" to delete</label>\n          <input type=\"text\" v-model=\"deleteConfirm\" class=\"form-control\" id=\"deleteConfirm\" _v-77a3ff0f=\"\">\n        </div>\n      </div>\n      <div class=\"modal-footer\" _v-77a3ff0f=\"\">\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-77a3ff0f=\"\">Cancel</button>\n        <button type=\"button\" class=\"btn btn-danger\" data-dismiss=\"modal\" @click=\"delPage\" :disabled=\"deleteConfirm != 'delete'\" _v-77a3ff0f=\"\">Delete Page</button>\n      </div>\n    </div>\n  </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-77a3ff0f", module.exports)
  } else {
    hotAPI.update("_v-77a3ff0f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.progress-done[_v-3ff02d72]{\n  background-color: #3D9970 !important;\n}\n.valid[_v-3ff02d72]{\n  color:#3c763d;\n}\n\n.invalid[_v-3ff02d72] {\n  color: #ff0000;\n}\n\n.valid-titleField[_v-3ff02d72] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-3ff02d72] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-3ff02d72] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-3ff02d72=\"\">\n    <!-- PROGRESS BAR -->\n    <div class=\"progress\" _v-3ff02d72=\"\">\n      <div v-if=\"numLoadedComponents >= 5\" class=\"progress-bar\" :class=\"progress == 100 ? 'progress-done' : ''\" role=\"progressbar\" :aria-valuenow=\"progress\" aria-valuemin=\"0\" aria-valuemax=\"100\" :style=\"'width:' + progress + '%'\" _v-3ff02d72=\"\">\n        <span v-if=\"progress < 100\" _v-3ff02d72=\"\">{{ progress }}% Complete</span>\n        <span v-else=\"\" _v-3ff02d72=\"\">I'm Ready!</span>\n      </div>\n      <div v-else=\"\" class=\"progress-bar progress-bar-striped progress-bar-danger active\" role=\"progressbar\" :aria-valuenow=\"100\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width:100%\" _v-3ff02d72=\"\">\n        <span _v-3ff02d72=\"\">Loading page...please wait.</span>\n      </div>\n    </div>\n    <section id=\"page-builder-container\" _v-3ff02d72=\"\">\n        <div class=\"row\" id=\"main-story\" _v-3ff02d72=\"\">\n            <div class=\"col-sm-12 col-md-12 col-lg-6 columns\" _v-3ff02d72=\"\">\n                <h4 class=\"subhead-title\" _v-3ff02d72=\"\">Main Story</h4>\n                <page-substory story-number=\"0\" :story=\"slotStories.main_story\" :stypes=\"stypes\" _v-3ff02d72=\"\"></page-substory>\n            </div>\n            <div class=\"col-sm-12 col-md-12 col-lg-6 columns\" _v-3ff02d72=\"\">\n                <div class=\"row\" id=\"date-time-container\" _v-3ff02d72=\"\">\n                    <div class=\"col-sm-12\" _v-3ff02d72=\"\">\n                        <h4 class=\"subhead-title\" _v-3ff02d72=\"\">Hub Page Information</h4>\n                    </div>\n                    <div class=\"col-sm-12 col-md-6\" _v-3ff02d72=\"\">\n                        <label _v-3ff02d72=\"\">Start Date/Time *</label>\n                        <input id=\"start-date\" type=\"text\" v-model=\"record.start_date\" class=\"form-control\" v-bind:class=\"[formErrors.start_date ? 'invalid-input' : '']\" _v-3ff02d72=\"\">\n                        <p v-if=\"formErrors.start_date\" class=\"help-text invalid\" _v-3ff02d72=\"\">A start date is required.</p>\n                    </div>\n                    <div class=\"col-sm-12 col-md-6\" _v-3ff02d72=\"\">\n                        <label _v-3ff02d72=\"\">End Date/Time *</label>\n                        <input id=\"end-date\" type=\"text\" v-model=\"record.end_date\" class=\"form-control\" v-bind:class=\"[formErrors.end_date ? 'invalid-input' : '']\" _v-3ff02d72=\"\">\n                        <p v-if=\"formErrors.end_date\" class=\"help-text invalid\" _v-3ff02d72=\"\">An end date is required.</p>\n                    </div>\n                    <!--<div class=\"col-sm-12 col-md-6\">\n                        <label>Active?</label>\n                        <input type=\"checkbox\" v-model=\"record.live\" />\n                    </div>-->\n                </div><!-- /end #date-time-container -->\n                <!-- SUCCESS/FAIL MESSAGES -->\n                <div class=\"row\" _v-3ff02d72=\"\">\n                  <div class=\"col-xs-12\" _v-3ff02d72=\"\">\n                    <div v-show=\"formMessage.isOk\" class=\"alert alert-success alert-dismissible\" _v-3ff02d72=\"\">\n                      <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-3ff02d72=\"\"><i class=\"fa fa-times\" _v-3ff02d72=\"\"></i></button>\n                      <p _v-3ff02d72=\"\">{{formMessage.msg}}</p>\n                    </div>\n                    <div v-show=\"formMessage.isErr\" class=\"alert alert-danger alert-dismissible\" _v-3ff02d72=\"\">\n                      <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-3ff02d72=\"\"><i class=\"fa fa-times\" _v-3ff02d72=\"\"></i></button>\n                      <p _v-3ff02d72=\"\">The hub page could not be {{ newpage ? 'created' : 'updated' }}. Please fix the following errors.</p>\n                      <ul v-if=\"formErrors\" _v-3ff02d72=\"\">\n                        <li v-for=\"error in formErrors\" _v-3ff02d72=\"\">{{error}}</li>\n                      </ul>\n                    </div>\n                  </div>\n                  <div class=\"col-xs-12 text-right\" _v-3ff02d72=\"\">\n                    <button class=\"btn btn-success\" type=\"button\" @click=\"submitForm\" _v-3ff02d72=\"\">{{ newpage ? 'Create Hub Page' : 'Update Hub Page' }}</button>\n                    <button v-show=\"!newpage\" type=\"button\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#deleteModal\" _v-3ff02d72=\"\">Delete Hub Page</button>\n                  </div>\n                </div>\n            </div>\n        </div>\n        <div id=\"four-stories-bar\" _v-3ff02d72=\"\">\n            <div class=\"row\" _v-3ff02d72=\"\">\n                <div class=\"col-xs-12\" _v-3ff02d72=\"\">\n                    <h4 class=\"subhead-title\" _v-3ff02d72=\"\">Sub Stories</h4>\n                </div>\n            </div>\n            <div class=\"row\" _v-3ff02d72=\"\">\n                <div class=\"col-sm-12 col-md-6 col-lg-3\" _v-3ff02d72=\"\">\n                    <page-substory story-number=\"1\" :story=\"slotStories.sub_story_1\" :stypes=\"stypes\" _v-3ff02d72=\"\"></page-substory>\n                </div>\n                <div class=\"col-sm-12 col-md-6 col-lg-3\" _v-3ff02d72=\"\">\n                    <page-substory story-number=\"2\" :story=\"slotStories.sub_story_2\" :stypes=\"stypes\" _v-3ff02d72=\"\"></page-substory>\n                </div>\n                <div class=\"col-sm-12 col-md-6 col-lg-3\" _v-3ff02d72=\"\">\n                    <page-substory story-number=\"3\" :story=\"slotStories.sub_story_3\" :stypes=\"stypes\" _v-3ff02d72=\"\"></page-substory>\n                </div>\n                <div class=\"col-sm-12 col-md-6 col-lg-3\" _v-3ff02d72=\"\">\n                    <page-substory story-number=\"4\" :story=\"slotStories.sub_story_4\" :stypes=\"stypes\" _v-3ff02d72=\"\"></page-substory>\n                </div>\n            </div>\n        </div>\n    </section><!-- end #page-builder-container -->\n</div><!-- /end root element -->\n<page-delete-modal :page=\"record\" _v-3ff02d72=\"\"></page-delete-modal>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3ff02d72", module.exports)
  } else {
    hotAPI.update("_v-3ff02d72", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.box[_v-3b618a13] {\n    color: #1B1B1B;\n    margin-bottom: 10px;\n}\n.box-body[_v-3b618a13] {\n    background-color: #fff;\n    border-bottom-left-radius: 0;\n    border-bottom-right-radius: 0;\n    margin:0;\n}\n\n.box-header[_v-3b618a13] {\n    padding: 3px;\n}\n.box-footer[_v-3b618a13] {\n    padding: 3px;\n}\n\n#storyform[_v-3b618a13] {\n    display:-webkit-inline-box;\n    display:-ms-inline-flexbox;\n    display:inline-flex;\n}\n.form-group[_v-3b618a13] {\n    margin-bottom: 2px;\n}\n#applabel[_v-3b618a13]{\n    margin-left: 2px;\n    margin-right: 2px;\n    padding-left: 2px;\n    padding-right: 2px;\n}\n\n.btn-group[_v-3b618a13],\n.btn-group-vertical[_v-3b618a13] {\n    display:-webkit-inline-box;\n    display:-ms-inline-flexbox;\n    display:inline-flex;\n}\nh5.box-footer[_v-3b618a13] {\n    padding: 3px;\n}\nbutton.footer-btn[_v-3b618a13] {\n    border-color: #1B1B1B;\n\n}\nh6.box-title[_v-3b618a13] {\n    font-size: 16px;\n    color: #1B1B1B;\n}\n.callout[_v-3b618a13] {\n    position: relative;\n    background: #ddd;\n    padding: 1em;\n    margin: 0;\n}\n.callout .callout-danger[_v-3b618a13] {\n    background: #ff0000;\n    color:#000000;\n    /*border: 1px solid #000000;*/\n}\n\n.callout .callout-success[_v-3b618a13] {\n    background: #00ff00;\n    color:#000000;\n    /*border: 1px solid #000000;*/\n}\n\n.Alert__close[_v-3b618a13] {\n    position: absolute;\n    top: 1em;\n    right: 1em;\n    font-weight: bold;\n    cursor: pointer;\n}\n.bg-hub[_v-3b618a13] {\n    background-color: #76D7EA;\n}\n.emutoday[_v-3b618a13] {\n\n    background-color: #76D7EA;\n    border: 1px solid #76D7EA\n}\n.student[_v-3b618a13] {\n    color: #1B1B1B;\n    background-color: #FED85D;\n    border: 1px solid #FED85D\n}\n.news[_v-3b618a13]  {\n    color: #1B1B1B;\n    background-color: #cccccc;\n    border: 1px solid #cccccc;\n}\n.external[_v-3b618a13]  {\n    color: #1B1B1B;\n    background-color: #C9A0DC;\n    border: 1px solid #C9A0DC;\n}\n.article[_v-3b618a13]  {\n    color: #1B1B1B;\n    background-color: #29AB87;\n    border: 1px solid #29AB87;\n}\n.advisory[_v-3b618a13]  {\n    color: #1B1B1B;\n    background-color: #CD5C5C;\n    border: 1px solid #CD5C5C;\n}\n.statement[_v-3b618a13]  {\n    color: #1B1B1B;\n    background-color: #FFA500;\n    border: 1px solid #FFA500;\n}\n.featurephoto[_v-3b618a13]  {\n    color: #1B1B1B;\n    background-color: #488dd8;\n    border: 1px solid #488dd8;\n}\n.zcallout[_v-3b618a13] {\n    border-radius: 5px;\n    border-left: 50px solid #ff0000;\n}\n.zinfo-box-icon[_v-3b618a13] {\n    border-top-left-radius: 5px;\n    border-top-right-radius: 0;\n    border-bottom-right-radius: 0;\n    border-bottom-left-radius: 5px;\n    display: block;\n    float: left;\n    height: auto;\n    width: 60px;\n    text-align: center;\n    font-size: 45px;\n    line-height: 90px;\n    background: rgba(0,0,0,0.2);\n}\n.type-badge[_v-3b618a13] {\n    width: 30px;\n    height: 30px;\n    font-size: 15px;\n    line-height: 30px;\n    position: absolute;\n    color: #666;\n    background: #d2d6de;\n    border-radius: 50%;\n    text-align: center;\n    left: 18px;\n    top: 0;\n}\n\nselect.form-control[_v-3b618a13] {\n    height:22px;\n    border: 1px solid #999999;\n}\n\n\nh6[_v-3b618a13] {\n    margin-top: 0;\n    margin-bottom: 0;\n}\nh5[_v-3b618a13] {\n    margin-top: 0;\n    margin-bottom: 0;\n}\n.form-group[_v-3b618a13] {\n    /*border: 1px solid red;*/\n}\n.form-group label[_v-3b618a13]{\n    margin-bottom: 0;\n}\n\n.set[_v-3b618a13] {\n    background-color: #00a65a !important;\n    border: 2px solid #00a65a !important;\n}\n\n.special-item[_v-3b618a13] {\n    border-left: 6px solid #bfff00;\n\n    padding-left: 3px;\n    border-top-left-radius:3px;\n    border-bottom-left-radius: 3px;\n    margin-left: -10px;\n\n}\n.special-item-last[_v-3b618a13] {\n}\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div :class=\"specialItem\" _v-3b618a13=\"\">\n    <div class=\"box box-solid {{item.story_group.group}} {{ currentStory &amp;&amp; currentStory.id == item.id &amp;&amp; podType == 'queue' ? 'set' : '' }}\" _v-3b618a13=\"\">\n        <div class=\"box-header with-border\" _v-3b618a13=\"\">\n          <div class=\"row\" _v-3b618a13=\"\">\n              <div class=\"col-sm-8\" _v-3b618a13=\"\">\n                  <span v-show=\"currentStory &amp;&amp; currentStory.id == item.id &amp;&amp; podType == 'queue'\" class=\"success\" _v-3b618a13=\"\"><i class=\"fa fa-check\" _v-3b618a13=\"\"></i> Set</span>\n              </div>\n              <div class=\"col-sm-4\" _v-3b618a13=\"\">\n                  <div class=\"pull-right\" _v-3b618a13=\"\">\n                      <button type=\"btn btn-sm btn-info\" @click=\"emitSwapStory\" _v-3b618a13=\"\"><i :class=\"currentStory &amp;&amp; currentStory.id == item.id ? 'fa fa-times' : 'fa fa-exchange'\" aria-hidden=\"true\" _v-3b618a13=\"\"></i></button>\n                  </div>\n              </div>\n          </div><!-- /.row -->\n          <div class=\"row\" _v-3b618a13=\"\">\n            <a v-on:click.prevent=\"toggleBody\" href=\"#\" _v-3b618a13=\"\">\n              <div class=\"col-sm-9\" _v-3b618a13=\"\">\n                <h6 class=\"box-title\" _v-3b618a13=\"\"><label data-toggle=\"tooltip\" data-placement=\"top\" title=\"{{item.story_type}}\" _v-3b618a13=\"\"><span class=\"item-type-icon\" :class=\"typeIcon\" _v-3b618a13=\"\"></span></label>{{item.title}}</h6>\n              </div>\n            </a>\n          </div><!-- /.row -->\n        </div>  <!-- /.box-header -->\n\n      <div v-if=\"showBody\" class=\"box-body\" _v-3b618a13=\"\">\n            <p _v-3b618a13=\"\">ID: {{item.id}}</p>\n            <p _v-3b618a13=\"\">Type: {{item.story_type}}</p>\n            <p _v-3b618a13=\"\">Title: {{item.title}}</p>\n            <p _v-3b618a13=\"\">Ready: {{item.is_ready}}</p>\n            <p _v-3b618a13=\"\">Approved: {{item.is_approved}}</p>\n            <p _v-3b618a13=\"\">Promoted: {{item.is_promoted}}</p>\n            <p _v-3b618a13=\"\">Featured: {{item.is_featured}}</p>\n            <p _v-3b618a13=\"\">Live: {{item.is_live}}</p>\n            <p _v-3b618a13=\"\">Archived: {{item.is_archived}}</p>\n            <p _v-3b618a13=\"\">Start Date: {{item.start_date}}</p>\n      </div><!-- /.box-body -->\n            <div class=\"box-footer list-footer\" _v-3b618a13=\"\">\n                <div class=\"row\" _v-3b618a13=\"\">\n                    <div class=\"col-sm-6\" _v-3b618a13=\"\">\n                        Live {{ timefromNow }}\n                    </div><!-- /.col-md-6 -->\n                    <div class=\"col-sm-6\" _v-3b618a13=\"\">\n                        <div class=\"btn-group pull-right\" _v-3b618a13=\"\">\n                            <a :href=\"'/admin/queueall/story/' + item.story_type + '/' + item.id + '/edit'\" target=\"_blank\" class=\"btn bg-orange btn-xs footer-btn\" data-toggle=\"tooltip\" title=\"edit\" _v-3b618a13=\"\"><i class=\"fa fa-pencil\" _v-3b618a13=\"\"></i></a>\n                        </div>\n                    </div><!-- /.col-md-6 -->\n                </div><!-- /.row -->\n            </div><!-- /.box-footer -->\n    </div><!-- /.box- -->\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3b618a13", module.exports)
  } else {
    hotAPI.update("_v-3b618a13", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"moment":102,"vue":109,"vue-hot-reload-api":105,"vueify/lib/insert-css":110}],114:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\nh4[_v-056b61a8] {\n    margin-top: 3px;\n    font-size: 18px;\n}\n.btn-default[_v-056b61a8]:active, .btn-default.active[_v-056b61a8], .open > .dropdown-toggle.btn-default[_v-056b61a8] {\n    background-color: #605ca8;\n    color: #ffffff;\n\n}\n.btn-default[_v-056b61a8]:active, .btn-default.active[_v-056b61a8], .open > .dropdown-toggle.btn-default[_v-056b61a8] {\n    color: #ffffff;\n}\n\nspan.item-type-icon[_v-056b61a8]:active, span.item-type-icon.active[_v-056b61a8]{\n    background-color: #605ca8;\n    color: #ffffff;\n}\n\n#rangetoggle[_v-056b61a8]{\n    color: #FF851B;\n    margin-left: 5px;\n    border-bottom: 2px #FF851B dotted;\n}\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<!--STATS MODAL-->\n<div :id=\"'pageStorySwapModal-' + storyNumber\" class=\"modal fade\" role=\"dialog\" _v-056b61a8=\"\">\n  <div class=\"modal-dialog\" _v-056b61a8=\"\">\n    <div class=\"modal-content\" _v-056b61a8=\"\">\n      <div class=\"modal-header\" _v-056b61a8=\"\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" _v-056b61a8=\"\">×</button>\n        <h3 class=\"modal-title\" _v-056b61a8=\"\">Swap Story</h3>\n        <template v-if=\"storyNumber == 0\">\n            <p _v-056b61a8=\"\">Choose a <strong _v-056b61a8=\"\">main story</strong> for this hub page. The list below shows all stories in within the date range that have an emutoday_front story type.</p>\n        </template>\n        <template v-else=\"\">\n            <p _v-056b61a8=\"\">Choose a <strong _v-056b61a8=\"\">sub story</strong>. The list below shows all stories in within the date range that have an emutoday_small story type.</p>\n        </template>\n      </div>\n      <div class=\"modal-body\" _v-056b61a8=\"\">\n          <!-- Shows the current story pod (if one is selected) -->\n          <template v-if=\"currentStory\">\n              <h4 _v-056b61a8=\"\">Selected story for this slot</h4>\n              <page-story-pod :item=\"currentStory\" :current-story=\"currentStory\" _v-056b61a8=\"\">\n              </page-story-pod>\n          </template>\n          <template v-else=\"\">\n              <h4 _v-056b61a8=\"\">No story has been selected for this slot.</h4>\n          </template>\n          <hr _v-056b61a8=\"\">\n          <!-- FILTERS -->\n          <div class=\"row\" _v-056b61a8=\"\">\n              <!-- DATE filter -->\n              <div class=\"col-xs-12 col-sm-12 col-md-6\" _v-056b61a8=\"\">\n                  <form class=\"form\" _v-056b61a8=\"\">\n                    <div class=\"form-group\" _v-056b61a8=\"\">\n                        <label for=\"start-date\" _v-056b61a8=\"\">Starting <span v-if=\"isEndDate\" _v-056b61a8=\"\">between</span><span v-else=\"\" _v-056b61a8=\"\">on or after</span></label>\n                        <input v-if=\"startdate\" v-model=\"startdate\" type=\"text\" :initval=\"startdate\" v-flatpickr=\"startdate\" class=\"form-control\" _v-056b61a8=\"\">\n                    </div>\n                    <div v-if=\"isEndDate\" class=\"form-group\" _v-056b61a8=\"\">\n                        <label for=\"start-date\" _v-056b61a8=\"\"> and </label>\n                        <input v-if=\"enddate\" type=\"text\" :initval=\"enddate\" v-flatpickr=\"enddate\" class=\"form-control\" _v-056b61a8=\"\">\n                    </div>\n                    <div class=\"form-group\" _v-056b61a8=\"\">\n                        <button type=\"button\" class=\"btn btn-sm btn-info\" @click=\"fetchStories\" _v-056b61a8=\"\">Filter</button>\n                        <a href=\"#\" id=\"rangetoggle\" @click=\"toggleRange\" _v-056b61a8=\"\"><span v-if=\"isEndDate\" _v-056b61a8=\"\"> - Remove </span><span v-else=\"\" _v-056b61a8=\"\"> + Add </span>Range</a>\n                    </div>\n                  </form>\n                  <div class=\"btn-toolbar\" role=\"toolbar\" style=\"margin-top:15px;\" _v-056b61a8=\"\">\n                      <div class=\"btn-group btn-group-xs\" role=\"group\" _v-056b61a8=\"\">\n                          <label _v-056b61a8=\"\">Filter: </label>\n                      </div>\n                      <div class=\"btn-group btn-group-xs\" role=\"group\" aria-label=\"typeFiltersLabel\" data-toggle=\"buttons\" v-iconradio=\"stories_filter_storytype\" _v-056b61a8=\"\">\n                           <template v-for=\"item in storyTypeIcons\">\n                               <label class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"{{item.name}}\" _v-056b61a8=\"\"><input type=\"radio\" autocomplete=\"off\" value=\"{{item.shortname}}\" _v-056b61a8=\"\"><span class=\"item-type-icon-shrt\" :class=\"typeIcon(item.shortname)\" _v-056b61a8=\"\"></span></label>\n                          </template>\n                      </div>\n                  </div>\n              </div>\n              <!-- TEXT filter -->\n              <div class=\"col-xs-6\" _v-056b61a8=\"\">\n                  <form class=\"form\" v-on:submit.prevent=\"\" _v-056b61a8=\"\">\n                    <div class=\"form-group\" _v-056b61a8=\"\">\n                        <label for=\"search-filter\" _v-056b61a8=\"\">Search titles</label>\n                        <input v-model=\"textFilter\" id=\"search-filter\" type=\"text\" class=\"form-control\" _v-056b61a8=\"\">\n                    </div>\n                  </form>\n              </div>\n          </div>\n          <!-- Filter by text -->\n          <div id=\"swappable-stories\" _v-056b61a8=\"\">\n            <template v-if=\"!loadingQueue\">\n              <template v-if=\"queueStories.length > 0\">\n                <page-story-pod :item=\"story\" v-for=\"story in queueStories | filterBy filterByStoryType | paginate\" :current-story=\"currentStory\" pod-type=\"queue\" _v-056b61a8=\"\">\n                </page-story-pod>\n                <ul class=\"pagination\" _v-056b61a8=\"\">\n                  <li v-bind:class=\"{disabled: (currentPage <= 1)}\" class=\"page-item\" _v-056b61a8=\"\">\n                    <a href=\"#\" @click.prevent=\"setPage(currentPage-1)\" class=\"page-link\" tabindex=\"-1\" _v-056b61a8=\"\">Previous</a>\n                  </li>\n                  <li v-for=\"pageNumber in totalPages\" :class=\"{active: (pageNumber+1) == currentPage}\" class=\"page-item\" _v-056b61a8=\"\">\n                    <a class=\"page-link\" href=\"#\" @click.prevent=\"setPage(pageNumber+1)\" _v-056b61a8=\"\">{{ pageNumber+1 }} <span v-if=\"(pageNumber+1) == currentPage\" class=\"sr-only\" _v-056b61a8=\"\">(current)</span></a>\n                  </li>\n                  <li v-bind:class=\"{disabled: (currentPage == totalPages)}\" class=\"page-item\" _v-056b61a8=\"\">\n                    <a class=\"page-link\" @click.prevent=\"setPage(currentPage+1)\" href=\"#\" _v-056b61a8=\"\">Next</a>\n                  </li>\n                </ul>\n              </template>\n              <template v-else=\"\">\n                <p _v-056b61a8=\"\">There are no stories for the date range you've specified.</p>\n              </template>\n            </template>\n            <template v-else=\"\">\n              <p _v-056b61a8=\"\">Loading queue. Please Wait...</p>\n            </template>\n          </div>\n      </div>\n      <div class=\"modal-footer\" _v-056b61a8=\"\">\n        this is the footer\n      </div>\n    </div>\n  </div>\n</div><!--/end modal-->\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-056b61a8", module.exports)
  } else {
    hotAPI.update("_v-056b61a8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div @mouseover=\"isMousedOver = true\" @mouseout=\"isMousedOver = false\" _v-6391b138=\"\">\n    <img class=\"topic-image\" :src=\"isMousedOver ? '/imgs/swapstory.png' : imageSrc\" alt=\"story image\" @click=\"openModal\" _v-6391b138=\"\">\n    <div class=\"stories-content\" _v-6391b138=\"\">\n        {{ story ? story.title : 'No story selected' }}\n    </div>\n</div><!-- /end root element -->\n\n<page-story-swap-modal :story-number=\"storyNumber\" :stypes=\"stypes\" :current-story=\"story\" _v-6391b138=\"\"></page-story-swap-modal>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6391b138", module.exports)
  } else {
    hotAPI.update("_v-6391b138", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
