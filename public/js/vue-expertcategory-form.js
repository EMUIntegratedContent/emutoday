...
var __vueify_style__ = __vueify_insert__.insert("\n.redBtn[_v-5ebcad83] {\n  background: hsl(0, 90%, 70%);\n}\np[_v-5ebcad83] {\n  margin: 0;\n}\n\nlabel[_v-5ebcad83] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-5ebcad83] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-5ebcad83] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-5ebcad83] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-5ebcad83] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.invalid[_v-5ebcad83] {\n  color: #ff0000;\n}\n\nfieldset label.radiobtns[_v-5ebcad83] {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n.reqstar[_v-5ebcad83] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nbutton.button-primary[_v-5ebcad83] {\n  margin-top: 0.8rem;\n}\n\nselect[_v-5ebcad83] {\n  margin: 0;\n}\n\n[type='submit'][_v-5ebcad83],\n[type='button'][_v-5ebcad83] {\n  margin-top: 0.8rem;\n}\n\ninput[type=\"number\"][_v-5ebcad83] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-5ebcad83] {\n  margin: 0;\n}\n\nh5.form-control[_v-5ebcad83] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
...
module.exports = {
  ...
  methods: {
    ...
    fetchCurrentRecord: function fetchCurrentRecord(recid) {
      ...
      this.$http.get('/api/expertcategory/' + recid + '/edit').then(function (response) {
    ...
    fetchAllCategories: function fetchAllCategories(id) {
      var _this2 = this;

      var route = this.recordexists ? '/api/expertcategory/all/' + id : '/api/expertcategory/all/';

      // Submit form.
      this.$http.get(route) //

      .then(function (response) {
        _this2.$set('allCategories', response.data);
      }, function (response) {
        console.log("Error fetching expert categories");
      }).bind(this);
    },

    fetchAssociatedCategories: function fetchAssociatedCategories(id) {
      var _this3 = this;

      this.$http.get('/api/expertcategory/associated/' + id).then(function (response) {
        _this3.$set('associatedCategories', response.data);
      }, function (response) {
    ...
    submitForm: function submitForm(e) {
      ...
      var route = this.recordexists ? '/api/expertcategory/' + this.record.id : '/api/expertcategory';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-5ebcad83=\"\">\n    <slot name=\"csrf\" _v-5ebcad83=\"\"></slot>\n    <div class=\"row\" _v-5ebcad83=\"\">\n      <div v-bind:class=\"md12col\" _v-5ebcad83=\"\">\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-5ebcad83=\"\">\n          <h5 _v-5ebcad83=\"\">{{formMessage.msg}}</h5>\n        </div>\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-5ebcad83=\"\">\n          <h5 _v-5ebcad83=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-5ebcad83=\"\">\n      <div v-bind:class=\"md6col\" _v-5ebcad83=\"\">\n        <!-- Category -->\n        <div v-bind:class=\"formGroup\" _v-5ebcad83=\"\">\n          <label _v-5ebcad83=\"\">Category Name <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-5ebcad83=\"\"></span></label>\n          <input v-model=\"record.category\" class=\"form-control\" v-bind:class=\"[formErrors.category ? 'invalid-input' : '']\" name=\"category\" type=\"text\" _v-5ebcad83=\"\">\n          <p v-if=\"formErrors.category\" class=\"help-text invalid\" _v-5ebcad83=\"\">{{formErrors.category}}</p>\n        </div>\n      </div>\n      <div v-bind:class=\"md6col\" _v-5ebcad83=\"\">\n          <label _v-5ebcad83=\"\">Related Categories</label>\n          <v-select :class=\"[formErrors.tags ? 'invalid-input' : '']\" :value.sync=\"associatedCategories\" :options=\"allCategories\" :multiple=\"true\" placeholder=\"Select related categories\" label=\"category\" _v-5ebcad83=\"\">\n          </v-select>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n\n    <div class=\"row\" _v-5ebcad83=\"\">\n      <div v-bind:class=\"md12col\" _v-5ebcad83=\"\">\n        <div v-bind:class=\"formGroup\" _v-5ebcad83=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-5ebcad83=\"\">{{submitBtnLabel}}</button>\n          <button v-if=\"recordexists\" id=\"btn-delete\" v-on:click=\"delEvent\" type=\"submit\" class=\"redBtn\" v-bind:class=\"btnPrimary\" _v-5ebcad83=\"\">Delete Category</button>\n        </div>\n      </div>\n    </div>\n    <!-- /.row -->\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5ebcad83", module.exports)
  } else {
    hotAPI.update("_v-5ebcad83", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../vuex/actions":112,"../vuex/getters":113,"babel-runtime/core-js/json/stringify":1,"flatpickr":102,"moment":103,"vue":108,"vue-hot-reload-api":105,"vue-select":107,"vueify/lib/insert-css":109}],111:[function(require,module,exports){
'use strict';
...
var _ExpertcategoryForm = require('./components/ExpertcategoryForm.vue');

var _ExpertcategoryForm2 = _interopRequireDefault(_ExpertcategoryForm);
...
var vm = new Vue({
    ...
    components: { ExpertcategoryForm: _ExpertcategoryForm2.default },
...
},{"./components/ExpertcategoryForm.vue":110,"vue":108,"vue-resource":106}],112:[function(require,module,exports){
'use strict';
