...
},{"got":2}],11:[function(require,module,exports){
;(function () {
...
},{"sortablejs":8}],12:[function(require,module,exports){
(function (process){
/*!
 * Vue.js v1.0.28
 * (c) 2016 Evan You
...
var __vueify_style__ = __vueify_insert__.insert("\n#items-unapproved .box[_v-69fad4a8] {\n  margin-bottom: 4px;\n}\n#items-approved .box[_v-69fad4a8] {\n  margin-bottom: 4px;\n}\n#automail-label[_v-69fad4a8] {\n  font-size: 110%;\n  margin: 0;\n  padding: 0;\n  position: relative;\n  top: 10px;\n}\n#rangetoggle[_v-69fad4a8]{\n    color: #FF851B;\n    margin-left: 5px;\n    border-bottom: 2px #FF851B dotted;\n}\n.ordersave-container[_v-69fad4a8]{\n  margin-bottom:10px;\n}\n")
'use strict';
...
exports.default = {
  ...
  methods: {
    ...
    filterItemsApproved: function filterItemsApproved(items) {
      ...
      return items.filter(function (item) {
        return (0, _moment2.default)(item.start_date_time).isAfter((0, _moment2.default)()) && item.is_approved === 1 && item.priority === 0 && item.is_promoted === 0 && regexp.test(item.title); // true
      });
    },
    ...
    filterItemsLive: function filterItemsLive(items) {
      var regexp = new RegExp(this.textFilter, 'gi'); // anywhere in the string, ignore case
      return items.filter(function (item) {
        return ((0, _moment2.default)(item.start_date_time).isSameOrBefore((0, _moment2.default)()) && item.is_approved === 1 || item.is_approved === 1 && (item.priority > 0 || item.is_promoted === 1)) && regexp.test(item.title);
      });
    },
  ...
  events: {
    'event-elevated': function eventElevated(eventObj) {
      if (eventObj) {
        this.elevateditems.push(eventObj);
        this.updateElevatedOrder();
      }
    },
    'event-demoted': function eventDemoted(eventId) {
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"row\" _v-69fad4a8=\"\">\n        <div class=\"col-xs-12 col-sm-8 col-md-8 col-lg-6\" _v-69fad4a8=\"\">\n            <form class=\"form-inline\" _v-69fad4a8=\"\">\n              <div class=\"form-group\" _v-69fad4a8=\"\">\n                  <label for=\"start-date\" _v-69fad4a8=\"\">Showing events starting <span v-if=\"isEndDate\" _v-69fad4a8=\"\">between</span><span v-else=\"\" _v-69fad4a8=\"\">on or after</span></label>\n                  <input v-if=\"startdate\" v-model=\"startdate\" type=\"text\" :initval=\"startdate\" v-flatpickr=\"startdate\" _v-69fad4a8=\"\">\n              </div>\n              <div v-if=\"isEndDate\" class=\"form-group\" _v-69fad4a8=\"\">\n                  <label for=\"start-date\" _v-69fad4a8=\"\"> and </label>\n                  <input v-if=\"enddate\" type=\"text\" :initval=\"enddate\" v-flatpickr=\"enddate\" _v-69fad4a8=\"\">\n              </div>\n              <button type=\"button\" class=\"btn btn-sm btn-info\" @click=\"fetchAllRecords\" _v-69fad4a8=\"\">Filter</button>\n              <a href=\"#\" id=\"rangetoggle\" @click=\"toggleRange\" _v-69fad4a8=\"\"><span v-if=\"isEndDate\" _v-69fad4a8=\"\"> - Remove </span><span v-else=\"\" _v-69fad4a8=\"\"> + Add </span>Range</a>\n            </form>\n        </div>\n        <!-- TEXT filter -->\n        <div class=\"col-xs-12 col-sm-4 col-md-4 col-lg-6\" _v-69fad4a8=\"\">\n            <form class=\"form-inline\" v-on:submit.prevent=\"\" _v-69fad4a8=\"\">\n              <div class=\"form-group\" _v-69fad4a8=\"\">\n                  <label for=\"search-filter\" _v-69fad4a8=\"\">Search titles</label>\n                  <input v-model=\"textFilter\" id=\"search-filter\" type=\"text\" class=\"form-control\" _v-69fad4a8=\"\">\n              </div>\n            </form>\n        </div>\n    </div>\n    <hr _v-69fad4a8=\"\">\n    <div class=\"row\" _v-69fad4a8=\"\">\n        <div class=\"col-xs-12\" _v-69fad4a8=\"\">\n            <label id=\"automail-label\" for=\"automail\" _v-69fad4a8=\"\">Send notification email? <input type=\"checkbox\" name=\"automail\" id=\"automail\" _v-69fad4a8=\"\"></label>\n        </div>\n    </div>\n  <div class=\"row\" _v-69fad4a8=\"\">\n      <h2 v-if=\"loading\" class=\"col-md-12\" _v-69fad4a8=\"\">Loading. Please Wait...</h2>\n    <div class=\"col-md-4\" _v-69fad4a8=\"\">\n      <h3 _v-69fad4a8=\"\"><span class=\"badge\" _v-69fad4a8=\"\">{{ itemsUnapproved ? itemsUnapproved.length : 0 }}</span> Unapproved Events</h3>\n      <div id=\"items-unapproved\" _v-69fad4a8=\"\">\n        <event-queue-item pid=\"items-unapproved\" v-for=\"item in itemsUnapproved | orderBy 'start_date' 1\" @item-change=\"moveToApproved\" :item=\"item\" :index=\"$index\" :is=\"unapproved-list\" _v-69fad4a8=\"\">\n      </event-queue-item>\n    </div>\n  </div><!-- /.col-md-6 -->\n  <div class=\"col-md-4\" _v-69fad4a8=\"\">\n    <h3 _v-69fad4a8=\"\"><span class=\"badge\" _v-69fad4a8=\"\">{{ itemsApproved ? itemsApproved.length : 0 }}</span> Approved Events</h3>\n    <div id=\"items-approved\" _v-69fad4a8=\"\">\n      <event-queue-item pid=\"items-approved\" v-for=\"item in itemsApproved | orderBy 'start_date' 1\" @item-change=\"moveToUnApproved\" :item=\"item\" :index=\"$index\" :is=\"approved-list\" _v-69fad4a8=\"\">\n    </event-queue-item>\n  </div>\n</div><!-- /.col-md-6 -->\n<div class=\"col-md-4\" _v-69fad4a8=\"\">\n  <div id=\"items-live\" _v-69fad4a8=\"\">\n    <!-- ELEVATED ANNOUNCEMENTS -->\n    <!-- UNCOMMENT IF EVENT ELEVATION/RE-ORDERING ON FRONT PAGE IS SUDDENLY \"NEEDED\" AGAIN -->\n    <!--\n    <template v-if=\"canElevate\">\n      <h3><span class=\"badge\">{{ elevateditems ? elevateditems.length : 0 }}</span> Elevated</h3>\n      <p>To rearrange the order of events, drag the pod to the desired location. To demote an event, click the red 'X' on the pod. Click \"save order\" button when done. Note: this list is NOT filtered by date.</p>\n      <div v-show=\"ordersave.isOk\"  class=\"alert alert-success alert-dismissible\">\n        <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\"><i class=\"fa fa-times\"></i></button>\n        <h5>{{ordersave.msg}}</h5>\n      </div>\n      <div v-show=\"ordersave.isErr\"  class=\"alert alert-danger alert-dismissible\">\n        <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\"><i class=\"fa fa-times\"></i></button>\n        <h5>{{ordersave.msg}}</h5>\n      </div>\n      <template v-if=\"elevateditemschanged\">\n        <div class=\"ordersave-container\">\n          <button @click=\"updateElevatedOrder\" class=\"btn btn-info\">Save Order</button>\n          <button @click=\"resetElevatedOrder\" class=\"btn btn-default\">Reset</button>\n        </div>\n      </template>\n      <template v-if=\"elevateditems.length > 0\">\n        <ul class=\"list-group\" v-sortable=\"{ onUpdate: updateOrder }\">\n          <li v-for=\"item in elevateditems\" class=\"list-group-item\">\n            <event-queue-item\n              pid=\"item-elevated\"\n              :item=\"item\"\n              :is=\"item-elevated\"\n            >\n            </event-queue-item>\n          </li>\n        </ul>\n      </template>\n      <template v-else>\n        <p>There are no elevated announcements.</p>\n      </template>\n    </template>\n    <hr /> --><!-- End elevated announcements -->\n    <h3 _v-69fad4a8=\"\"><span class=\"badge\" _v-69fad4a8=\"\">{{ itemsLive ? itemsLive.length : 0 }}</span> Live Events</h3>\n    <event-queue-item pid=\"items-live\" v-for=\"item in itemsLive | orderBy 'start_date' -1\" @item-change=\"moveToUnApproved\" :elevated-events=\"elevateditems\" :item=\"item\" :index=\"$index\" :is=\"other-list\" _v-69fad4a8=\"\">\n  </event-queue-item>\n</div>\n</div><!-- /.col-md-6 -->\n</div><!-- ./row -->\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-69fad4a8", module.exports)
  } else {
    hotAPI.update("_v-69fad4a8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.file-upload[_v-01dd6a5b] {\n  position: relative;\n  overflow: hidden;\n}\n.file-upload input.file-input[_v-01dd6a5b] {\n  position: absolute;\n  top: 0;\n  right: 0;\n  margin: 0;\n  padding: 0;\n  cursor: pointer;\n  opacity: 0;\n  filter: alpha(opacity=0);\n}\nspan.file-input-helpertext[_v-01dd6a5b] {\n  display: inline-block;\n  line-height: 18px;\n  margin: 0 .5rem;\n  padding: 0;\n  vertical-align: middle;\n  padding: .2rem 0;\n  overflow: hidden;\n  border-bottom: 1px solid #bbb;\n}\n/*//////////////////*/\n.event-cancel[_v-01dd6a5b] {\n  font-size: 90%;\n  font-weight: normal;\n  color: #333;\n}\n.input-group.caption[_v-01dd6a5b] {\n  margin: .5rem 0;\n}\n.input-group-addon.caption[_v-01dd6a5b] {\n  background-color: #ddd;\n}\n.box[_v-01dd6a5b] {\n  color: #1B1B1B;\n  margin-bottom: 10px;\n}\n.box-body[_v-01dd6a5b] {\n  background-color: #fff;\n  border-bottom-left-radius: 0;\n  border-bottom-right-radius: 0;\n  margin:0;\n}\n\n.box-header[_v-01dd6a5b] {\n  padding: 3px;\n}\n.box-footer[_v-01dd6a5b] {\n  padding: 3px;\n}\nh5.box-footer[_v-01dd6a5b] {\n  padding: 3px;\n}\nbutton.footer-btn[_v-01dd6a5b] {\n  border-color: #999999;\n\n}\nh6.box-title[_v-01dd6a5b] {\n  font-size: 16px;\n  color: #1B1B1B;\n}\nform[_v-01dd6a5b] {\n  display:inline-block;\n}\nform.mediaform[_v-01dd6a5b] {\n  margin-top: 1rem;\n}\n.form-group[_v-01dd6a5b] {\n  margin-bottom: 2px;\n}\n#applabel[_v-01dd6a5b]{\n  margin-left: 2px;\n  margin-right: 2px;\n  padding-left: 2px;\n  padding-right: 2px;\n}\n\n.btn-group[_v-01dd6a5b],\n.btn-group-vertical[_v-01dd6a5b] {\n  display:-webkit-inline-box;\n  display:-ms-inline-flexbox;\n  display:inline-flex;\n}\nselect.form-control[_v-01dd6a5b] {\n  height:22px;\n  border: 1px solid #999999;\n}\n\nh6[_v-01dd6a5b] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\nh5[_v-01dd6a5b] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\n.form-group[_v-01dd6a5b] {\n  /*border: 1px solid red;*/\n}\n.form-group label[_v-01dd6a5b]{\n  margin-bottom: 0;\n}\n.topitems[_v-01dd6a5b] {\n  /*background-color: #9B59B6;*/\n  background-color: #76D7EA;\n  border: 2px solid #9B59B6;\n}\n.ongoing[_v-01dd6a5b] {\n  background-color: #ffcc33;\n  border: 1px solid #999999\n}\n.event-positive[_v-01dd6a5b] {\n\n  background-color: #D8D8D8;\n  border: 1px solid #999999;\n}\n.event-negative[_v-01dd6a5b] {\n\n  background-color: #999999;\n  border: 1px solid #999999;\n}\n.is-promoted[_v-01dd6a5b] {\n\n  background-color: #76D7EA;\n  /*border: 1px solid #999999*/\n}\n.time-is-short[_v-01dd6a5b] {\n  color: #F39C12;\n}\n.time-is-long[_v-01dd6a5b] {\n  color: #999999;\n}\n.time-is-over[_v-01dd6a5b] {\n  color: #9B59B6;\n}\n\n.special-item[_v-01dd6a5b] {\n  border-left: 6px solid #ff00bf;\n\n  padding-left: 3px;\n  border-top-left-radius:3px;\n  border-bottom-left-radius: 3px;\n  margin-left: -10px;\n\n}\n.special-item-both[_v-01dd6a5b] {\n  border-left: 6px solid #bfff00;\n}\n.special-item-home[_v-01dd6a5b] {\n  border-left: 6px solid #00bfff;\n}\n.special-item-last[_v-01dd6a5b] {\n  margin-bottom: 30px;\n}\n.remove-event-btn[_v-01dd6a5b]{\n  margin-left: 10px;\n}\n.form-check[_v-01dd6a5b]{\n  display:inline;\n}\n")
'use strict';
...
module.exports = {
  ...
  computed: {
    ...
    isElevatedEvent: function isElevatedEvent() {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n  <!-- <div class=\"box box-default box-solid\"> -->\n  <div :class=\"specialItem\" _v-01dd6a5b=\"\">\n\n    <div :class=\"liveTimeStatusClass\" class=\"box box-solid\" _v-01dd6a5b=\"\">\n\n      <div class=\"box-header with-border\" _v-01dd6a5b=\"\">\n        <div class=\"row\" _v-01dd6a5b=\"\">\n          <div class=\"col-sm 12 col-md-4\" _v-01dd6a5b=\"\">\n            <div class=\"box-date-top pull-left\" _v-01dd6a5b=\"\">{{item.start_date | titleDateLong}}</div>\n            <div class=\"pull-right\" _v-01dd6a5b=\"\">\n              <label data-toggle=\"tooltip\" data-placement=\"top\" title=\"Promoted\" _v-01dd6a5b=\"\"><span class=\"item-promoted-icon\" :class=\"promotedIcon\" _v-01dd6a5b=\"\"></span></label>\n            </div><!-- /.pull-right -->\n          </div><!-- /.col-sm-6 -->\n          <div class=\"col-sm 12 col-md-8\" _v-01dd6a5b=\"\">\n            <form class=\"form-inline pull-right\" _v-01dd6a5b=\"\">\n              <!-- UNCOMMENT IF EVENT ELEVATION/RE-ORDERING ON FRONT PAGE IS SUDDENLY \"NEEDED\" AGAIN -->\n              <!--\n              <template v-if=\"pid == 'items-live' || pid == 'items-approved'\">\n                <div class=\"form-check\">\n                  <label class=\"form-check-label\">\n                    Elevate\n                    <input type=\"checkbox\" class=\"form-check-input\" @click=\"toggleEmitEventElevate(item)\" v-model=\"checked\" :checked=\"isElevatedEvent\" /> |\n                  </label>\n                </div>\n              </template>\n              <template v-if=\"pid != 'item-elevated'\">\n                <div id=\"applabel\" class=\"form-group\">\n                  <label> approved:</label>\n                </div>\n                <div class=\"form-group\">\n                  <vui-flip-switch id=\"switch-{{item.id}}\"\n                  v-on:click.prevent=\"changeIsApproved\"\n                  :value.sync=\"patchRecord.is_approved\" >\n                  </vui-flip-switch>\n                </div>\n              </template>\n              -->\n              <div id=\"applabel\" class=\"form-group\" _v-01dd6a5b=\"\">\n                <label _v-01dd6a5b=\"\"> approved:</label>\n              </div>\n              <div class=\"form-group\" _v-01dd6a5b=\"\">\n                <vui-flip-switch id=\"switch-{{item.id}}\" v-on:click.prevent=\"changeIsApproved\" :value.sync=\"patchRecord.is_approved\" _v-01dd6a5b=\"\">\n                </vui-flip-switch>\n              </div>\n              <button v-show=\"pid == 'item-elevated'\" type=\"button\" class=\"btn btn-sm btn-danger pull-right remove-event-btn\" @click=\"emitEventDemote(item)\" _v-01dd6a5b=\"\"><i class=\"fa fa-times\" aria-hidden=\"true\" _v-01dd6a5b=\"\"></i></button>\n          </form>\n        </div><!-- /.col-sm-6 -->\n      </div><!-- /.row -->\n      <div class=\"row\" _v-01dd6a5b=\"\">\n        <a v-on:click.prevent=\"toggleBody\" href=\"#\" _v-01dd6a5b=\"\">\n          <div class=\"col-sm-12\" _v-01dd6a5b=\"\">\n            <h6 class=\"box-title\" _v-01dd6a5b=\"\">{{item.title}}</h6><span class=\"event-cancel\" v-if=\"item.is_canceled\" _v-01dd6a5b=\"\"> - canceled</span>\n          </div><!-- /.col-md-12 -->\n        </a>\n      </div><!-- /.row -->\n    </div>  <!-- /.box-header -->\n\n    <div v-if=\"showBody\" class=\"box-body\" _v-01dd6a5b=\"\">\n      <!-- <div class=\"box-body\"> -->\n      <div v-show=\"formMessage.msg\" class=\"callout bg-success\" _v-01dd6a5b=\"\">\n        <h5 _v-01dd6a5b=\"\">{{formMessage.msg}}</h5>\n      </div>\n      <div v-show=\"formMessage.err\" class=\"callout bg-danger\" _v-01dd6a5b=\"\">\n        <h5 _v-01dd6a5b=\"\">{{formMessage.err}}</h5>\n      </div>\n      <template v-if=\"canHaveImage\">\n        <img v-if=\"hasEventImage\" :src=\"imageUrl\" _v-01dd6a5b=\"\"><br _v-01dd6a5b=\"\">\n        <a v-on:click.prevent=\"togglePanel\" style=\"width: 100px\" class=\"btn btn-info btn-sm\" href=\"#\" _v-01dd6a5b=\"\">{{hasEventImage ? 'Change Image' : 'Promote Event'}}</a>\n        <div v-show=\"showPanel\" _v-01dd6a5b=\"\">\n          <!-- <div class=\"panel\"> -->\n          <div _v-01dd6a5b=\"\">\n            <form id=\"form-mediafile-upload{{item.id}}\" @submit.prevent=\"addMediaFile\" class=\"mediaform m-t\" role=\"form\" action=\"/api/event/addMediaFile/{{item.id}}\" enctype=\"multipart/form-data\" files=\"true\" _v-01dd6a5b=\"\">\n              <input name=\"eventid\" class=\"hidden\" type=\"input\" value=\"{{item.id}}\" v-model=\"formInputs.event_id\" _v-01dd6a5b=\"\">\n              <input type=\"text\" class=\"hidden\" name=\"caption\" id=\"caption\" v-model=\"formInputs.caption\" _v-01dd6a5b=\"\">\n              <input type=\"text\" class=\"hidden\" name=\"alt_text\" id=\"alt_text\" v-model=\"formInputs.alt_text\" _v-01dd6a5b=\"\">\n              <div class=\"fa fa-photo btn btn-info btn-sm block m-b file-upload\" _v-01dd6a5b=\"\">\n                <input v-el:eventimg=\"\" type=\"file\" @change=\"getFileName\" class=\"file-input\" name=\"eventimg\" id=\"eventimg\" _v-01dd6a5b=\"\">\n              </div>\n              <button v-if=\"eventimage\" id=\"btn-mediafile-upload\" type=\"submit\" class=\"fa fa-floppy-o btn btn-sm bg-orange block m-b\" _v-01dd6a5b=\"\"></button>\n              <span class=\"file-input-helpertext\" id=\"file-name\" _v-01dd6a5b=\"\">{{eventimage}}</span><br _v-01dd6a5b=\"\">\n            </form>\n            <form v-if=\"hasEventImage\" id=\"form-mediafile-remove{{item.id}}\" @submit.prevent=\"removeMediaFile\" class=\"mediaform m-t\" role=\"form\" action=\"/api/event/removeMediaFile/{{item.id}}\" _v-01dd6a5b=\"\">\n              <input name=\"eventid\" class=\"hidden\" type=\"input\" value=\"{{item.id}}\" v-model=\"formInputs.event_id\" _v-01dd6a5b=\"\">\n              <button id=\"btn-mediafile-remove\" type=\"submit\" class=\"fa fa-eraser btn btn-sm btn-danger block m-b\" _v-01dd6a5b=\"\"></button>\n            </form>\n          </div>\n          <div class=\"input-group caption\" v-if=\"hasEventImage\" _v-01dd6a5b=\"\">\n            <span class=\"input-group-addon caption\" _v-01dd6a5b=\"\">Caption: </span>\n            <input class=\"form-control\" type=\"text\" v-model=\"formInputs.caption\" _v-01dd6a5b=\"\">\n          </div>\n          <div class=\"input-group caption\" v-if=\"hasEventImage\" _v-01dd6a5b=\"\">\n            <span class=\"input-group-addon caption\" _v-01dd6a5b=\"\">Alt text: </span>\n            <input class=\"form-control\" type=\"text\" v-model=\"formInputs.alt_text\" _v-01dd6a5b=\"\">\n          </div>\n        </div><!-- /.panel mediaform -->\n\n        <hr _v-01dd6a5b=\"\">\n      </template>\n      <p _v-01dd6a5b=\"\">From: {{item.start_date | momentPretty}}, {{item.start_time}} To: {{item.end_date | momentPretty}}, {{item.end_time}}</p>\n      <template v-if=\"item.all_day\">\n        <p _v-01dd6a5b=\"\">All Day Event</p>\n      </template>\n      <hr _v-01dd6a5b=\"\">\n      <div class=\"item-info\" _v-01dd6a5b=\"\">\n        <p _v-01dd6a5b=\"\">Title: {{item.title}}</p>\n        <p v-if=\"item.short_title\" _v-01dd6a5b=\"\">Short-title: {{item.shor_title}}</p>\n        <p _v-01dd6a5b=\"\">Description: {{item.description}}</p>\n        <template v-if=\"isOnCampus\">\n          <p _v-01dd6a5b=\"\">Location: <a href=\"http://emich.edu/maps/?building={{item.building}}\" target=\"_blank\" _v-01dd6a5b=\"\">{{item.location}}</a></p>\n        </template>\n        <hr _v-01dd6a5b=\"\">\n        <template v-else=\"\">\n          <p _v-01dd6a5b=\"\">Location: {{item.location}}</p>\n        </template>\n        <template v-if=\"item.contact_person || item.contact_person || item.contact_person\">\n          <p _v-01dd6a5b=\"\">Contact:</p>\n          <ul _v-01dd6a5b=\"\">\n            <li v-if=\"item.contact_person\" _v-01dd6a5b=\"\">Person: {{item.contact_person}}</li>\n            <li v-if=\"item.contact_email\" _v-01dd6a5b=\"\">Email: {{item.contact_email}}</li>\n            <li v-if=\"item.contact_phone\" _v-01dd6a5b=\"\">Phone: {{item.contact_phone}}</li>\n          </ul>\n        </template>\n        <template v-if=\"item.related_link_1\">\n          <p _v-01dd6a5b=\"\">For more information, visit:</p>\n          <ul _v-01dd6a5b=\"\">\n            <li _v-01dd6a5b=\"\"><a href=\"{{item.related_link_1 | hasHttp}}\" target=\"_blank\" _v-01dd6a5b=\"\">\n              <template v-if=\"item.related_link_1_txt\">{{item.related_link_1_txt}}</template>\n              <template v-else=\"\">{{item.related_link_1}}</template>\n            </a></li>\n            <li v-if=\"item.related_link_2\" _v-01dd6a5b=\"\"><a href=\"{{item.related_link_2 | hasHttp}}\" target=\"_blank\" _v-01dd6a5b=\"\">\n              <template v-if=\"item.related_link_2_txt\">{{item.related_link_2_txt}}</template>\n              <template v-else=\"\">{{item.related_link_2}}</template>\n            </a></li>\n            <li v-if=\"item.related_link_3\" _v-01dd6a5b=\"\"><a href=\"{{item.related_link_3 | hasHttp}}\" target=\"_blank\" _v-01dd6a5b=\"\">\n              <template v-if=\"item.related_link_3_txt\">{{item.related_link_3_txt}}</template>\n              <template v-else=\"\">{{item.related_link_3}}</template>\n            </a></li>\n          </ul>\n        </template>\n        <hr _v-01dd6a5b=\"\">\n        <p v-if=\"item.free\" _v-01dd6a5b=\"\">Cost: Free</p>\n        <p v-else=\"\" _v-01dd6a5b=\"\">Cost: {{item.cost | currency }}</p>\n        <p _v-01dd6a5b=\"\">Participation: {{eventParticipation}}</p>\n        <template v-if=\"item.tickets\">\n          <p v-if=\"item.ticket_details_online\" _v-01dd6a5b=\"\">For Tickets Visit: <a href=\"{{item.ticket_details_online | hasHttp}}\" _v-01dd6a5b=\"\">{{item.ticket_details_online}}</a></p>\n          <p v-if=\"item.ticket_details_phone\" _v-01dd6a5b=\"\">For Tickets Call: {{item.ticket_details_phone}}</p>\n          <p v-if=\"item.ticket_details_office\" _v-01dd6a5b=\"\">For Tickets Office: {{item.ticket_details_office}}</p>\n          <p v-if=\"item.ticket_details_other\" _v-01dd6a5b=\"\">Or: {{item.ticket_details_other}}</p>\n        </template>\n        <hr _v-01dd6a5b=\"\">\n        <p _v-01dd6a5b=\"\">LBC Approved: {{item.lbc_approved | yesNo }}</p>\n        <hr _v-01dd6a5b=\"\">\n        <p _v-01dd6a5b=\"\">Submitted by: {{item.submitter}}</p>\n      </div>\n    </div><!-- /.box-body -->\n\n\n    <div :class=\"addSeperator\" class=\"box-footer list-footer\" _v-01dd6a5b=\"\">\n      <div class=\"row\" _v-01dd6a5b=\"\">\n        <div class=\"col-sm-12 col-md-9\" _v-01dd6a5b=\"\">\n          <span v-if=\"itemCurrent\" :class=\"timeFromNowStatus\" _v-01dd6a5b=\"\">Live {{timefromNow}}</span> <span :class=\"timeLeftStatus\" _v-01dd6a5b=\"\">{{timeLeft}}</span>\n        </div><!-- /.col-md-7 -->\n        <div class=\"col-sm-12 col-md-3\" _v-01dd6a5b=\"\">\n          {{item.id}}\n          <div class=\"btn-group pull-right\" _v-01dd6a5b=\"\">\n            <button v-on:click.prevent=\"editItem\" class=\"btn bg-orange btn-xs footer-btn\" _v-01dd6a5b=\"\"><i class=\"fa fa-pencil\" _v-01dd6a5b=\"\"></i></button>\n          </div><!-- /.btn-toolbar -->\n        </div><!-- /.col-md-7 -->\n      </div><!-- /.row -->\n    </div><!-- /.box-footer -->\n  </div><!-- /.box- -->\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-01dd6a5b", module.exports)
  } else {
    hotAPI.update("_v-01dd6a5b", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"flatpickr":5}],18:[function(require,module,exports){
'use strict';
...
},{"./components/EventQueue.vue":14,"vue":12,"vue-resource":10,"vue-sortable":11}]},{},[18]);
