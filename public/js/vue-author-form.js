...
var __vueify_style__ = __vueify_insert__.insert("\np[_v-49d2beb1] {\n  margin: 0;\n}\n\nlabel[_v-49d2beb1] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-49d2beb1] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-49d2beb1] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-49d2beb1] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-49d2beb1] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.invalid[_v-49d2beb1] {\n  color: #ff0000;\n}\n\nfieldset label.radiobtns[_v-49d2beb1] {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n.reqstar[_v-49d2beb1] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nbutton.button-primary[_v-49d2beb1] {\n  margin-top: 0.8rem;\n}\n\nselect[_v-49d2beb1] {\n  margin: 0;\n}\n\n[type='submit'][_v-49d2beb1],\n[type='button'][_v-49d2beb1] {\n  margin-top: 0.8rem;\n}\n\ninput[type=\"number\"][_v-49d2beb1] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-49d2beb1] {\n  margin: 0;\n}\n\nh5.form-control[_v-49d2beb1] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  -webkit-transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-49d2beb1=\"\">\n    <slot name=\"csrf\" _v-49d2beb1=\"\"></slot>\n    <div class=\"row\" _v-49d2beb1=\"\">\n      <div v-bind:class=\"md12col\" _v-49d2beb1=\"\">\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-49d2beb1=\"\">\n          <h5 _v-49d2beb1=\"\">{{formMessage.msg}}</h5>\n        </div>\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-49d2beb1=\"\">\n          <h5 _v-49d2beb1=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-49d2beb1=\"\">\n      <div v-bind:class=\"md6col\" _v-49d2beb1=\"\">\n        <!-- First Name -->\n        <div v-bind:class=\"formGroup\" _v-49d2beb1=\"\">\n          <label _v-49d2beb1=\"\">First Name <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-49d2beb1=\"\"></span></label>\n          <input v-model=\"record.first_name\" class=\"form-control\" v-bind:class=\"[formErrors.first_name ? 'invalid-input' : '']\" name=\"first_name\" type=\"text\" _v-49d2beb1=\"\">\n          <p v-if=\"formErrors.first_name\" class=\"help-text invalid\" _v-49d2beb1=\"\">{{formErrors.first_name}}</p>\n        </div>\n      </div>\n      <div v-bind:class=\"md6col\" _v-49d2beb1=\"\">\n        <!-- Last Name -->\n        <div v-bind:class=\"formGroup\" _v-49d2beb1=\"\">\n          <label _v-49d2beb1=\"\">Last Name <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-49d2beb1=\"\"></span></label>\n          <input v-model=\"record.last_name\" class=\"form-control\" v-bind:class=\"[formErrors.last_name ? 'invalid-input' : '']\" name=\"last_name\" type=\"text\" _v-49d2beb1=\"\">\n          <p v-if=\"formErrors.last_name\" class=\"help-text invalid\" _v-49d2beb1=\"\">{{formErrors.last_name}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-49d2beb1=\"\">\n      <div :class=\"md6col\" _v-49d2beb1=\"\">\n        <!-- Email -->\n        <div v-bind:class=\"formGroup\" _v-49d2beb1=\"\">\n          <label _v-49d2beb1=\"\">Email <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-49d2beb1=\"\"></span></label>\n          <p class=\"help-text\" id=\"title-helptext\" _v-49d2beb1=\"\">Please enter the author's email address. (contact@emich.edu)</p>\n          <div class=\"input-group input-group-flat\" _v-49d2beb1=\"\">\n            <input v-model=\"record.email\" class=\"form-control\" v-bind:class=\"[formErrors.email ? 'invalid-input' : '']\" name=\"email\" type=\"text\" _v-49d2beb1=\"\">\n          </div>\n          <p v-if=\"formErrors.email\" class=\"help-text invalid\" _v-49d2beb1=\"\">Please make sure email is properly formed.</p>\n        </div>\n      </div><!-- /.col-md-6 -->\n      <div :class=\"md6col\" _v-49d2beb1=\"\">\n        <!-- Phone -->\n        <div v-bind:class=\"formGroup\" _v-49d2beb1=\"\">\n          <label _v-49d2beb1=\"\">Phone</label>\n          <p class=\"help-text\" id=\"title-helptext\" _v-49d2beb1=\"\">Please enter the contact person's phone number.</p>\n          <div class=\"input-group input-group-flat\" _v-49d2beb1=\"\">\n            <input v-model=\"record.phone\" class=\"form-control\" v-bind:class=\"[formErrors.phone ? 'invalid-input' : '']\" name=\"phone\" type=\"text\" _v-49d2beb1=\"\">\n          </div>\n          <p v-if=\"formErrors.phone\" class=\"help-text invalid\" _v-49d2beb1=\"\">Please enter a phone number.</p>\n        </div>\n      </div><!-- /.col-md-6 -->\n    </div><!-- /.row -->\n    <div class=\"row\" _v-49d2beb1=\"\">\n      <div :class=\"md6col\" _v-49d2beb1=\"\">\n        <div class=\"form-group\" _v-49d2beb1=\"\">\n          <label _v-49d2beb1=\"\">Show this author as story contact?\n            <input id=\"is-contact-yes\" name=\"is_contact\" type=\"checkbox\" value=\"1\" v-model=\"record.is_contact\" _v-49d2beb1=\"\">\n          </label>\n        </div>\n      </div><!-- /.md6col -->\n    </div><!-- /.row -->\n    <div class=\"row\" _v-49d2beb1=\"\">\n      <div :class=\"md12col\" _v-49d2beb1=\"\">\n        <div class=\"form-group\" _v-49d2beb1=\"\">\n          <label _v-49d2beb1=\"\">This author should be the DEFAULT contact for a story if none is otherwise specified.\n            <input id=\"is-principal-contact-yes\" name=\"is_principal_contact\" type=\"checkbox\" value=\"1\" v-model=\"record.is_principal_contact\" _v-49d2beb1=\"\">\n          </label>\n          <p _v-49d2beb1=\"\">Notice: Selecting this will replace the currently-select principal contact which is {{currentPrimaryContact}}.</p>\n        </div>\n      </div><!-- /.md6col -->\n    </div><!-- /.row -->\n    <div class=\"row\" _v-49d2beb1=\"\">\n      <div v-bind:class=\"md12col\" _v-49d2beb1=\"\">\n        <div v-bind:class=\"formGroup\" _v-49d2beb1=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-49d2beb1=\"\">{{submitBtnLabel}}</button>\n        </div>\n      </div>\n    </div>\n\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-49d2beb1", module.exports)
  } else {
    hotAPI.update("_v-49d2beb1", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
