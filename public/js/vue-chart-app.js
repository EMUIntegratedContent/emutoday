...
exports.default = {
    ...
    computed: {
        rowsLoad: function rowsLoad() {
            ...
            return newdata.map(function (item, index) {
                ...
                var ddsdate = (0, _moment2.default)(item.start_date);
                var newsdate = new Date(ddsdate.year(), ddsdate.month(), ddsdate.date());
                var ddedate = item.end_date === null ? (0, _moment2.default)("2017-01-01") : (0, _moment2.default)(item.end_date);
    ...
    methods: {
        ...
        formatColumnValues: function formatColumnValues(items) {
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n    <div class=\"panel-body\" _v-3638728e=\"\">\n    <vue-chart :packages=\"gpackages\" :chart-type=\"chartType\" :columns=\"columns\" :rows=\"rowsLoad\" :options=\"options\" _v-3638728e=\"\"></vue-chart>\n</div>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3638728e", module.exports)
  } else {
    hotAPI.update("_v-3638728e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"moment":2,"vue":8,"vue-hot-reload-api":6,"vueify/lib/insert-css":9}],11:[function(require,module,exports){
'use strict';
...
Vue.use(_vueCharts2.default);

new Vue({
    el: '#vue-chart-app',
    components: { PageChartApp: _PageChartApp2.default },
    ready: function ready() {
        console.log('vue ready');
    }
});

},{"./components/PageChartApp.vue":10,"vue":8,"vue-charts":4,"vue-resource":7}]},{},[11]);

//# sourceMappingURL=vue-chart-app.js.map
