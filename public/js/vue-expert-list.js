...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-255aeada=\"\">\n  <div class=\"row\" _v-255aeada=\"\">\n    <div v-bind:class=\"md12col\" _v-255aeada=\"\">\n      <h1 _v-255aeada=\"\">Eastern Experts</h1>\n    </div>\n  </div>\n  <div class=\"row\" _v-255aeada=\"\">\n    <div v-bind:class=\"md8col\" _v-255aeada=\"\">\n      <div class=\"panel panel-default\" _v-255aeada=\"\">\n        <!-- Default panel contents -->\n        <div class=\"panel-heading\" _v-255aeada=\"\">\n          <div class=\"row\" _v-255aeada=\"\">\n            <div :class=\"md8col\" _v-255aeada=\"\">\n              <form v-on:submit.prevent=\"fetchExperts(currentSearch, 1)\" class=\"form-inline\" role=\"search\" _v-255aeada=\"\">\n                <div class=\"btn-group\" data-toggle=\"buttons\" v-radio=\"type_filter\" @click.prevent=\"fetchExperts(currentSearch, 1)\" _v-255aeada=\"\">\n                  <label class=\"btn btn-info active\" _v-255aeada=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"all\" autocomplete=\"off\" _v-255aeada=\"\"> All\n                  </label>\n                  <label class=\"btn btn-info\" _v-255aeada=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"unapproved\" autocomplete=\"off\" _v-255aeada=\"\"> Unapproved\n                  </label>\n                  <label class=\"btn btn-info\" _v-255aeada=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"new\" autocomplete=\"off\" _v-255aeada=\"\"> New\n                  </label>\n                </div>\n                <div class=\"input-group\" _v-255aeada=\"\">\n                  <label for=\"narrow\" class=\"sr-only\" _v-255aeada=\"\">Narrow results</label>\n                  <input type=\"text\" class=\"form-control\" id=\"narrow\" placeholder=\"Narrow Results\" v-model=\"currentSearch\" _v-255aeada=\"\">\n                  <div class=\"input-group-btn\" _v-255aeada=\"\">\n                    <input type=\"submit\" class=\"form-control btn btn-info\" aria-label=\"Narrow search results\" value=\"Narrow\" _v-255aeada=\"\">\n                  </div>\n                </div>\n              </form>\n            </div>\n            <div :class=\"md4col\" _v-255aeada=\"\">\n              <p class=\"text-right\" _v-255aeada=\"\"><a :class=\"btnPrimary\" href=\"/admin/experts/form\" _v-255aeada=\"\">Add Expert</a></p>\n            </div>\n          </div>\n        </div>\n\n        <!-- Table -->\n        <table class=\"table table-hover table-sm\" _v-255aeada=\"\">\n          <tbody _v-255aeada=\"\"><tr _v-255aeada=\"\">\n            <th _v-255aeada=\"\">Photo</th>\n            <th _v-255aeada=\"\">Last Name</th>\n            <th _v-255aeada=\"\">First Name</th>\n            <th _v-255aeada=\"\">Job Title</th>\n            <th _v-255aeada=\"\">Approved?</th>\n            <th _v-255aeada=\"\">Actions</th>\n          </tr>\n          <tr v-for=\"expert in experts\" _v-255aeada=\"\">\n            <td _v-255aeada=\"\">\n              <img v-if=\"expert.expert_images[0]\" class=\"small-thumb\" v-bind:src=\"'/imagecache/expertthumb/' + expert.expert_images[0].filename\" v-bind:alt=\"'A photo of ' + expert.first_name + ' ' + expert.last_name\" _v-255aeada=\"\">\n              <img v-else=\"\" class=\"small-thumb\" src=\"/imagecache/expertthumb/no-image.png\" v-bind:alt=\"'No image available for ' + expert.first_name + ' ' + expert.last_name\" _v-255aeada=\"\">\n            </td>\n            <td _v-255aeada=\"\">{{ expert.last_name }}</td>\n            <td _v-255aeada=\"\">{{ expert.first_name }}</td>\n            <td _v-255aeada=\"\">{{ expert.title }}</td>\n            <td _v-255aeada=\"\">\n              <span v-show=\"expert.is_approved\" class=\"label label-success\" _v-255aeada=\"\">Yes</span>\n              <span v-show=\"!expert.is_approved &amp;&amp; (expert.created_at != expert.updated_at)\" class=\"label label-danger\" _v-255aeada=\"\">No</span>\n              <span v-show=\"!expert.is_approved &amp;&amp; (expert.created_at == expert.updated_at)\" class=\"label label-info\" _v-255aeada=\"\">New</span>\n            </td>\n            <td _v-255aeada=\"\">\n              <a href=\"/admin/experts/{{ expert.id }}/edit\" class=\"button success\" _v-255aeada=\"\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" _v-255aeada=\"\"></i></a>\n            </td>\n          </tr>\n        </tbody></table>\n        <div class=\"panel-footer\" _v-255aeada=\"\">\n          <ul class=\"pagination\" _v-255aeada=\"\">\n            <li v-bind:class=\"{disabled: !hasPrevious}\" class=\"page-item\" _v-255aeada=\"\">\n              <a href=\"#\" v-on:click.prevent=\"fetchExperts(currentSearch, pagination.current_page-1)\" class=\"page-link\" tabindex=\"-1\" _v-255aeada=\"\">Previous</a>\n            </li>\n            <li v-for=\"pg in pagination.last_page\" :class=\"{active: isActivePage(pg+1)}\" class=\"page-item\" _v-255aeada=\"\">\n              <a class=\"page-link\" href=\"#\" v-on:click.prevent=\"fetchExperts(currentSearch, pg+1)\" _v-255aeada=\"\">{{ pg+1 }} <span v-if=\"isCurrent\" class=\"sr-only\" _v-255aeada=\"\">(current)</span></a>\n            </li>\n            <li v-bind:class=\"{disabled: !hasNext}\" class=\"page-item\" _v-255aeada=\"\">\n              <a class=\"page-link\" v-on:click.prevent=\"fetchExperts(currentSearch, pagination.current_page+1)\" href=\"#\" _v-255aeada=\"\">Next</a>\n            </li>\n          </ul>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-255aeada", module.exports)
  } else {
    hotAPI.update("_v-255aeada", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
