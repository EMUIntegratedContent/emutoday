...
module.exports = {
  components: { flatpickr: _flatpickr2.default },
  props: {
    framework: {
      default: 'bootstrap'
    },
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-274f4212=\"\">\n  <div class=\"row\" _v-274f4212=\"\">\n    <div v-bind:class=\"md12col\" _v-274f4212=\"\">\n      <h1 _v-274f4212=\"\">Eastern Expert Media Requests</h1>\n    </div>\n  </div>\n  <div class=\"row\" _v-274f4212=\"\">\n    <div v-bind:class=\"md8col\" _v-274f4212=\"\">\n      <div class=\"panel panel-default\" _v-274f4212=\"\">\n        <!-- Default panel contents -->\n        <div class=\"panel-heading\" _v-274f4212=\"\">\n          <div class=\"row\" _v-274f4212=\"\">\n            <div :class=\"md12col\" _v-274f4212=\"\">\n              <form class=\"form-inline\" role=\"search\" _v-274f4212=\"\">\n                <!-- Tutorial for button group workaround https://forum-archive.vuejs.org/topic/135/problem-binding-bootstrap-styled-radio-button-groups-with-vue-vm/3 -->\n                <div class=\"btn-group\" data-toggle=\"buttons\" v-radio=\"formData.type_filter\" @click.prevent=\"fetchRequests(this.formData, 1)\" _v-274f4212=\"\">\n                  <label class=\"btn btn-info active\" _v-274f4212=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"all\" autocomplete=\"off\" _v-274f4212=\"\"> All\n                  </label>\n                  <label class=\"btn btn-info\" _v-274f4212=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"new\" autocomplete=\"off\" _v-274f4212=\"\"> New\n                  </label>\n                  <label class=\"btn btn-info\" _v-274f4212=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"read\" autocomplete=\"off\" _v-274f4212=\"\"> Viewed\n                  </label>\n                </div>\n                <div class=\"form-group\" _v-274f4212=\"\">\n                    <label for=\"start-date\" _v-274f4212=\"\">| Requests between</label>\n                    <input v-if=\"formData.start_date\" v-model=\"formData.start_date\" id=\"start_date\" type=\"text\" :initval=\"formData.start_date\" v-flatpickr=\"formData.start_date\" _v-274f4212=\"\">\n                </div>\n                <div class=\"form-group\" _v-274f4212=\"\">\n                    <label for=\"start-date\" _v-274f4212=\"\"> and </label>\n                    <input v-if=\"formData.end_date\" type=\"text\" :initval=\"formData.end_date\" id=\"end-date\" v-flatpickr=\"formData.end_date\" _v-274f4212=\"\">\n                </div>\n                <button type=\"button\" class=\"btn btn-sm btn-info\" @click.prevent=\"fetchRequests(this.formData, 1)\" _v-274f4212=\"\">Filter</button>\n              </form>\n            </div>\n          </div>\n        </div>\n\n        <!-- Table -->\n        <table class=\"table table-hover table-sm\" _v-274f4212=\"\">\n          <tbody _v-274f4212=\"\"><tr _v-274f4212=\"\">\n            <th _v-274f4212=\"\">Submitted</th>\n            <th _v-274f4212=\"\">Requester</th>\n            <th _v-274f4212=\"\">Media Outlet</th>\n            <th _v-274f4212=\"\">Requested Expert</th>\n            <th _v-274f4212=\"\">Deadline</th>\n            <th _v-274f4212=\"\">Status</th>\n            <th _v-274f4212=\"\">Actions</th>\n          </tr>\n          <tr v-for=\"request in mediarequests\" _v-274f4212=\"\">\n            <td _v-274f4212=\"\">{{ request.created_at | formatDate }}</td>\n            <td _v-274f4212=\"\">{{ request.name }}</td>\n            <td _v-274f4212=\"\">{{ request.media_outlet }}</td>\n            <td _v-274f4212=\"\">{{ request.expert.first_name + ' ' + request.expert.last_name }}</td>\n            <td _v-274f4212=\"\">{{ request.deadline }}</td>\n            <td _v-274f4212=\"\">\n              <span v-if=\"request.is_acknowledged\" class=\"label label-info\" _v-274f4212=\"\">Viewed</span>\n              <span v-else=\"\" class=\"label label-warning\" _v-274f4212=\"\">New</span>\n            </td>\n            <td _v-274f4212=\"\">\n              <a href=\"/admin/expertrequests/{{ request.id }}/edit\" class=\"button success\" _v-274f4212=\"\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" _v-274f4212=\"\"></i></a>\n            </td>\n          </tr>\n        </tbody></table>\n        <div class=\"panel-footer\" _v-274f4212=\"\">\n          <ul class=\"pagination\" _v-274f4212=\"\">\n            <li v-bind:class=\"{disabled: !hasPrevious}\" class=\"page-item\" _v-274f4212=\"\">\n              <a href=\"#\" v-on:click.prevent=\"fetchRequests(this.formData, pagination.current_page-1)\" class=\"page-link\" tabindex=\"-1\" _v-274f4212=\"\">Previous</a>\n            </li>\n            <li v-for=\"pg in pagination.last_page\" :class=\"{active: isActivePage(pg+1)}\" class=\"page-item\" _v-274f4212=\"\">\n              <a class=\"page-link\" href=\"#\" v-on:click.prevent=\"fetchRequests(this.formData, pg+1)\" _v-274f4212=\"\">{{ pg+1 }} <span v-if=\"isCurrent\" class=\"sr-only\" _v-274f4212=\"\">(current)</span></a>\n            </li>\n            <li v-bind:class=\"{disabled: !hasNext}\" class=\"page-item\" _v-274f4212=\"\">\n              <a class=\"page-link\" v-on:click.prevent=\"fetchRequests(this.formData, pagination.current_page+1)\" href=\"#\" _v-274f4212=\"\">Next</a>\n            </li>\n          </ul>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-274f4212", module.exports)
  } else {
    hotAPI.update("_v-274f4212", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../directives/flatpickr.js":10,"moment":3,"vue":7,"vue-hot-reload-api":5,"vueify/lib/insert-css":8}],10:[function(require,module,exports){
'use strict';
...
},{"flatpickr":2}],11:[function(require,module,exports){
'use strict';
...
var _ExpertRequestList = require('./components/ExpertRequestList.vue');

var _ExpertRequestList2 = _interopRequireDefault(_ExpertRequestList);
...
var vm = new Vue({
    ...
    components: {
        ExpertMediaRequestList: _ExpertRequestList2.default
    },
    ready: function ready() {
...
},{"./components/ExpertRequestList.vue":9,"vue":7,"vue-resource":6}]},{},[11]);

//# sourceMappingURL=vue-expert-request-list.js.map
