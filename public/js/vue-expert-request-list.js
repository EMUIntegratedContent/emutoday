...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-3bfe9342=\"\">\n  <div class=\"row\" _v-3bfe9342=\"\">\n    <div v-bind:class=\"md12col\" _v-3bfe9342=\"\">\n      <h1 _v-3bfe9342=\"\">Eastern Expert Media Requests</h1>\n    </div>\n  </div>\n  <div class=\"row\" _v-3bfe9342=\"\">\n    <div v-bind:class=\"md8col\" _v-3bfe9342=\"\">\n      <div class=\"panel panel-default\" _v-3bfe9342=\"\">\n        <!-- Default panel contents -->\n        <div class=\"panel-heading\" _v-3bfe9342=\"\">\n          <div class=\"row\" _v-3bfe9342=\"\">\n            <div :class=\"md12col\" _v-3bfe9342=\"\">\n              <form class=\"form-inline\" role=\"search\" _v-3bfe9342=\"\">\n                <!-- Tutorial for button group workaround https://forum-archive.vuejs.org/topic/135/problem-binding-bootstrap-styled-radio-button-groups-with-vue-vm/3 -->\n                <div class=\"btn-group\" data-toggle=\"buttons\" v-radio=\"formData.type_filter\" @click.prevent=\"fetchRequests(this.formData, 1)\" _v-3bfe9342=\"\">\n                  <label class=\"btn btn-info active\" _v-3bfe9342=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"all\" autocomplete=\"off\" _v-3bfe9342=\"\"> All\n                  </label>\n                  <label class=\"btn btn-info\" _v-3bfe9342=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"new\" autocomplete=\"off\" _v-3bfe9342=\"\"> New\n                  </label>\n                  <label class=\"btn btn-info\" _v-3bfe9342=\"\">\n                    <input type=\"radio\" name=\"typeFilter\" value=\"read\" autocomplete=\"off\" _v-3bfe9342=\"\"> Viewed\n                  </label>\n                </div>\n                <div class=\"form-group\" _v-3bfe9342=\"\">\n                    <label for=\"start-date\" _v-3bfe9342=\"\">| Requests between</label>\n                    <input v-if=\"formData.start_date\" v-model=\"formData.start_date\" id=\"start_date\" type=\"text\" :initval=\"formData.start_date\" v-flatpickr=\"formData.start_date\" _v-3bfe9342=\"\">\n                </div>\n                <div class=\"form-group\" _v-3bfe9342=\"\">\n                    <label for=\"start-date\" _v-3bfe9342=\"\"> and </label>\n                    <input v-if=\"formData.end_date\" type=\"text\" :initval=\"formData.end_date\" id=\"end-date\" v-flatpickr=\"formData.end_date\" _v-3bfe9342=\"\">\n                </div>\n                <button type=\"button\" class=\"btn btn-sm btn-info\" @click.prevent=\"fetchRequests(this.formData, 1)\" _v-3bfe9342=\"\">Filter</button>\n              </form>\n            </div>\n          </div>\n        </div>\n\n        <!-- Table -->\n        <table class=\"table table-hover table-sm\" _v-3bfe9342=\"\">\n          <tbody _v-3bfe9342=\"\"><tr _v-3bfe9342=\"\">\n            <th _v-3bfe9342=\"\">Submitted</th>\n            <th _v-3bfe9342=\"\">Requester</th>\n            <th _v-3bfe9342=\"\">Media Outlet</th>\n            <th _v-3bfe9342=\"\">Requested Expert</th>\n            <th _v-3bfe9342=\"\">Deadline</th>\n            <th _v-3bfe9342=\"\">Status</th>\n            <th _v-3bfe9342=\"\">Actions</th>\n          </tr>\n          <tr v-for=\"request in mediarequests\" _v-3bfe9342=\"\">\n            <td _v-3bfe9342=\"\">{{ request.created_at | formatDate }}</td>\n            <td _v-3bfe9342=\"\">{{ request.name }}</td>\n            <td _v-3bfe9342=\"\">{{ request.media_outlet }}</td>\n            <td _v-3bfe9342=\"\">{{ request.expert.first_name + ' ' + request.expert.last_name }}</td>\n            <td _v-3bfe9342=\"\">{{ request.deadline }}</td>\n            <td _v-3bfe9342=\"\">\n              <span v-if=\"request.is_acknowledged\" class=\"label label-info\" _v-3bfe9342=\"\">Viewed</span>\n              <span v-else=\"\" class=\"label label-warning\" _v-3bfe9342=\"\">New</span>\n            </td>\n            <td _v-3bfe9342=\"\">\n              <a href=\"/admin/expertrequests/{{ request.id }}/edit\" class=\"button success\" _v-3bfe9342=\"\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" _v-3bfe9342=\"\"></i></a>\n            </td>\n          </tr>\n        </tbody></table>\n        <div class=\"panel-footer\" _v-3bfe9342=\"\">\n          <ul class=\"pagination\" _v-3bfe9342=\"\">\n            <li v-bind:class=\"{disabled: !hasPrevious}\" class=\"page-item\" _v-3bfe9342=\"\">\n              <a href=\"#\" v-on:click.prevent=\"fetchRequests(this.formData, pagination.current_page-1)\" class=\"page-link\" tabindex=\"-1\" _v-3bfe9342=\"\">Previous</a>\n            </li>\n            <li v-for=\"pg in pagination.last_page\" :class=\"{active: isActivePage(pg+1)}\" class=\"page-item\" _v-3bfe9342=\"\">\n              <a class=\"page-link\" href=\"#\" v-on:click.prevent=\"fetchRequests(this.formData, pg+1)\" _v-3bfe9342=\"\">{{ pg+1 }} <span v-if=\"isCurrent\" class=\"sr-only\" _v-3bfe9342=\"\">(current)</span></a>\n            </li>\n            <li v-bind:class=\"{disabled: !hasNext}\" class=\"page-item\" _v-3bfe9342=\"\">\n              <a class=\"page-link\" v-on:click.prevent=\"fetchRequests(this.formData, pagination.current_page+1)\" href=\"#\" _v-3bfe9342=\"\">Next</a>\n            </li>\n          </ul>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3bfe9342", module.exports)
  } else {
    hotAPI.update("_v-3bfe9342", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
