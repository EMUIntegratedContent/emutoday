...
var __vueify_style__ = __vueify_insert__.insert("\n.row[_v-226f10b5]{\n    padding: 5px 0px 5px 0px;\n}\n.list-row[_v-226f10b5]{\n    padding: 10px;\n    border: 1px solid #eeeeee;\n}\n.list-row h4[_v-226f10b5]{\n    padding: 10px;\n    background: #eeeeee;\n}\n.nofields[_v-226f10b5]{\n    padding: 10px;\n    font-style: italic;\n}\n#policies-container[_v-226f10b5]{\n    height: 175px;\n    overflow: scroll;\n    padding: 16px;\n    background: #eeeeee;\n    border: 1px solid #999999;\n    margin: 10px;\n}\n#honeypot[_v-226f10b5]{\n    display: none;\n}\n.redBtn[_v-226f10b5] {\n  background: hsl(0, 90%, 70%);\n}\np[_v-226f10b5] {\n  margin: 0;\n}\n\nlabel[_v-226f10b5] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-226f10b5] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-226f10b5] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-226f10b5] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-226f10b5] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.invalid[_v-226f10b5] {\n  color: #ff0000;\n}\n\nfieldset label.radiobtns[_v-226f10b5] {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n.reqstar[_v-226f10b5] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nbutton.button-primary[_v-226f10b5] {\n  margin-top: 0.8rem;\n}\n\nselect[_v-226f10b5] {\n  margin: 0;\n}\n\n[type='submit'][_v-226f10b5],\n[type='button'][_v-226f10b5] {\n  margin-top: 0;\n}\n\ninput[type=\"number\"][_v-226f10b5] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-226f10b5] {\n  margin: 0;\n}\n\nh5.form-control[_v-226f10b5] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
  ...
  methods: {
    ...
    fetchRequest: function fetchRequest() {
      ...
      .then(function (response) {
        _this.$set('record', response.data.newdata);
      }, function (response) {
    ...
    getSelectedSpeaker: function getSelectedSpeaker() {
      if (this.expertId) {
        this.record.expert_id = this.expertId;
      }
    },

    fetchExperts: function fetchExperts() {
      var _this2 = this;

      this.$http.get('/api/experts/list', { params: { type: 'media' } }).then(function (response) {
        _this2.$set('experts', response.data.newdata);
      }, function (response) {
        _this2.expertListError = "Unable to fetch experts list.";
      }).bind(this);
    },

    getSelectedExpert: function getSelectedExpert() {
      var _this3 = this;

      this.$http.get('/api/experts/list/' + this.record.expert_id) //

      .then(function (response) {
        _this3.$set('selectedExpert', response.data.newdata[0]);
      }, function (response) {
    ...
    submitForm: function submitForm(e) {
      ...
      var method = this.isAdmin ? 'put' : 'post';
      var route = this.isAdmin ? '/api/expertmediarequest/' + this.record.id : '/api/expertmediarequest';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form v-show=\"!recordexists || isAdmin\" _v-226f10b5=\"\">\n    <slot name=\"csrf\" _v-226f10b5=\"\"></slot>\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-226f10b5=\"\">\n          <h5 _v-226f10b5=\"\">There are errors.</h5>\n        </div>\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-226f10b5=\"\">\n          <h5 _v-226f10b5=\"\">{{formMessage.msg}}</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" v-show=\"isAdmin\" _v-226f10b5=\"\">\n        <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n            <!-- Acknowledged? -->\n            <div class=\"checkbox\" _v-226f10b5=\"\">\n                <label _v-226f10b5=\"\"><input type=\"checkbox\" value=\"1\" v-model=\"record.is_acknowledged\" _v-226f10b5=\"\">Acknowledged By Admin?</label>\n            </div>\n        </div>\n        <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Expert -->\n        <div v-if=\"this.expertListError != ''\" _v-226f10b5=\"\">\n            {{ this.expertListError }}\n        </div>\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Expert <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <select v-model=\"record.expert_id\" v-bind:class=\"[formErrors.expert_id ? 'invalid-input' : '']\" name=\"expert_id\" _v-226f10b5=\"\">\n              <option v-for=\"expert in experts\" value=\"{{ expert.id }}\" _v-226f10b5=\"\">{{ expert.last_name }}, {{ expert.first_name}}</option>\n          </select>\n          <p v-if=\"formErrors.expert_id\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.expert_id}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Name -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Name <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <input v-model=\"record.name\" class=\"form-control\" v-bind:class=\"[formErrors.name ? 'invalid-input' : '']\" name=\"name\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.name\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.name}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Title -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Title <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <input v-model=\"record.title\" class=\"form-control\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" name=\"title\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.title}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Media Outlet -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Media Outlet <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <input v-model=\"record.media_outlet\" class=\"form-control\" v-bind:class=\"[formErrors.media_outlet ? 'invalid-input' : '']\" name=\"media_outlet\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.media_outlet\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.media_outlet}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md6col\" _v-226f10b5=\"\">\n        <!-- City -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">City</label>\n          <input v-model=\"record.city\" class=\"form-control\" v-bind:class=\"[formErrors.city ? 'invalid-input' : '']\" name=\"city\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.city\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.city}}</p>\n        </div>\n      </div>\n      <div v-bind:class=\"md6col\" _v-226f10b5=\"\">\n        <!-- State -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">State</label>\n          <select v-model=\"record.state\" _v-226f10b5=\"\">\n              <option value=\"\" _v-226f10b5=\"\">--Select State--</option>\n              <option value=\"AL\" _v-226f10b5=\"\">Alabama</option>\n              <option value=\"AK\" _v-226f10b5=\"\">Alaska</option>\n              <option value=\"AZ\" _v-226f10b5=\"\">Arizona</option>\n              <option value=\"AR\" _v-226f10b5=\"\">Arkansas</option>\n              <option value=\"CA\" _v-226f10b5=\"\">California</option>\n              <option value=\"CO\" _v-226f10b5=\"\">Colorado</option>\n              <option value=\"CT\" _v-226f10b5=\"\">Connecticut</option>\n              <option value=\"DE\" _v-226f10b5=\"\">Delaware</option>\n              <option value=\"DC\" _v-226f10b5=\"\">District Of Columbia</option>\n              <option value=\"FL\" _v-226f10b5=\"\">Florida</option>\n              <option value=\"GA\" _v-226f10b5=\"\">Georgia</option>\n              <option value=\"HI\" _v-226f10b5=\"\">Hawaii</option>\n              <option value=\"ID\" _v-226f10b5=\"\">Idaho</option>\n              <option value=\"IL\" _v-226f10b5=\"\">Illinois</option>\n              <option value=\"IN\" _v-226f10b5=\"\">Indiana</option>\n              <option value=\"IA\" _v-226f10b5=\"\">Iowa</option>\n              <option value=\"KS\" _v-226f10b5=\"\">Kansas</option>\n              <option value=\"KY\" _v-226f10b5=\"\">Kentucky</option>\n              <option value=\"LA\" _v-226f10b5=\"\">Louisiana</option>\n              <option value=\"ME\" _v-226f10b5=\"\">Maine</option>\n              <option value=\"MD\" _v-226f10b5=\"\">Maryland</option>\n              <option value=\"MA\" _v-226f10b5=\"\">Massachusetts</option>\n              <option value=\"MI\" _v-226f10b5=\"\">Michigan</option>\n              <option value=\"MN\" _v-226f10b5=\"\">Minnesota</option>\n              <option value=\"MS\" _v-226f10b5=\"\">Mississippi</option>\n              <option value=\"MO\" _v-226f10b5=\"\">Missouri</option>\n              <option value=\"MT\" _v-226f10b5=\"\">Montana</option>\n              <option value=\"NE\" _v-226f10b5=\"\">Nebraska</option>\n              <option value=\"NV\" _v-226f10b5=\"\">Nevada</option>\n              <option value=\"NH\" _v-226f10b5=\"\">New Hampshire</option>\n              <option value=\"NJ\" _v-226f10b5=\"\">New Jersey</option>\n              <option value=\"NM\" _v-226f10b5=\"\">New Mexico</option>\n              <option value=\"NY\" _v-226f10b5=\"\">New York</option>\n              <option value=\"NC\" _v-226f10b5=\"\">North Carolina</option>\n              <option value=\"ND\" _v-226f10b5=\"\">North Dakota</option>\n              <option value=\"OH\" _v-226f10b5=\"\">Ohio</option>\n              <option value=\"OK\" _v-226f10b5=\"\">Oklahoma</option>\n              <option value=\"OR\" _v-226f10b5=\"\">Oregon</option>\n              <option value=\"PA\" _v-226f10b5=\"\">Pennsylvania</option>\n              <option value=\"RI\" _v-226f10b5=\"\">Rhode Island</option>\n              <option value=\"SC\" _v-226f10b5=\"\">South Carolina</option>\n              <option value=\"SD\" _v-226f10b5=\"\">South Dakota</option>\n              <option value=\"TN\" _v-226f10b5=\"\">Tennessee</option>\n              <option value=\"TX\" _v-226f10b5=\"\">Texas</option>\n              <option value=\"UT\" _v-226f10b5=\"\">Utah</option>\n              <option value=\"VT\" _v-226f10b5=\"\">Vermont</option>\n              <option value=\"VA\" _v-226f10b5=\"\">Virginia</option>\n              <option value=\"WA\" _v-226f10b5=\"\">Washington</option>\n              <option value=\"WV\" _v-226f10b5=\"\">West Virginia</option>\n              <option value=\"WI\" _v-226f10b5=\"\">Wisconsin</option>\n              <option value=\"WY\" _v-226f10b5=\"\">Wyoming</option>\n          </select>\n          <p v-if=\"formErrors.city\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.city}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md6col\" _v-226f10b5=\"\">\n        <!-- Phone -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Phone <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <input v-model=\"record.phone\" class=\"form-control\" v-bind:class=\"[formErrors.phone ? 'invalid-input' : '']\" name=\"phone\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.phone\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.phone}}</p>\n        </div>\n      </div>\n      <div v-bind:class=\"md6col\" _v-226f10b5=\"\">\n        <!-- Email -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Email <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <input v-model=\"record.email\" class=\"form-control\" v-bind:class=\"[formErrors.email ? 'invalid-input' : '']\" name=\"email\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.email\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.email}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Deadline -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Deadline</label>\n          <input v-model=\"record.deadline\" class=\"form-control\" v-bind:class=\"[formErrors.deadline ? 'invalid-input' : '']\" name=\"deadline\" type=\"text\" _v-226f10b5=\"\">\n          <p v-if=\"formErrors.deadline\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.deadline}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Interview type -->\n        <label _v-226f10b5=\"\">Interview Details <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label for=\"inperson_int\" _v-226f10b5=\"\"><input type=\"radio\" id=\"inperson_int\" value=\"In-person\" v-model=\"record.interview_type\" _v-226f10b5=\"\">&nbsp;In-person</label>\n        </div>\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label for=\"phone_int\" _v-226f10b5=\"\"><input type=\"radio\" id=\"phone_int\" value=\"Phone\" v-model=\"record.interview_type\" _v-226f10b5=\"\">&nbsp;Phone</label>\n        </div>\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label for=\"oncamera_int\" _v-226f10b5=\"\"><input type=\"radio\" id=\"oncamera_int\" value=\"On-camera\" v-model=\"record.interview_type\" _v-226f10b5=\"\">&nbsp;On-camera</label>\n        </div>\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label for=\"instudio_int\" _v-226f10b5=\"\"><input type=\"radio\" id=\"instudio_int\" value=\"In-studio\" v-model=\"record.interview_type\" _v-226f10b5=\"\">&nbsp;In-studio</label>\n        </div>\n        <p v-if=\"formErrors.interview_type\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.interview_type}}</p>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <!-- Deadline -->\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <label _v-226f10b5=\"\">Describe your story <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-226f10b5=\"\">*</span></label>\n          <textarea v-model=\"record.description\" class=\"form-control\" v-bind:class=\"[formErrors.description ? 'invalid-input' : '']\" name=\"description\" _v-226f10b5=\"\"></textarea>\n          <p v-if=\"formErrors.description\" class=\"help-text invalid\" _v-226f10b5=\"\">{{formErrors.description}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-226f10b5=\"\">\n      <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n        <div v-bind:class=\"formGroup\" _v-226f10b5=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-226f10b5=\"\">{{ isAdmin ? 'Edit Request' : 'Send Request' }}</button>\n          <input v-model=\"record.honeypot\" class=\"form-control\" v-bind:class=\"[formErrors.honeypot ? 'invalid-input' : '']\" name=\"honeypot\" type=\"text\" id=\"honeypot\" _v-226f10b5=\"\">\n        </div>\n      </div>\n    </div>\n    <!-- /.row -->\n</form>\n    <div class=\"row\" v-show=\"recordexists &amp;&amp; !isAdmin\" _v-226f10b5=\"\">\n        <div v-bind:class=\"md12col\" _v-226f10b5=\"\">\n            <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-226f10b5=\"\">\n              <h5 _v-226f10b5=\"\">{{formMessage.msg}}</h5>\n            </div>\n            <p _v-226f10b5=\"\"><strong _v-226f10b5=\"\">An administrator will review your request soon. Here are the details of your submission.</strong></p>\n            <ul _v-226f10b5=\"\">\n                <li _v-226f10b5=\"\">\n                    Expert: {{ selectedExpert.first_name }} {{ selectedExpert.last_name }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Your Name: {{ record.name }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Your Title: {{ record.title }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Media Outlet: {{ record.media_outlet }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    City: {{ record.city }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    State: {{ record.state }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Phone: {{ record.phone }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Email: {{ record.email }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Deadline: {{ record.deadline }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Interview Type: {{ record.interview_type }}\n                </li>\n                <li _v-226f10b5=\"\">\n                    Description of Story: {{ record.description }}\n                </li>\n            </ul>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-226f10b5", module.exports)
  } else {
    hotAPI.update("_v-226f10b5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _ExpertMediaRequestForm = require('./components/ExpertMediaRequestForm.vue');

var _ExpertMediaRequestForm2 = _interopRequireDefault(_ExpertMediaRequestForm);
...
var vm = new Vue({
    ...
    components: { ExpertMediaRequestForm: _ExpertMediaRequestForm2.default },
    ready: function ready() {
        console.log('Expert Media Request Form ready');
    }
});

},{"./components/ExpertMediaRequestForm.vue":109,"vue":107,"vue-resource":105}]},{},[110]);

//# sourceMappingURL=vue-expertmediarequest-form.js.map
