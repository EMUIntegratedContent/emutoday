...
var __vueify_style__ = __vueify_insert__.insert("\n#items-unapproved .box[_v-b7db511c] {\n  margin-bottom: 4px;\n}\n#items-approved .box[_v-b7db511c] {\n  margin-bottom: 4px;\n}\n#items-reviewed[_v-b7db511c] {\n}\n#rangetoggle[_v-b7db511c]{\n  color: #FF851B;\n  margin-left: 5px;\n  border-bottom: 2px #FF851B dotted;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <div class=\"row\" _v-b7db511c=\"\">\n    <div class=\"col-xs-12 col-sm-8 col-md-6 col-lg-9\" _v-b7db511c=\"\">\n      <form class=\"form-inline\" _v-b7db511c=\"\">\n        <div class=\"form-group\" _v-b7db511c=\"\">\n          <label for=\"start-date\" _v-b7db511c=\"\">Showing all events starting <span v-if=\"isEndDate\" _v-b7db511c=\"\">between</span><span v-else=\"\" _v-b7db511c=\"\">on or after</span></label>\n          <input v-if=\"startdate\" v-model=\"startdate\" type=\"text\" :initval=\"startdate\" v-flatpickr=\"startdate\" _v-b7db511c=\"\">\n        </div>\n        <div v-if=\"isEndDate\" class=\"form-group\" _v-b7db511c=\"\">\n          <label for=\"start-date\" _v-b7db511c=\"\"> and </label>\n          <input v-if=\"enddate\" type=\"text\" :initval=\"enddate\" v-flatpickr=\"enddate\" _v-b7db511c=\"\">\n        </div>\n        <button type=\"button\" class=\"btn btn-sm btn-info\" @click=\"fetchAllRecords\" _v-b7db511c=\"\">Filter</button>\n        <a href=\"#\" id=\"rangetoggle\" @click=\"toggleRange\" _v-b7db511c=\"\"><span v-if=\"isEndDate\" _v-b7db511c=\"\"> - Remove </span><span v-else=\"\" _v-b7db511c=\"\"> + Add </span>Range</a>\n      </form>\n    </div>\n  </div>\n  <hr _v-b7db511c=\"\">\n\n  <div class=\"row\" _v-b7db511c=\"\">\n\n  <div class=\"col-md-4\" _v-b7db511c=\"\">\n      <h3 _v-b7db511c=\"\"><span class=\"badge\" _v-b7db511c=\"\">{{ itemsNoPointsReviewed ? itemsNoPointsReviewed.length : 0 }}</span> No Eagle Rewards Points | Reviewed</h3>\n      <div id=\"items-reviewed\" _v-b7db511c=\"\">\n        <event-queue-item pid=\"items-approved\" v-for=\"item in itemsNoPointsReviewed | orderBy 'start_date' 1\" @item-change=\"moveToApproved\" :item=\"item\" :index=\"$index\" :is=\"approved-list\" _v-b7db511c=\"\">\n        </event-queue-item>\n      </div>\n    </div><!-- /.col-md-6 -->\n\n    <div class=\"col-md-4\" _v-b7db511c=\"\">\n      <h3 _v-b7db511c=\"\"><span class=\"badge\" _v-b7db511c=\"\">{{ itemsNoPoints ? itemsNoPoints.length : 0 }}</span> No Eagle Rewards Points</h3>\n      <div _v-b7db511c=\"\">\n        <event-queue-item pid=\"items-approved\" v-for=\"item in itemsNoPoints | orderBy 'start_date' 1\" @item-change=\"moveToApproved\" :item=\"item\" :index=\"$index\" :is=\"approved-list\" _v-b7db511c=\"\">\n        </event-queue-item>\n      </div>\n      </div>\n\n  <div class=\"col-md-4\" _v-b7db511c=\"\">\n    <h3 _v-b7db511c=\"\"><span class=\"badge\" _v-b7db511c=\"\">{{ itemsPoints ? itemsPoints.length : 0 }}</span> Has Eagle Rewards Points <i class=\"fa fa-check green\" _v-b7db511c=\"\"></i></h3>\n    <div id=\"items-approved\" _v-b7db511c=\"\">\n      <event-queue-item pid=\"items-approved\" v-for=\"item in itemsPoints | orderBy 'start_date' 1\" @item-change=\"moveToUnApproved\" :item=\"item\" :index=\"$index\" :is=\"approved-list\" _v-b7db511c=\"\">\n    </event-queue-item>\n  </div>\n</div>\n</div><!-- /.col-md-6 -->\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-b7db511c", module.exports)
  } else {
    hotAPI.update("_v-b7db511c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.box[_v-e8fb0fb6] {\n  color: #1B1B1B;\n  margin-bottom: 10px;\n}\n.box-body[_v-e8fb0fb6] {\n  background-color: #fff;\n  border-bottom-left-radius: 0;\n  border-bottom-right-radius: 0;\n  margin:0;\n}\n\n.box-header[_v-e8fb0fb6] {\n  padding: 3px;\n}\n.box-footer[_v-e8fb0fb6] {\n  padding: 3px;\n}\nh5.box-footer[_v-e8fb0fb6] {\n  padding: 3px;\n}\nbutton.footer-btn[_v-e8fb0fb6] {\n  border-color: #999999;\n\n}\nh6.box-title[_v-e8fb0fb6] {\n  font-size: 16px;\n  color: #1B1B1B;\n}\nform[_v-e8fb0fb6] {\n  display:-webkit-inline-box;\n  display:-ms-inline-flexbox;\n  display:inline-flex;\n}\n.form-group[_v-e8fb0fb6] {\n  margin-bottom: 2px;\n}\n#applabel[_v-e8fb0fb6]{\n  margin-left: 2px;\n  margin-right: 2px;\n  padding-left: 2px;\n  padding-right: 2px;\n}\n\n.btn-group[_v-e8fb0fb6],\n.btn-group-vertical[_v-e8fb0fb6] {\n  display:-webkit-inline-box;\n  display:-ms-inline-flexbox;\n  display:inline-flex;\n}\nselect.form-control[_v-e8fb0fb6] {\n  height:22px;\n  border: 1px solid #999999;\n}\n\nh6[_v-e8fb0fb6] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\nh5[_v-e8fb0fb6] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\n\n.form-group[_v-e8fb0fb6] {\n  /*border: 1px solid red;*/\n}\n.form-group label[_v-e8fb0fb6]{\n  margin-bottom: 0;\n}\n.topitems[_v-e8fb0fb6] {\n  /*background-color: #9B59B6;*/\n  background-color: #76D7EA;\n  border: 2px solid #9B59B6;\n}\n.ongoing[_v-e8fb0fb6] {\n  background-color: #ffcc33;\n  border: 1px solid #999999\n}\n.event-positive[_v-e8fb0fb6] {\n  background-color: #D8D8D8;\n  border: 1px solid #999999;\n}\n.event-negative[_v-e8fb0fb6] {\n  background-color: #999999;\n  border: 1px solid #999999;\n}\n.reviewed-item[_v-e8fb0fb6] {\n  border-left: 6px solid #605CA8;\n  padding-left: 2px;\n}\n.time-is-short[_v-e8fb0fb6] {\n  color: #F39C12;\n}\n.time-is-long[_v-e8fb0fb6] {\n  color: #999999;\n}\n.time-is-over[_v-e8fb0fb6] {\n  color: #9B59B6;\n}\n.short-input[_v-e8fb0fb6] {\n  width: 8rem;\n  max-width: 8rem;\n}\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <!-- <div class=\"box box-default box-solid\"> -->\n  <div :class=\"reviewedItem\" _v-e8fb0fb6=\"\">\n    <div :class=\"liveTimeStatusClass\" class=\"box box-solid\" _v-e8fb0fb6=\"\">\n      <div class=\"box-header with-border\" _v-e8fb0fb6=\"\">\n        <div class=\"row\" _v-e8fb0fb6=\"\">\n          <div class=\"col-sm 12 col-md-4\" _v-e8fb0fb6=\"\">\n            <div class=\"box-date-top pull-left\" _v-e8fb0fb6=\"\">{{item.start_date | titleDateLong}}</div>\n          </div><!-- /.col-sm-6 -->\n          <!-- REVIEWED switch -->\n          <div class=\"col-sm 12 col-md-4\" _v-e8fb0fb6=\"\">\n            <form class=\"form-inline pull-right\" _v-e8fb0fb6=\"\">\n              <div id=\"applabel\" class=\"form-group\" _v-e8fb0fb6=\"\">\n                <label _v-e8fb0fb6=\"\">reviewed:</label>\n              </div><!-- /.form-group -->\n              <div class=\"form-group\" _v-e8fb0fb6=\"\">\n                <vui-flip-switch id=\"switch-{{item.id}}\" v-on:click.prevent=\"changeIsReviewed\" :value.sync=\"patchRecord.hsc_reviewed\" _v-e8fb0fb6=\"\">\n                </vui-flip-switch>\n              </div>\n            </form>\n          </div><!-- /.col-sm-6 -->\n\n          <!-- POINTS -->\n          <div class=\"col-sm 12 col-md-4\" _v-e8fb0fb6=\"\">\n            <form class=\"form-inline pull-right\" v-on:submit.prevent=\"changePoints\" _v-e8fb0fb6=\"\">\n              <div class=\"form-group input-group\" _v-e8fb0fb6=\"\">\n                <span class=\"input-group-addon\" _v-e8fb0fb6=\"\"><label _v-e8fb0fb6=\"\">points:</label></span>\n                <input id=\"event-points-{{item.id}}\" type=\"number\" step=\"5\" class=\"form-control short-input\" min=\"0\" placeholder=\"0\" v-on:change.prevent=\"changePoints\" v-model:value=\"patchRecord.hsc_rewards\" _v-e8fb0fb6=\"\">\n                <span class=\"input-group-addon btn bg-orange\" v-on:click.prevent=\"changePoints\" _v-e8fb0fb6=\"\"><i class=\"fa fa-save\" _v-e8fb0fb6=\"\"></i></span>\n              </div>\n            </form>\n          </div><!-- /.col-sm-6 -->\n        </div><!-- /.row -->\n\n      <div class=\"row\" _v-e8fb0fb6=\"\">\n        <a v-on:click.prevent=\"toggleBody\" href=\"#\" _v-e8fb0fb6=\"\">\n          <div class=\"col-sm-12\" _v-e8fb0fb6=\"\">\n            <h6 class=\"box-title\" _v-e8fb0fb6=\"\">{{item.title}}</h6>\n          </div><!-- /.col-md-12 -->\n        </a>\n      </div><!-- /.row -->\n    </div>  <!-- /.box-header -->\n\n    <div v-if=\"showBody\" class=\"box-body\" _v-e8fb0fb6=\"\">\n      <p _v-e8fb0fb6=\"\">From: {{item.start_date | momentPretty}}, {{item.start_time}} To: {{item.end_date | momentPretty}}, {{item.end_time}}</p>\n      <template v-if=\"item.all_day\">\n        <p _v-e8fb0fb6=\"\">All Day Event</p>\n      </template>\n      <hr _v-e8fb0fb6=\"\">\n      <div class=\"item-info\" _v-e8fb0fb6=\"\">\n        <p _v-e8fb0fb6=\"\">Title: {{item.title}}</p>\n        <p v-if\"item.short_title\"=\"\" _v-e8fb0fb6=\"\">Short-title: {{item.shor_title}}</p>\n        <p _v-e8fb0fb6=\"\">Description: {{item.description}}</p>\n        <template v-if=\"isOnCampus\">\n          <p _v-e8fb0fb6=\"\">Location: <a href=\"http://emich.edu/maps/?building={{item.building}}\" target=\"_blank\" _v-e8fb0fb6=\"\">{{item.location}}</a></p>\n        </template>\n        <hr _v-e8fb0fb6=\"\">\n        <template v-else=\"\">\n          <p _v-e8fb0fb6=\"\">Location: {{item.location}}</p>\n        </template>\n        <template v-if=\"item.contact_person || item.contact_person || item.contact_person\">\n          <p _v-e8fb0fb6=\"\">Contact:</p>\n          <ul _v-e8fb0fb6=\"\">\n            <li v-if=\"item.contact_person\" _v-e8fb0fb6=\"\">Person: {{item.contact_person}}</li>\n            <li v-if=\"item.contact_email\" _v-e8fb0fb6=\"\">Email: {{item.contact_email}}</li>\n            <li v-if=\"item.contact_phone\" _v-e8fb0fb6=\"\">Phone: {{item.contact_phone}}</li>\n          </ul>\n        </template>\n        <template v-if=\"item.related_link_1\">\n          <p _v-e8fb0fb6=\"\">For more information, visit:</p>\n          <ul _v-e8fb0fb6=\"\">\n            <li _v-e8fb0fb6=\"\"><a href=\"{{item.related_link_1 | hasHttp}}\" target=\"_blank\" _v-e8fb0fb6=\"\">\n              <template v-if=\"item.related_link_1_txt\">{{item.related_link_1_txt}}</template>\n              <template v-else=\"\">{{item.related_link_1}}</template>\n            </a></li>\n            <li v-if=\"item.related_link_2\" _v-e8fb0fb6=\"\"><a href=\"{{item.related_link_2 | hasHttp}}\" target=\"_blank\" _v-e8fb0fb6=\"\">\n              <template v-if=\"item.related_link_2_txt\">{{item.related_link_2_txt}}</template>\n              <template v-else=\"\">{{item.related_link_2}}</template>\n            </a></li>\n            <li v-if=\"item.related_link_3\" _v-e8fb0fb6=\"\"><a href=\"{{item.related_link_3 | hasHttp}}\" target=\"_blank\" _v-e8fb0fb6=\"\">\n              <template v-if=\"item.related_link_3_txt\">{{item.related_link_3_txt}}</template>\n              <template v-else=\"\">{{item.related_link_3}}</template>\n            </a></li>\n          </ul>\n        </template>\n        <hr _v-e8fb0fb6=\"\">\n        <p v-if=\"item.free\" _v-e8fb0fb6=\"\">Cost: Free</p>\n        <p v-else=\"\" _v-e8fb0fb6=\"\">Cost: {{item.cost | currency }}</p>\n        <p _v-e8fb0fb6=\"\">Participation: {{eventParticipation}}</p>\n        <template v-if=\"item.tickets\">\n          <p v-if=\"item.ticket_details_online\" _v-e8fb0fb6=\"\">For Tickets Visit: <a href=\"{{item.ticket_details_online | hasHttp}}\" _v-e8fb0fb6=\"\">{{item.ticket_details_online}}</a></p>\n          <p v-if=\"item.ticket_details_phone\" _v-e8fb0fb6=\"\">For Tickets Call: {{item.ticket_details_phone}}</p>\n          <p v-if=\"item.ticket_details_office\" _v-e8fb0fb6=\"\">For Tickets Office: {{item.ticket_details_office}}</p>\n          <p v-if=\"item.ticket_details_other\" _v-e8fb0fb6=\"\">Or: {{item.ticket_details_other}}</p>\n        </template>\n        <hr _v-e8fb0fb6=\"\">\n        <p _v-e8fb0fb6=\"\">Submitted by: {{item.submitter}}</p>\n        <p _v-e8fb0fb6=\"\">LBC Approved: {{item.lbc_approved | yesNo }}</p>\n        <p _v-e8fb0fb6=\"\">LBC Reviewed: {{item.lbc_reviewed | yesNo }}</p>\n        <p _v-e8fb0fb6=\"\">Eagle Rewards: {{item.hsc_rewards}}</p>\n      </div>\n    </div><!-- /.box-body -->\n\n\n    <div class=\"box-footer list-footer\" _v-e8fb0fb6=\"\">\n      <div class=\"row\" _v-e8fb0fb6=\"\">\n        <div class=\"col-sm-12 col-md-9\" _v-e8fb0fb6=\"\">\n          <!-- <span>Start {{item.start_date_time}}</span> <span>End {{item.end_date_time}}</span> -->\n\n          <span v-if=\"itemCurrent\" :class=\"timeFromNowStatus\" _v-e8fb0fb6=\"\">Live {{timefromNow}}</span> <span :class=\"timeLeftStatus\" _v-e8fb0fb6=\"\">{{timeLeft}}</span>\n\n\n\n        </div><!-- /.col-md-7 -->\n        <div class=\"col-sm-12 col-md-3\" _v-e8fb0fb6=\"\">\n          {{item.id}}\n          <div class=\"btn-group pull-right\" _v-e8fb0fb6=\"\">\n\n            <!-- <button v-on:click.prevent=\"previewItem\" class=\"btn bg-orange btn-xs footer-btn\"><i class=\"fa fa-eye\"></i></button> -->\n          </div><!-- /.btn-toolbar -->\n\n        </div><!-- /.col-md-7 -->\n      </div><!-- /.row -->\n    </div><!-- /.box-footer -->\n  </div><!-- /.box- -->\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e8fb0fb6", module.exports)
  } else {
    hotAPI.update("_v-e8fb0fb6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
