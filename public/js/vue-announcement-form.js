...
var __vueify_style__ = __vueify_insert__.insert("\n#submit-area[_v-94175008]{\n  background: #e1e1e1;\n  margin:20px 0 0 0;\n}\np[_v-94175008] {\n  margin: 0;\n}\n.accordion-content p[_v-94175008] {\n  margin-bottom: .5rem;\n}\nlabel[_v-94175008] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-94175008] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-94175008] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-94175008] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-94175008] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.invalid[_v-94175008] {\n  color: #ff0000;\n}\n\nfieldset label.radiobtns[_v-94175008] {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n.reqstar[_v-94175008] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nbutton.button-primary[_v-94175008] {\n  margin-top: 0.8rem;\n}\n\nselect[_v-94175008] {\n  margin: 0;\n}\n\n[type='submit'][_v-94175008],\n[type='button'][_v-94175008] {\n  margin-top: 0.8rem;\n}\n\ninput[type=\"number\"][_v-94175008] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-94175008] {\n  margin: 0;\n}\n\nh5.form-control[_v-94175008] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\ntextarea[_v-94175008] {\n  resize: vertical !important;\n}\n.redBtn[_v-94175008] {\n  background: hsl(0, 90%, 70%);\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-94175008=\"\">\n    <slot name=\"csrf\" _v-94175008=\"\"></slot>\n    <div class=\"row\" _v-94175008=\"\">\n      <div v-bind:class=\"md12col\" _v-94175008=\"\">\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-94175008=\"\">\n          <h5 _v-94175008=\"\">{{formMessage.msg}}</h5>\n        </div>\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-94175008=\"\">\n          <h5 _v-94175008=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n\n    <div class=\"row\" _v-94175008=\"\">\n      <div v-bind:class=\"md12col\" _v-94175008=\"\">\n        <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n          <div class=\"input-group\" style=\"width: 100%\" _v-94175008=\"\">\n            <label _v-94175008=\"\">Title <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-94175008=\"\"></span></label>\n            <p class=\"help-text\" id=\"title-helptext\" _v-94175008=\"\">Please enter a title ({{titleChars}} characters left)</p>\n            <input v-model=\"record.title\" class=\"form-control\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" name=\"title\" type=\"text\" maxlength=\"80\" _v-94175008=\"\">\n            <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-94175008=\"\">{{formErrors.title}}</p>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <div v-if=\"generalForm\" class=\"row\" _v-94175008=\"\">\n      <div v-bind:class=\"md12col\" _v-94175008=\"\">\n        <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n          <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n            <label _v-94175008=\"\">Announcement <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-94175008=\"\"></span>\n              <p class=\"help-text\" id=\"announcement-helptext\" _v-94175008=\"\">({{descriptionChars}} characters left)</p>\n            </label>\n            <textarea v-model=\"record.announcement\" class=\"form-control\" v-bind:class=\"[formErrors.announcement ? 'invalid-input' : '']\" name=\"announcement\" type=\"textarea\" rows=\"8\" maxlength=\"255\" _v-94175008=\"\"></textarea>\n            <p v-if=\"formErrors.announcement\" class=\"help-text invalid\" _v-94175008=\"\">{{formErrors.announcement}}</p>\n          </div>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n\n    <!-- /.row  -->\n    <div class=\"input-group\" style=\"width: 100%\" _v-94175008=\"\">\n      <div class=\"row\" _v-94175008=\"\">\n        <div :class=\"md12col\" _v-94175008=\"\">\n          <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n            <label _v-94175008=\"\">Related Link</label>\n            <p class=\"help-text\" id=\"title-helptext\" _v-94175008=\"\">Please enter the web address for your related web page. (ex. www.yourlink.com)</p>\n            <div class=\"input-group\" _v-94175008=\"\">\n              <span :class=\"inputGroupLabel\" _v-94175008=\"\">http://</span>\n              <input v-model=\"record.link\" class=\"form-control\" v-bind:class=\"[formErrors.link ? 'invalid-input' : '']\" name=\"link\" type=\"text\" maxlength=\"200\" _v-94175008=\"\">\n            </div>\n            <p v-if=\"formErrors.link\" class=\"help-text invalid\" _v-94175008=\"\">Please make sure web address is properly formed.</p>\n          </div>\n        </div><!-- /.col-md-4 -->\n      </div><!-- /.row -->\n\n      <div class=\"row\" v-if=\"generalForm\" _v-94175008=\"\">\n        <div :class=\"md12col\" _v-94175008=\"\">\n          <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n            <label class=\"hidden\" aria-label=\"Descriptive text for web page\" _v-94175008=\"\">Descriptive text for web page</label>\n            <p class=\"help-text\" id=\"title-helptext\" _v-94175008=\"\">Please add descriptive text for link. <strong _v-94175008=\"\">Do not use web address.</strong> (ex. My Announcement Webpage)</p>\n            <input v-model=\"record.link_txt\" class=\"form-control\" v-bind:class=\"[formErrors.link_txt ? 'invalid-input' : '']\" name=\"link_txt\" type=\"text\" maxlength=\"80\" _v-94175008=\"\">\n            <p v-if=\"formErrors.link_txt\" class=\"help-text invalid\" _v-94175008=\"\"> Please include a descriptive text for your related link.</p>\n          </div>\n        </div>\n        <div v-if=\"record.link != ''\" :class=\"md12col\" _v-94175008=\"\">\n          <p _v-94175008=\"\">For more information visit: <a :href=\"record.link\" _v-94175008=\"\">{{ record.link_txt }}</a></p>\n        </div>\n      </div>\n    </div>\n\n    <br v-if=\"framework == 'bootstrap' &amp;&amp; generalForm\" _v-94175008=\"\">\n\n    <div v-if=\"generalForm\" class=\"row\" _v-94175008=\"\">\n      <div :class=\"md12col\" _v-94175008=\"\">\n        <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n          <label _v-94175008=\"\">Contact Person</label>\n          <input v-model=\"record.email_link_txt\" class=\"form-control\" v-bind:class=\"[formErrors.email_link_txt ? 'invalid-input' : '']\" name=\"email_link_txt\" type=\"text\" maxlength=\"80\" _v-94175008=\"\">\n        </div>\n      </div><!-- /.col-md-4 -->\n    </div>\n    <div v-if=\"generalForm\" class=\"row\" _v-94175008=\"\">\n      <div :class=\"md12col\" _v-94175008=\"\">\n        <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n          <label _v-94175008=\"\">Contact Email</label>\n          <p class=\"help-text\" id=\"title-helptext\" _v-94175008=\"\">Please enter the contact person's email address. (contact@yourlink.com)</p>\n          <div class=\"input-group\" _v-94175008=\"\">\n            <span :class=\"inputGroupLabel\" _v-94175008=\"\">mailto:</span>\n            <input v-model=\"record.email_link\" class=\"form-control\" v-bind:class=\"[formErrors.email_link ? 'invalid-input' : '']\" name=\"email_link\" type=\"text\" maxlength=\"80\" _v-94175008=\"\">\n          </div>\n          <p v-if=\"formErrors.email_link\" class=\"help-text invalid\" _v-94175008=\"\">Please make sure email is properly formed.</p>\n        </div>\n      </div><!-- /.col-md-4 -->\n    </div><!-- /.row -->\n\n    <br v-if=\"framework == 'foundation' &amp;&amp; generalForm\" _v-94175008=\"\">\n\n    <div v-if=\"generalForm\" class=\"row\" _v-94175008=\"\">\n      <div :class=\"md12col\" _v-94175008=\"\">\n        <div class=\"form-group\" _v-94175008=\"\">\n          <label _v-94175008=\"\">Contact Phone <em _v-94175008=\"\">(ex. 734.487.1849)</em></label>\n          <input v-model=\"record.phone\" class=\"form-control\" :class=\"[formErrors.phone ? 'invalid-input' : '']\" name=\"phone\" type=\"text\" maxlength=\"15\" _v-94175008=\"\">\n          <p v-if=\"formErrors.phone\" class=\"help-text invalid\" _v-94175008=\"\">Need a Contact Phone!</p>\n        </div>\n      </div><!-- /.md6col -->\n    </div><!-- /.row -->\n\n    <br v-if=\"framework == 'foundation' &amp;&amp; generalForm\" _v-94175008=\"\">\n\n    <div class=\"row\" _v-94175008=\"\">\n      <div v-bind:class=\"md6col\" _v-94175008=\"\">\n        <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n          <label for=\"start-date\" _v-94175008=\"\">Publish Date: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-94175008=\"\"></span></label>\n          <input id=\"start-date\" class=\"form-control\" v-bind:class=\"[formErrors.start_date ? 'invalid-input' : '']\" type=\"text\" :value=\"record.start_date\" _v-94175008=\"\">\n          <p v-if=\"formErrors.start_date\" class=\"help-text invalid\" _v-94175008=\"\">Need a Start Date</p>\n        </div> <!--form-group -->\n      </div> <!-- /.small-6 columns -->\n\n      <div v-bind:class=\"md6col\" _v-94175008=\"\">\n        <div v-bind:class=\"formGroup\" _v-94175008=\"\">\n          <label for=\"end-date\" _v-94175008=\"\">End Date: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-94175008=\"\"></span></label>\n          <input id=\"end-date\" class=\"form-control\" v-bind:class=\"[formErrors.end_date ? 'invalid-input' : '']\" type=\"text\" :value=\"record.end_date\" _v-94175008=\"\">\n          <p v-if=\"formErrors.end_date\" class=\"help-text invalid\" _v-94175008=\"\">Need an End Date</p>\n        </div> <!--form-group -->\n      </div> <!-- /.small-6 columns -->\n    </div> <!-- /.row -->\n\n<div id=\"preview-contents\" class=\"row\" v-show=\"record.title\" v-if=\"framework == 'foundation'\" _v-94175008=\"\">\n  <div v-bind:class=\"md12col\" _v-94175008=\"\">\n    <h3 class=\"cal-caps toptitle\" _v-94175008=\"\">Announcement Preview</h3>\n    <ul class=\"accordion\" data-accordion=\"\" _v-94175008=\"\">\n      <li class=\"accordion-item is-active\" id=\"accitem-1\" data-accordion-item=\"\" _v-94175008=\"\">\n        <a href=\"#\" class=\"accordion-title\" _v-94175008=\"\">{{record.title}}</a>\n        <div class=\"accordion-content\" data-tab-content=\"\" _v-94175008=\"\">\n          <p _v-94175008=\"\">{{record.announcement}}</p>\n          <p v-if=\"record.link\" _v-94175008=\"\">For more information visit: <a class=\"accordion-link\" target=\"_blank\" _v-94175008=\"\">{{record.link_txt}}</a></p>\n          <p v-if=\"record.email_link\" _v-94175008=\"\">Contact Email: <a class=\"accordion-link\" target=\"_blank\" _v-94175008=\"\">{{record.email_link_txt}}</a></p>\n          <p v-if=\"record.phone\" _v-94175008=\"\">Contact Phone: {{record.phone}}</p>\n          <!-- <p v-if='record.start_date'>Posted {{record.start_date}}</a></p> -->\n        </div>\n      </li>\n    </ul>\n  </div>\n</div>\n<div class=\"row\" id=\"submit-area\" _v-94175008=\"\">\n  <div v-if=\"isadmin\" :class=\"md4col\" _v-94175008=\"\">\n    <div class=\"checkbox\" _v-94175008=\"\">\n      <label _v-94175008=\"\"><input type=\"checkbox\" v-model=\"record.admin_pre_approved\" _v-94175008=\"\">Auto Approve</label>\n    </div>\n  </div>\n  <div :class=\"md8col\" _v-94175008=\"\">\n    <div :class=\"formGroup\" _v-94175008=\"\">\n      <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-94175008=\"\">{{submitBtnLabel}}</button>\n      <button v-if=\"recordexists\" id=\"btn-delete\" v-on:click=\"delAnnouncement\" type=\"submit\" class=\"redBtn\" v-bind:class=\"btnPrimary\" _v-94175008=\"\">Delete Announcement</button>\n    </div><!-- /.md12col -->\n  </div><!-- /.md12col -->\n  </div></form>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-94175008", module.exports)
  } else {
    hotAPI.update("_v-94175008", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
