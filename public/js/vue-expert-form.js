  ...
  methods: {
    ...
    fetchCurrentRecord: function fetchCurrentRecord(recid) {
      ...
      this.$http.get('/api/experts/' + recid + '/edit').then(function (response) {
        ...
        _this.fetchUsers(_this.user_id);
      }, function (response) {
...
},{"../directives/ckrte.js":9,"flatpickr":1,"moment":2,"vue":6,"vue-hot-reload-api":4,"vueify/lib/insert-css":7}],9:[function(require,module,exports){
'use strict';
...
},{"./components/ExpertForm.vue":8,"vue":6,"vue-resource":5}]},{},[10]);
