...
},{"../VuiFlipSwitch.vue":127,"babel-runtime/helpers/defineProperty":14,"moment":104,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],115:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../../directives/flatpickr.js":128,"../Pagination.vue":126,"./EmailAnnouncementPod.vue":114,"babel-runtime/helpers/defineProperty":14,"moment":104,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],116:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
},{"babel-runtime/core-js/json/stringify":1,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],117:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../VuiFlipSwitch.vue":127,"moment":104,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],118:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../../directives/flatpickr.js":128,"./EmailEventPod.vue":117,"moment":104,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],119:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../VuiFlipSwitch.vue":127,"./EmailAnnouncementQueue.vue":115,"./EmailDeleteModal.vue":116,"./EmailEventQueue.vue":118,"./EmailLiveView.vue":120,"./EmailMainStoryQueue.vue":121,"./EmailStatsModal.vue":122,"./EmailStoryQueue.vue":124,"babel-runtime/helpers/defineProperty":14,"flatpickr":103,"moment":104,"vue":111,"vue-hot-reload-api":107,"vue-select":109,"vueify/lib/insert-css":112}],120:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<section id=\"email-live-container\" style=\"margin:0 auto; width:620px; padding:10px; border:1px solid #d1d1d1; overflow:scroll; overflow-y: hidden; margin-bottom:20px\" _v-2c477ab3=\"\">\n  <table border=\"0\" cellpadding=\"5\" cellspacing=\"0\" height=\"100%\" width=\"100%\" id=\"bodyTable\" _v-2c477ab3=\"\">\n      <tbody _v-2c477ab3=\"\"><tr _v-2c477ab3=\"\">\n          <td align=\"center\" valign=\"top\" _v-2c477ab3=\"\">\n              <table border=\"0\" width=\"600\" id=\"emailContainer\" _v-2c477ab3=\"\">\n                  <tbody _v-2c477ab3=\"\"><tr valign=\"top\" id=\"header-row\" _v-2c477ab3=\"\">\n                    <td colspan=\"2\" _v-2c477ab3=\"\">\n                      <img src=\"/assets/imgs/email/emailblast_logo_template_600x120.png\" width=\"600\" style=\"padding:5px 0px 5px 0px\" alt=\"EMU Today email blast logo\" _v-2c477ab3=\"\">\n                    </td>\n                  </tr>\n                  <tr valign=\"top\" id=\"title-row\" _v-2c477ab3=\"\">\n                    <td colspan=\"2\" style=\"text-align:center\" _v-2c477ab3=\"\">\n                      <header _v-2c477ab3=\"\">\n                        <h1 _v-2c477ab3=\"\">{{ email.title }}</h1>\n                        <p _v-2c477ab3=\"\">{{ email.subheading }}</p>\n                      </header>\n                    </td>\n                  </tr>\n                  <tr _v-2c477ab3=\"\">\n                      <td valign=\"top\" width=\"368\" _v-2c477ab3=\"\">\n                        <template v-if=\"email.mainStory\">\n                          <article _v-2c477ab3=\"\">\n                            <img :src=\"email.mainStory.email_images[0].image_path + email.mainStory.email_images[0].filename\" :alt=\"email.mainStory.email_images[0].title\" style=\"border-right:5px solid #ffffff; width:368px; height:245px; \" _v-2c477ab3=\"\">\n                            <h2 _v-2c477ab3=\"\">{{email.mainStory.title}}</h2>\n                            {{{ email.mainStory.content | truncate '60' }}}\n                            <p _v-2c477ab3=\"\"><a :href=\"email.mainStory.full_url\" _v-2c477ab3=\"\">Read More</a></p>\n                          </article>\n                        </template>\n                        <template v-else=\"\">\n                          <div style=\"background-color:#e5e5e5; position:relative; width:368px; height:245px; text-align:center; margin:0 auto; border-right:5px solid #ffffff;\" _v-2c477ab3=\"\">\n                            <p style=\"position:absolute; left:38px; top:96px; font-size:3rem;\" _v-2c477ab3=\"\">Main story image here.</p>\n                          </div>\n                          <h2 style=\"padding:0 5px\" class=\"insufficient\" _v-2c477ab3=\"\">No main story set yet.</h2>\n                          <p style=\"padding:0 5px\" _v-2c477ab3=\"\">Select a main story from the \"Main Story\" tab.</p>\n                        </template>\n                        <hr _v-2c477ab3=\"\">\n                      </td>\n                      <td rowspan=\"3\" valign=\"top\" width=\"232\" style=\"background:#e5e5e5\" _v-2c477ab3=\"\">\n                        <template v-if=\"email.events.length > 0\">\n                          <h3 style=\"padding:0 5px\" _v-2c477ab3=\"\">Upcoming Events</h3>\n                          <article v-for=\"event in email.events\" style=\"padding:0 5px\" _v-2c477ab3=\"\">\n                            <hr _v-2c477ab3=\"\">\n                            <h4 _v-2c477ab3=\"\">{{event.title}}</h4><h4 _v-2c477ab3=\"\">\n                            {{ event.start_date }} | {{ event.start_time }} | {{ event.location }}\n                            <p _v-2c477ab3=\"\"><a :href=\"event.full_url\" _v-2c477ab3=\"\">View Event</a></p>\n                          </h4></article>\n                        </template>\n                        <template v-else=\"\">\n                          <p style=\"padding:0 5px\" class=\"insufficient\" _v-2c477ab3=\"\">No events set yet. Select at least one from the \"Events\" tab.</p>\n                        </template>\n                      </td>\n                  </tr>\n                  <tr _v-2c477ab3=\"\">\n                    <td valign=\"top\" _v-2c477ab3=\"\">\n                      <template v-if=\"email.otherStories.length > 0\">\n                        <h3 _v-2c477ab3=\"\">Featured News Stories</h3>\n                        <article v-for=\"story in email.otherStories\" _v-2c477ab3=\"\">\n                          <h4 _v-2c477ab3=\"\">{{story.title}}</h4><h4 _v-2c477ab3=\"\">\n                          {{{ story.content | truncate '30' }}}\n                          <p _v-2c477ab3=\"\"><a :href=\"story.full_url\" _v-2c477ab3=\"\">Read More</a></p>\n                        </h4></article>\n                      </template>\n                      <template v-else=\"\">\n                        <p style=\"padding:0 5px\" class=\"insufficient\" _v-2c477ab3=\"\">No side stories set yet. Select at least one from the \"Side Stories\" tab.</p>\n                      </template>\n                      <hr _v-2c477ab3=\"\">\n                    </td>\n                  </tr>\n                  <tr _v-2c477ab3=\"\">\n                    <td valign=\"top\" _v-2c477ab3=\"\">\n                      <template v-if=\"email.announcements.length > 0\">\n                        <h3 _v-2c477ab3=\"\">Announcements</h3>\n                        <article v-for=\"announcement in email.announcements\" _v-2c477ab3=\"\">\n                          <h4 _v-2c477ab3=\"\">{{ announcement.title }}</h4>\n                          <p _v-2c477ab3=\"\">{{ announcement.announcement | truncate '30' }}</p>\n                          <p _v-2c477ab3=\"\"><a :href=\"announcement.link\" _v-2c477ab3=\"\">{{ announcement.link_txt }}</a></p>\n                        </article>\n                      </template>\n                      <template v-else=\"\">\n                        <p style=\"padding:0 5px\" class=\"insufficient\" _v-2c477ab3=\"\">No announcements set yet. Select at least one from the \"Announcements\" tab.</p>\n                      </template>\n                    </td>\n                  </tr>\n                  <tr id=\"footer-row\" style=\"background:#555555; margin-top:5px; color:#ffffff;\" _v-2c477ab3=\"\">\n                      <td valign=\"top\" width=\"368\" style=\"padding:5px\" _v-2c477ab3=\"\">\n                        <ul class=\"social-icons\" style=\"padding-left: 5px;\" _v-2c477ab3=\"\">\n                          <li style=\"float:left; list-style-type:none; padding-right:10px;\" _v-2c477ab3=\"\"><a href=\"https://www.facebook.com/EasternMichU/\" _v-2c477ab3=\"\"><img alt=\"Facebook\" src=\"/assets/imgs/icons/facebook-base-icons.png\" _v-2c477ab3=\"\"></a></li>\n                          <li style=\"float:left; list-style-type:none; padding-right:10px;\" _v-2c477ab3=\"\"><a href=\"http://www.emich.edu/twitter/\" _v-2c477ab3=\"\"><img alt=\"Twitter\" src=\"/assets/imgs/icons/twitter-base-icons.png\" _v-2c477ab3=\"\"></a></li>\n                          <li style=\"float:left; list-style-type:none; padding-right:10px;\" _v-2c477ab3=\"\"><a href=\"https://www.youtube.com/user/emichigan08\" _v-2c477ab3=\"\"><img alt=\"YouTube\" src=\"/assets/imgs/icons/you-tube-base-icons.png\" _v-2c477ab3=\"\"></a></li>\n                          <li style=\"float:left; list-style-type:none; padding-right:10px;\" _v-2c477ab3=\"\"><a href=\"https://instagram.com/easternmichigan/\" _v-2c477ab3=\"\"><img alt=\"Instagram\" src=\"/assets/imgs/icons/instagram-base-icons-new.png\" _v-2c477ab3=\"\"></a></li>\n                          <li style=\"float:left; list-style-type:none; padding-right:10px;\" _v-2c477ab3=\"\"><a href=\"https://www.linkedin.com/edu/school?id=18604\" _v-2c477ab3=\"\"><img alt=\"Linked-In\" src=\"/assets/imgs/icons/linked-in-base-icons.png\" _v-2c477ab3=\"\"></a></li>\n                          <li style=\"float:left; list-style-type:none; padding-right:10px;\" _v-2c477ab3=\"\"><a href=\"http://blogemu.com/\" _v-2c477ab3=\"\"><img alt=\"Blog EMU\" src=\"/assets/imgs/icons/e-base-icons.png\" _v-2c477ab3=\"\"></a></li>\n                        </ul>\n                      </td>\n                      <td valign=\"top\" width=\"232\" style=\"padding:5px; text-align:center\" _v-2c477ab3=\"\">\n                        <a style=\"color:#ffffff\" href=\"https://today.emich.edu\" _v-2c477ab3=\"\">EMU Today</a> | <a style=\"color:#ffffff\" href=\"https://today.emich.edu/magazine\" _v-2c477ab3=\"\">Eastern Magazine</a>\n                      </td>\n                  </tr>\n              </tbody></table>\n          </td>\n      </tr>\n  </tbody></table>\n</section>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],121:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../../directives/flatpickr.js":128,"../../directives/iconradio.js":129,"../IconToggleBtn.vue":125,"../Pagination.vue":126,"./EmailStoryPod.vue":123,"babel-runtime/core-js/object/keys":10,"moment":104,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],122:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
},{"../../directives/flatpickr.js":128,"../../directives/iconradio.js":129,"../IconToggleBtn.vue":125,"../Pagination.vue":126,"./EmailStoryPod.vue":123,"babel-runtime/core-js/object/keys":10,"moment":104,"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],125:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.item-type-icon {\n    color: #1B1B1B;\n    /*position:absolute;\n    top: 5px;\n    left: 5px;*/\n\n}\n")
'use strict';
...
},{"vue":111,"vue-hot-reload-api":107,"vueify/lib/insert-css":112}],126:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.cursor[_v-6eea2f11]{\n    cursor: pointer;\n}\n")
'use strict';
...
},{"flatpickr":103}],129:[function(require,module,exports){
'use strict';
...
},{"./components/Email/EmailForm.vue":119,"./vuex/store":131,"vue":111,"vue-resource":108,"vue-sortable":110}],131:[function(require,module,exports){
'use strict';
