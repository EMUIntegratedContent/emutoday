...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"row\" _v-efe077e4=\"\">\n        <!-- Date Filter -->\n        <div class=\"col-xs-12 col-sm-12 col-md-4 col-lg-6\" _v-efe077e4=\"\">\n            <form class=\"form-inline\" _v-efe077e4=\"\">\n              <div class=\"form-group\" _v-efe077e4=\"\">\n                  <label for=\"start-date\" _v-efe077e4=\"\">Showing <template v-if=\"this.stype == 'featurephoto'\">photos</template><template v-else=\"\">stories</template> starting <span v-if=\"isEndDate\" _v-efe077e4=\"\">between</span><span v-else=\"\" _v-efe077e4=\"\">on or after</span></label>\n                  <input v-if=\"startdate\" v-model=\"startdate\" type=\"text\" :initval=\"startdate\" v-flatpickr=\"startdate\" _v-efe077e4=\"\">\n              </div>\n              <div v-if=\"isEndDate\" class=\"form-group\" _v-efe077e4=\"\">\n                  <label for=\"start-date\" _v-efe077e4=\"\"> and </label>\n                  <input v-if=\"enddate\" type=\"text\" :initval=\"enddate\" v-flatpickr=\"enddate\" _v-efe077e4=\"\">\n              </div>\n              <button type=\"button\" class=\"btn btn-sm btn-info\" @click=\"fetchAllRecords\" _v-efe077e4=\"\">Filter</button>\n              <a href=\"#\" id=\"rangetoggle\" @click=\"toggleRange\" _v-efe077e4=\"\"><span v-if=\"isEndDate\" _v-efe077e4=\"\"> - Remove </span><span v-else=\"\" _v-efe077e4=\"\"> + Add </span>Range</a>\n            </form>\n        </div>\n        <!-- TEXT filter -->\n        <div class=\"col-xs-12 col-sm-12 col-md-4 col-lg-3\" _v-efe077e4=\"\">\n            <form class=\"form-inline\" v-on:submit.prevent=\"\" _v-efe077e4=\"\">\n              <div class=\"form-group\" _v-efe077e4=\"\">\n                  <label for=\"search-filter\" _v-efe077e4=\"\">Search titles</label>\n                  <input v-model=\"textFilter\" id=\"search-filter\" type=\"text\" class=\"form-control\" _v-efe077e4=\"\">\n              </div>\n            </form>\n        </div>\n        <div v-if=\"canApprove\" class=\"col-xs-12 col-sm-12 col-md-4 col-lg-3 text-right\" _v-efe077e4=\"\">\n            <a class=\"btn btn-sm btn-default\" href=\"/admin/archive/queue/stories\" _v-efe077e4=\"\"><i class=\"fa fa-archive\" _v-efe077e4=\"\"></i> Archived Stories</a>\n        </div>\n    </div>\n    <hr _v-efe077e4=\"\">\n    <div class=\"row\" _v-efe077e4=\"\">\n        <h2 v-if=\"loading\" class=\"col-md-12\" _v-efe077e4=\"\">Loading. Please Wait...</h2>\n        <div class=\"col-md-4\" _v-efe077e4=\"\">\n            <h4 _v-efe077e4=\"\"><span class=\"badge\" _v-efe077e4=\"\">{{ itemsUnapproved ? itemsUnapproved.length : 0 }}</span> Unapproved<p _v-efe077e4=\"\"></p></h4>\n            <div v-show=\"checkRoleAndQueueType\" class=\"btn-toolbar\" role=\"toolbar\" _v-efe077e4=\"\">\n                <div class=\"btn-group btn-group-xs\" role=\"group\" _v-efe077e4=\"\">\n                    <label _v-efe077e4=\"\">Filter: </label>\n                </div>\n                <div class=\"btn-group btn-group-xs\" role=\"group\" aria-label=\"typeFiltersLabel\" data-toggle=\"buttons\" v-iconradio=\"items_unapproved_filter_storytype\" _v-efe077e4=\"\">\n                     <template v-for=\"item in storyTypeIcons\">\n                         <label class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"{{item.name}}\" _v-efe077e4=\"\"><input type=\"radio\" autocomplete=\"off\" value=\"{{item.shortname}}\" _v-efe077e4=\"\"><span class=\"item-type-icon-shrt\" :class=\"typeIcon(item.shortname)\" _v-efe077e4=\"\"></span></label>\n                    </template>\n              </div>\n            </div>\n            <div id=\"items-unapproved\" _v-efe077e4=\"\">\n                <story-pod pid=\"items-unapproved\" :role=\"role\" :sroute=\"sroute\" :stype=\"stype\" :gtype=\"gtype\" :qtype=\"qtype\" v-for=\"item in itemsUnapproved | orderBy 'start_date' 1 | filterBy filterUnapprovedByStoryType\" @item-change=\"moveToApproved\" :item=\"item\" :index=\"$index\" :is=\"items-unapproved\" _v-efe077e4=\"\">\n                </story-pod>\n            </div>\n    </div><!-- /.col-md-4 -->\n    <div class=\"col-md-4\" _v-efe077e4=\"\">\n        <h4 _v-efe077e4=\"\"><span class=\"badge\" _v-efe077e4=\"\">{{ itemsApproved ? itemsApproved.length : 0 }}</span> Approved</h4>\n        <div v-show=\"checkRoleAndQueueType\" class=\"btn-toolbar\" role=\"toolbar\" _v-efe077e4=\"\">\n            <div class=\"btn-group btn-group-xs\" role=\"group\" _v-efe077e4=\"\">\n                <label _v-efe077e4=\"\">Filter: </label>\n            </div>\n            <div class=\"btn-group btn-group-xs\" role=\"group\" aria-label=\"typeFiltersLabel\" data-toggle=\"buttons\" v-iconradio=\"items_approved_filter_storytype\" _v-efe077e4=\"\">\n                 <template v-for=\"item in storyTypeIcons\">\n                     <label class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"{{item.name}}\" _v-efe077e4=\"\"><input type=\"radio\" autocomplete=\"off\" value=\"{{item.shortname}}\" _v-efe077e4=\"\"><span class=\"item-type-icon-shrt\" :class=\"typeIcon(item.shortname)\" _v-efe077e4=\"\"></span></label>\n                </template>\n          </div>\n      </div>\n        <div id=\"items-approved\" _v-efe077e4=\"\">\n            <story-pod pid=\"items-approved\" :role=\"role\" :sroute=\"sroute\" :stype=\"stype\" :gtype=\"gtype\" :qtype=\"qtype\" v-for=\"item in itemsApproved | orderBy 'start_date' 1 | filterBy filterApprovedByStoryType\" @item-change=\"moveToUnApproved\" :item=\"item\" :index=\"$index\" :is=\"items-approved\" _v-efe077e4=\"\">\n            </story-pod>\n        </div>\n    </div><!-- /.col-md-4 -->\n    <div class=\"col-md-4\" _v-efe077e4=\"\">\n        <div id=\"items-live\" _v-efe077e4=\"\">\n          <!-- ELEVATED ANNOUNCEMENTS -->\n          <template v-if=\"canElevate\">\n            <h3 _v-efe077e4=\"\"><span class=\"badge\" _v-efe077e4=\"\">{{ elevateditems ? elevateditems.length : 0 }}</span> Elevated (all story types)</h3>\n            <p _v-efe077e4=\"\">To rearrange the order of stories, drag the pod to the desired location. To demote a story, click the red 'X' on the pod. Click \"save order\" button when done. Note: this list is NOT filtered by date.</p>\n            <div v-show=\"ordersave.isOk\" class=\"alert alert-success alert-dismissible\" _v-efe077e4=\"\">\n              <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-efe077e4=\"\"><i class=\"fa fa-times\" _v-efe077e4=\"\"></i></button>\n              <h5 _v-efe077e4=\"\">{{ordersave.msg}}</h5>\n            </div>\n            <div v-show=\"ordersave.isErr\" class=\"alert alert-danger alert-dismissible\" _v-efe077e4=\"\">\n              <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-efe077e4=\"\"><i class=\"fa fa-times\" _v-efe077e4=\"\"></i></button>\n              <h5 _v-efe077e4=\"\">{{ordersave.msg}}</h5>\n            </div>\n            <template v-if=\"elevateditemschanged\">\n              <div class=\"ordersave-container\" _v-efe077e4=\"\">\n                <button @click=\"updateElevatedOrder\" class=\"btn btn-info\" _v-efe077e4=\"\">Save Order</button>\n                <button @click=\"resetElevatedOrder\" class=\"btn btn-default\" _v-efe077e4=\"\">Reset</button>\n              </div>\n            </template>\n            <template v-if=\"elevateditems.length > 0\">\n              <ul class=\"list-group\" v-sortable=\"{ onUpdate: updateOrder }\" _v-efe077e4=\"\">\n                <li v-for=\"item in elevateditems\" class=\"list-group-item\" _v-efe077e4=\"\">\n                  <story-pod pid=\"item-elevated\" :role=\"role\" :sroute=\"sroute\" :stype=\"stype\" :gtype=\"gtype\" :qtype=\"qtype\" :item=\"item\" :is=\"item-elevated\" _v-efe077e4=\"\">\n                  </story-pod>\n                </li>\n              </ul>\n            </template>\n            <template v-else=\"\">\n              <p _v-efe077e4=\"\">There are no elevated stories.</p>\n            </template>\n          </template>\n          <hr _v-efe077e4=\"\"> <!-- End elevated announcements -->\n          <h4 _v-efe077e4=\"\"><span class=\"badge\" _v-efe077e4=\"\">{{ itemsLive ? itemsLive.length : 0 }}</span> Live <small _v-efe077e4=\"\">Approved and Start Date has passed</small></h4>\n          <div v-show=\"checkRoleAndQueueType\" class=\"btn-toolbar\" role=\"toolbar\" _v-efe077e4=\"\">\n              <div class=\"btn-group btn-group-xs\" role=\"group\" _v-efe077e4=\"\">\n                  <label _v-efe077e4=\"\">Filter: </label>\n              </div>\n              <div class=\"btn-group btn-group-xs\" role=\"group\" aria-label=\"typeFiltersLabel\" data-toggle=\"buttons\" v-iconradio=\"items_live_filter_storytype\" _v-efe077e4=\"\">\n                   <template v-for=\"item in storyTypeIcons\">\n                       <label class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"{{item.name}}\" _v-efe077e4=\"\"><input type=\"radio\" autocomplete=\"off\" value=\"{{item.shortname}}\" _v-efe077e4=\"\"><span class=\"item-type-icon-shrt\" :class=\"typeIcon(item.shortname)\" _v-efe077e4=\"\"></span></label>\n                  </template>\n            </div>\n          </div>\n          <story-pod pid=\"items-live\" :role=\"role\" :sroute=\"sroute\" :stype=\"stype\" :gtype=\"gtype\" :qtype=\"qtype\" v-for=\"item in itemsLive | orderBy 'start_date' -1 | filterBy filterLiveByStoryType\" @item-change=\"moveToUnApproved\" :elevated-storys=\"elevateditems\" :item=\"item\" :index=\"$index\" :is=\"items-live\" _v-efe077e4=\"\">\n          </story-pod>\n      </div>\n    </div><!-- /.col-md-4 -->\n</div><!-- ./row -->\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
