...
var __vueify_style__ = __vueify_insert__.insert("\n\n#items-unapproved .box[_v-37aa9489] {\n  margin-bottom: 4px;\n}\n\n#items-approved .box[_v-37aa9489] {\n  margin-bottom: 4px;\n}\n\n#rangetoggle[_v-37aa9489]{\n    color: #FF851B;\n    margin-left: 5px;\n    border-bottom: 2px #FF851B dotted;\n}\n\n\n\n.ordersave-container{\n  margin-bottom:10px;\n}\n")
'use strict';
  ...
  methods: {
    ...
    filterItemsApproved: function filterItemsApproved(items) {
      ...
      return items.filter(function (item) {
        return (0, _moment2.default)(item.start_date).isAfter((0, _moment2.default)()) && item.is_approved === 1 && item.priority === 0 && item.is_archived === 0 && regexp.test(item.title);
      });
    },
    ...
    filterItemsLive: function filterItemsLive(items) {
      var regexp = new RegExp(this.textFilter, 'gi'); // anywhere in the string, ignore case
      return items.filter(function (item) {
        return ((0, _moment2.default)(item.start_date).isSameOrBefore((0, _moment2.default)()) && item.is_approved === 1 && item.is_archived === 0 || item.is_approved === 1 && item.priority > 0 && item.is_archived === 0) && regexp.test(item.title); // true
      });
    },
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"row\" _v-37aa9489=\"\">\n        <div class=\"col-xs-12 col-sm-12 col-md-4 col-lg-5\" _v-37aa9489=\"\">\n            <form class=\"form-inline\" _v-37aa9489=\"\">\n              <div class=\"form-group\" _v-37aa9489=\"\">\n                  <label for=\"start-date\" _v-37aa9489=\"\">Showing announcements starting <span v-if=\"isEndDate\" _v-37aa9489=\"\">between</span><span v-else=\"\" _v-37aa9489=\"\">on or after</span></label>\n                  <input v-if=\"startdate\" v-model=\"startdate\" type=\"text\" :initval=\"startdate\" v-flatpickr=\"startdate\" _v-37aa9489=\"\">\n              </div>\n              <div v-if=\"isEndDate\" class=\"form-group\" _v-37aa9489=\"\">\n                  <label for=\"start-date\" _v-37aa9489=\"\"> and </label>\n                  <input v-if=\"enddate\" type=\"text\" :initval=\"enddate\" v-flatpickr=\"enddate\" _v-37aa9489=\"\">\n              </div>\n              <button type=\"button\" class=\"btn btn-sm btn-info\" @click=\"fetchAllRecords\" _v-37aa9489=\"\">Filter</button>\n              <a href=\"#\" id=\"rangetoggle\" @click=\"toggleRange\" _v-37aa9489=\"\"><span v-if=\"isEndDate\" _v-37aa9489=\"\"> - Remove </span><span v-else=\"\" _v-37aa9489=\"\"> + Add </span>Range</a>\n            </form>\n        </div>\n        <!-- TEXT filter -->\n        <div class=\"col-xs-12 col-sm-12 col-md-4 col-lg-4\" _v-37aa9489=\"\">\n            <form class=\"form-inline\" v-on:submit.prevent=\"\" _v-37aa9489=\"\">\n              <div class=\"form-group\" _v-37aa9489=\"\">\n                  <label for=\"search-filter\" _v-37aa9489=\"\">Search titles</label>\n                  <input v-model=\"textFilter\" id=\"search-filter\" type=\"text\" class=\"form-control\" _v-37aa9489=\"\">\n              </div>\n            </form>\n        </div>\n        <div v-if=\"role == 'admin' || role == 'admin_super'\" class=\"col-xs-12 col-sm-12 col-md-4 col-lg-3 text-right\" _v-37aa9489=\"\">\n            <a class=\"btn btn-sm btn-default\" href=\"/admin/archive/queue/announcements\" _v-37aa9489=\"\"><i class=\"fa fa-archive\" _v-37aa9489=\"\"></i> Archived Announcements</a>\n        </div>\n    </div>\n    <hr _v-37aa9489=\"\">\n  <div class=\"row\" _v-37aa9489=\"\">\n      <h2 v-if=\"loading\" class=\"col-md-12\" _v-37aa9489=\"\">Loading. Please Wait...</h2>\n    <div class=\"col-md-4\" _v-37aa9489=\"\">\n      <h3 _v-37aa9489=\"\"><span class=\"badge\" _v-37aa9489=\"\">{{ itemsUnapproved ? itemsUnapproved.length : 0 }}</span> Unapproved</h3>\n      <div id=\"items-unapproved\" _v-37aa9489=\"\">\n        <announcement-queue-item pid=\"items-unapproved\" v-for=\"item in itemsUnapproved | orderBy 'start_date' 1\" :item=\"item\" :index=\"$index\" :is=\"unapproved-list\" :atype=\"atype\" _v-37aa9489=\"\">\n      </announcement-queue-item>\n    </div>\n  </div>\n  <!-- /.col-md-6 -->\n  <div class=\"col-md-4\" _v-37aa9489=\"\">\n    <h3 _v-37aa9489=\"\"><span class=\"badge\" _v-37aa9489=\"\">{{ itemsApproved ? itemsApproved.length : 0 }}</span> Approved</h3>\n    <div id=\"items-approved\" _v-37aa9489=\"\">\n      <announcement-queue-item pid=\"items-approved\" v-for=\"item in itemsApproved | orderBy 'start_date' -1\" :item=\"item\" :index=\"$index\" :is=\"approved-list\" :atype=\"atype\" _v-37aa9489=\"\">\n    </announcement-queue-item>\n  </div>\n</div>\n<div class=\"col-md-4\" _v-37aa9489=\"\">\n\n  <div id=\"items-live\" _v-37aa9489=\"\">\n    <!-- ELEVATED ANNOUNCEMENTS -->\n    <template v-if=\"canElevate\">\n      <h3 _v-37aa9489=\"\"><span class=\"badge\" _v-37aa9489=\"\">{{ elevateditems ? elevateditems.length : 0 }}</span> Elevated</h3>\n      <p _v-37aa9489=\"\">To rearrange the order of announcements, drag the pod to the desired location. To demote an announcement, click the red 'X' on the pod. Click \"save order\" button when done. Note: this list is NOT filtered by date.</p>\n      <div v-show=\"ordersave.isOk\" class=\"alert alert-success alert-dismissible\" _v-37aa9489=\"\">\n        <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-37aa9489=\"\"><i class=\"fa fa-times\" _v-37aa9489=\"\"></i></button>\n        <h5 _v-37aa9489=\"\">{{ordersave.msg}}</h5>\n      </div>\n      <div v-show=\"ordersave.isErr\" class=\"alert alert-danger alert-dismissible\" _v-37aa9489=\"\">\n        <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-37aa9489=\"\"><i class=\"fa fa-times\" _v-37aa9489=\"\"></i></button>\n        <h5 _v-37aa9489=\"\">{{ordersave.msg}}</h5>\n      </div>\n      <template v-if=\"elevateditemschanged\">\n        <div class=\"ordersave-container\" _v-37aa9489=\"\">\n          <button @click=\"updateElevatedOrder\" class=\"btn btn-info\" _v-37aa9489=\"\">Save Order</button>\n          <button @click=\"resetElevatedOrder\" class=\"btn btn-default\" _v-37aa9489=\"\">Reset</button>\n        </div>\n      </template>\n      <template v-if=\"elevateditems.length > 0\">\n        <ul class=\"list-group\" v-sortable=\"{ onUpdate: updateOrder }\" _v-37aa9489=\"\">\n          <li v-for=\"item in elevateditems\" class=\"list-group-item\" _v-37aa9489=\"\">\n            <announcement-queue-item pid=\"item-elevated\" :item=\"item\" :is=\"item-elevated\" :elevated-announcements=\"elevateditems\" :atype=\"atype\" _v-37aa9489=\"\">\n            </announcement-queue-item>\n          </li>\n        </ul>\n      </template>\n      <template v-else=\"\">\n        <p _v-37aa9489=\"\">There are no elevated announcements.</p>\n      </template>\n    </template>\n    <hr _v-37aa9489=\"\"> <!-- End elevated announcements -->\n    <h3 _v-37aa9489=\"\"><span class=\"badge\" _v-37aa9489=\"\">{{ itemsLive ? itemsLive.length : 0 }}</span> Live</h3>\n    <announcement-queue-item pid=\"items-live\" v-for=\"item in itemsLive | orderBy 'start_date' -1\" :elevated-announcements=\"elevateditems\" :item=\"item\" :index=\"$index\" :is=\"items-live\" :atype=\"atype\" _v-37aa9489=\"\">\n  </announcement-queue-item>\n</div>\n</div>\n<!-- /.col-md-6 -->\n</div>\n<!-- ./row -->\n\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-37aa9489", module.exports)
  } else {
    hotAPI.update("_v-37aa9489", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.box[_v-200f5c88] {\n  color: #1B1B1B;\n  margin-bottom: 10px;\n}\n.box-body[_v-200f5c88] {\n  background-color: #fff;\n  border-bottom-left-radius: 0;\n  border-bottom-right-radius: 0;\n  margin:0;\n}\n\n.box-header[_v-200f5c88] {\n  padding: 3px;\n}\n\nbutton.footer-btn[_v-200f5c88] {\n  border-color: #1B1B1B;\n\n}\n\nh6.box-title[_v-200f5c88] {\n  color: #1B1B1B;\n}\n\n\n.zcallout[_v-200f5c88] {\n  border-radius: 5px;\n  /*margin: 0 0 20px 0;*/\n  /*padding: 15px 30px 15px 15px;*/\n  border-left: 50px solid #ff0000;\n}\nform[_v-200f5c88] {\n  display:-webkit-inline-box;\n  display:-ms-inline-flexbox;\n  display:inline-flex;\n}\n.form-group[_v-200f5c88] {\n  margin-bottom: 2px;\n}\n#applabel[_v-200f5c88]{\n  margin-left: 2px;\n  margin-right: 2px;\n  padding-left: 2px;\n  padding-right: 2px;\n}\n\n.btn-group[_v-200f5c88],\n.btn-group-vertical[_v-200f5c88] {\n  display:-webkit-inline-box;\n  display:-ms-inline-flexbox;\n  display:inline-flex;\n}\nselect.form-control[_v-200f5c88] {\n  height:22px;\n  border: 1px solid #999999;\n}\nh6[_v-200f5c88] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\nh5[_v-200f5c88] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\n.form-group[_v-200f5c88] {\n  /*border: 1px solid red;*/\n}\n.form-group label[_v-200f5c88]{\n  margin-bottom: 0;\n}\n\n\n.box-footer[_v-200f5c88] {\n  padding: 3px;\n}\n.box.box-solid.box-default[_v-200f5c88] {\n  border: 1px solid #999999;\n}\n\n.topitems[_v-200f5c88] {\n  /*background-color: #9B59B6;*/\n  background-color: #76D7EA;\n  border: 2px solid #9B59B6;\n}\n.ongoing[_v-200f5c88] {\n  background-color: #ffcc33;\n  border: 1px solid #999999\n}\n.event-positive[_v-200f5c88] {\n\n  background-color: #D8D8D8;\n  border: 1px solid #999999;\n}\n.event-negative[_v-200f5c88] {\n\n  background-color: #999999;\n  border: 1px solid #999999;\n}\n.is-promoted[_v-200f5c88] {\n\n  background-color: #76D7EA;\n  /*border: 1px solid #999999*/\n}\n.time-is-short[_v-200f5c88] {\n  color: #F39C12;\n}\n.time-is-long[_v-200f5c88] {\n  color: #999999;\n}\n.time-is-over[_v-200f5c88] {\n  color: #9B59B6;\n}\n\n.special-item[_v-200f5c88] {\n  border-left: 6px solid #bfff00;\n\n  padding-left: 3px;\n  border-top-left-radius:3px;\n  border-bottom-left-radius: 3px;\n  margin-left: -10px;\n\n}\n.special-item-last[_v-200f5c88] {\n  margin-bottom: 30px;\n}\n.remove-announcement-btn[_v-200f5c88]{\n  margin-left: 10px;\n}\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <div :class=\"specialItem\" _v-200f5c88=\"\">\n    <div :class=\"liveTimeStatusClass\" class=\"box box-solid\" _v-200f5c88=\"\">\n      <div class=\"box-header with-border\" _v-200f5c88=\"\">\n        <div class=\"row\" _v-200f5c88=\"\">\n          <div class=\"col-sm 12 col-md-4\" _v-200f5c88=\"\">\n            <div class=\"box-date-top pull-left\" _v-200f5c88=\"\">{{item.start_date | titleDateLong}}</div>\n          </div><!-- /.col-sm-6 -->\n          <div class=\"col-sm 12 col-md-8\" _v-200f5c88=\"\">\n            <form class=\"form-inline pull-right\" _v-200f5c88=\"\">\n              <template v-if=\"pid == 'items-live'\">\n                <div class=\"form-check\" _v-200f5c88=\"\">\n                  <label class=\"form-check-label\" _v-200f5c88=\"\">\n                    Elevate\n                    <input type=\"checkbox\" class=\"form-check-input\" @click=\"toggleEmitAnnouncementElevate(item)\" v-model=\"checked\" :checked=\"isElevatedAnnouncement\" _v-200f5c88=\"\"> |\n                  </label>\n                </div>\n              </template>\n              <template v-if=\"pid != 'item-elevated'\">\n                <div id=\"applabel\" class=\"form-group \" _v-200f5c88=\"\">\n                  <label _v-200f5c88=\"\">  approved:</label>\n                </div><!-- /.form-group -->\n                <div class=\"form-group\" _v-200f5c88=\"\">\n                  <vui-flip-switch id=\"switch-{{item.id}}\" v-on:click.prevent=\"changeIsApproved\" :value.sync=\"patchRecord.is_approved\" _v-200f5c88=\"\">\n                  </vui-flip-switch>\n                </div>\n              </template>\n              <template v-if=\"pid == 'item-elevated'\">\n                  <label v-if=\"atype == 'general'\" _v-200f5c88=\"\"><input type=\"checkbox\" @click=\"toggleEmitSpecialAnnouncement(item)\" v-model=\"checked\" :checked=\"item.priority == 1000000\" :disabled=\"item.priority != 1000000 &amp;&amp; isSpecialAnnouncementPresent\" _v-200f5c88=\"\">  Special</label>\n                  <button type=\"button\" class=\"btn btn-sm btn-danger pull-right remove-announcement-btn\" @click=\"emitAnnouncementDemote(item)\" _v-200f5c88=\"\"><i class=\"fa fa-times\" aria-hidden=\"true\" _v-200f5c88=\"\"></i></button>\n              </template>\n          </form>\n        </div><!-- /.col-md-12 -->\n      </div><!-- /.row -->\n      <div class=\"row\" _v-200f5c88=\"\">\n        <a v-on:click.prevent=\"toggleBody\" href=\"#\" _v-200f5c88=\"\">\n          <div class=\"col-sm-12\" _v-200f5c88=\"\">\n            <h6 class=\"box-title\" _v-200f5c88=\"\">{{item.title}}</h6>\n          </div><!-- /.col-md-12 -->\n        </a>\n      </div><!-- /.row -->\n    </div>  <!-- /.box-header -->\n    <div v-if=\"showBody\" class=\"box-body\" _v-200f5c88=\"\">\n      <p _v-200f5c88=\"\">{{item.announcement}}</p>\n      <div class=\"announcement-info\" _v-200f5c88=\"\">\n        Submitted On: {{item.submission_date}}<br _v-200f5c88=\"\">\n        By: {{item.submitter}}<br _v-200f5c88=\"\">\n        Dates: {{item.start_date}} - {{item.end_date}}\n      </div>\n    </div><!-- /.box-body -->\n    <div class=\"box-footer list-footer\" _v-200f5c88=\"\">\n      <div class=\"row\" _v-200f5c88=\"\">\n        <div class=\"col-sm-12 col-md-9 \" _v-200f5c88=\"\">\n          <span :class=\"timeFromNowStatus\" _v-200f5c88=\"\">Live {{timefromNow}}</span> <span :class=\"timeLeftStatus\" _v-200f5c88=\"\">{{timeLeft}}</span>\n        </div><!-- /.col-md-7 -->\n        <div class=\"col-sm-12 col-md-3\" _v-200f5c88=\"\">\n          <div class=\"btn-group pull-right\" _v-200f5c88=\"\">\n            <button v-on:click.prevent=\"editItem\" class=\"btn bg-orange btn-xs footer-btn\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"edit\" _v-200f5c88=\"\"><i class=\"fa fa-pencil\" _v-200f5c88=\"\"></i></button>\n            <button v-on:click.prevent=\"archiveItem\" class=\"btn bg-orange btn-xs footer-btn\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"archive\" _v-200f5c88=\"\"><i class=\"fa fa-archive\" _v-200f5c88=\"\"></i></button>\n          </div><!-- /.btn-toolbar -->\n        </div><!-- /.col-md-7 -->\n      </div><!-- /.row -->\n    </div><!-- /.box-footer -->\n  </div><!-- /.box- -->\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-200f5c88", module.exports)
  } else {
    hotAPI.update("_v-200f5c88", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _AnnouncementQueue2 = _interopRequireDefault(_AnnouncementQueue);
...
new Vue({
  ...
  components: {
    AnnouncementQueue: _AnnouncementQueue2.default
  },
  ready: function ready() {
