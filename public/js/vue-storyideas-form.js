...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-aaceaf5a", module.exports)
  } else {
    hotAPI.update("_v-aaceaf5a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":108,"vue-hot-reload-api":105,"vueify/lib/insert-css":109}],112:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.redBtn[_v-7a6af472] {\n  background: hsl(0, 90%, 70%);\n}\n.dynamic-list-item[_v-7a6af472]{\n    margin: 5px 0px 10px 0px !important;\n}\n.dynamic-list-btn[_v-7a6af472]{\n    margin-top: -4px !important;\n}\n.social-list-item[_v-7a6af472]{\n    margin: 2px 0px 2px 0px !important;\n}\n.social-list-btn[_v-7a6af472]{\n    margin-top: 26px !important;\n}\np[_v-7a6af472] {\n  margin: 0;\n}\n\nlabel[_v-7a6af472] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-7a6af472] {\n  display: inline-block;\n  /*width: 8em*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-7a6af472] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-7a6af472] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-7a6af472] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.invalid[_v-7a6af472] {\n  color: #ff0000;\n}\n\nfieldset label.radiobtns[_v-7a6af472] {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n.reqstar[_v-7a6af472] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nbutton.button-primary[_v-7a6af472] {\n  margin-top: 0.8rem;\n}\n\nselect[_v-7a6af472] {\n  margin: 0;\n}\n\n[type='submit'][_v-7a6af472],\n[type='button'][_v-7a6af472] {\n  margin-top: 0;\n}\n\ninput[type=\"number\"][_v-7a6af472] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-7a6af472] {\n  margin: 0;\n}\n\nh5.form-control[_v-7a6af472] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-7a6af472=\"\">\n    <slot name=\"csrf\" _v-7a6af472=\"\"></slot>\n    <div class=\"row\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md12col\" _v-7a6af472=\"\">\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-7a6af472=\"\">\n          <h5 _v-7a6af472=\"\">{{formMessage.msg}}</h5>\n        </div>\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-7a6af472=\"\">\n          <h5 _v-7a6af472=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" style=\"margin-bottom:10px\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md6col\" _v-7a6af472=\"\">\n        <p v-if=\"record.creator\" _v-7a6af472=\"\">Created by <strong _v-7a6af472=\"\">{{ record.creator.name }}</strong></p>\n      </div>\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md6col\" _v-7a6af472=\"\">\n        <div class=\"form-group\" _v-7a6af472=\"\">\n            <label for=\"tags\" _v-7a6af472=\"\">Medium: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-7a6af472=\"\"></span></label>\n            <v-select :class=\"[formErrors.medium ? 'invalid-input' : '']\" :value.sync=\"record.medium\" :options=\"ideaCategoryList\" :multiple=\"false\" placeholder=\"Choose Medium\" label=\"medium\" _v-7a6af472=\"\">\n          </v-select>\n          <p v-if=\"formErrors.medium\" class=\"help-text invalid\" _v-7a6af472=\"\">{{formErrors.medium}}</p>\n        </div><!-- /.form-group -->\n      </div>\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md12col\" _v-7a6af472=\"\">\n        <!-- Display Name -->\n        <div v-bind:class=\"formGroup\" _v-7a6af472=\"\">\n          <label _v-7a6af472=\"\">Title <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-7a6af472=\"\"></span></label>\n          <input v-model=\"record.title\" class=\"form-control\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" name=\"display_name\" type=\"text\" _v-7a6af472=\"\">\n          <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-7a6af472=\"\">{{formErrors.title}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md12col\" _v-7a6af472=\"\">\n        <!-- Idea -->\n        <div v-bind:class=\"formGroup\" _v-7a6af472=\"\">\n          <label _v-7a6af472=\"\">What's your idea? <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-7a6af472=\"\"></span></label>\n          <textarea v-if=\"hasContent\" v-model=\"record.idea\" id=\"idea\" name=\"idea\" v-ckrte=\"idea\" :type=\"editorType\" :idea=\"idea\" :fresh=\"isFresh\" rows=\"200\" _v-7a6af472=\"\"></textarea>\n          <p v-if=\"formErrors.idea\" class=\"help-text invalid\" _v-7a6af472=\"\">Need idea text.</p>\n        </div>\n      </div>\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md6col\" _v-7a6af472=\"\">\n        <div class=\"form-group\" _v-7a6af472=\"\">\n            <label for=\"tags\" _v-7a6af472=\"\">Assigned to:</label>\n            <v-select :class=\"[formErrors.assignee ? 'invalid-input' : '']\" :value.sync=\"record.assignee\" :options=\"userList\" :multiple=\"false\" placeholder=\"Assign idea\" label=\"name\" _v-7a6af472=\"\">\n          </v-select>\n        </div><!-- /.form-group -->\n      </div>\n      <div :class=\"md6col\" _v-7a6af472=\"\">\n        <div class=\"form-group\" _v-7a6af472=\"\">\n          <label for=\"deadline\" _v-7a6af472=\"\">Deadline:</label>\n          <input id=\"deadline\" :class=\"[formErrors.deadline ? 'invalid-input' : '']\" type=\"text\" v-model=\"record.deadline.date\" aria-describedby=\"errorDeadline\" _v-7a6af472=\"\">\n          <p v-if=\"formErrors.deadline\" class=\"help-text invalid\" _v-7a6af472=\"\">Need a deadline date</p>\n        </div><!--form-group -->\n      </div><!-- /.md6col -->\n    </div>\n   <!-- /.row -->\n   <div v-if=\"recordexists\" class=\"row\" _v-7a6af472=\"\">\n     <div v-bind:class=\"md4col\" _v-7a6af472=\"\">\n         <!-- Is completed? -->\n        <label _v-7a6af472=\"\">Completed? <input type=\"checkbox\" value=\"1\" v-model=\"record.is_completed\" _v-7a6af472=\"\"></label>\n     </div>\n     <!-- /.small-12 columns -->\n   </div>\n   <!-- /.row -->\n    <div class=\"row\" _v-7a6af472=\"\">\n      <div v-bind:class=\"md12col\" _v-7a6af472=\"\">\n        <div v-bind:class=\"formGroup\" _v-7a6af472=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-7a6af472=\"\">{{submitBtnLabel}}</button>\n          <button v-if=\"recordexists\" id=\"btn-delete\" v-on:click=\"delIdea\" type=\"submit\" class=\"redBtn\" v-bind:class=\"btnPrimary\" _v-7a6af472=\"\">Delete Idea</button>\n        </div>\n      </div>\n    </div>\n    <!-- /.row -->\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7a6af472", module.exports)
  } else {
    hotAPI.update("_v-7a6af472", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
