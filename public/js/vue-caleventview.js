...
module.exports = {
  ...
  ready: function ready() {
    var start_datetime = (0, _moment2.default)(this.calendarDate(this.item.start_date) + ' ' + this.convertTimeformat(this.item.start_time));
    var end_datetime = (0, _moment2.default)(this.calendarDate(this.item.end_date) + ' ' + this.convertTimeformat(this.item.end_time));
  ...
  methods: {
    ...
    convertTimeformat: function convertTimeformat(time) {
