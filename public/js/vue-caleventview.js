...
module.exports = {
  ...
  ready: function ready() {
    ...
    var start_datetime = (0, _moment2.default)(this.calendarDate(this.item.start_date) + ' ' + '13:00');
    var end_datetime = (0, _moment2.default)(this.calendarDate(this.item.end_date) + ' ' + '15:00');
