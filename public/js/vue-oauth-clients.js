...
var __vueify_style__ = __vueify_insert__.insert("\n.action-link[_v-f73433c8] {\n    cursor: pointer;\n}\n\n.m-b-none[_v-f73433c8] {\n    margin-bottom: 0;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-f73433c8=\"\">\n    <div class=\"panel panel-default\" _v-f73433c8=\"\">\n        <div class=\"panel-heading\" _v-f73433c8=\"\">\n            <div style=\"display: flex; justify-content: space-between; align-items: center;\" _v-f73433c8=\"\">\n                <span _v-f73433c8=\"\">\n                    OAuth Clients\n                </span>\n\n                <a class=\"action-link\" @click=\"showCreateClientForm\" _v-f73433c8=\"\">\n                    Create New Client\n                </a>\n            </div>\n        </div>\n\n        <div class=\"panel-body\" _v-f73433c8=\"\">\n            <!-- Current Clients -->\n            <p class=\"m-b-none\" v-if=\"clients.length === 0\" _v-f73433c8=\"\">\n                You have not created any OAuth clients.\n            </p>\n\n            <table class=\"table table-borderless m-b-none\" v-if=\"clients.length > 0\" _v-f73433c8=\"\">\n                <thead _v-f73433c8=\"\">\n                    <tr _v-f73433c8=\"\">\n                        <th _v-f73433c8=\"\">Client ID</th>\n                        <th _v-f73433c8=\"\">Name</th>\n                        <th _v-f73433c8=\"\">Secret</th>\n                        <th _v-f73433c8=\"\"></th>\n                        <th _v-f73433c8=\"\"></th>\n                    </tr>\n                </thead>\n\n                <tbody _v-f73433c8=\"\">\n                    <tr v-for=\"client in clients\" _v-f73433c8=\"\">\n                        <!-- ID -->\n                        <td style=\"vertical-align: middle;\" _v-f73433c8=\"\">\n                            {{ client.id }}\n                        </td>\n\n                        <!-- Name -->\n                        <td style=\"vertical-align: middle;\" _v-f73433c8=\"\">\n                            {{ client.name }}\n                        </td>\n\n                        <!-- Secret -->\n                        <td style=\"vertical-align: middle;\" _v-f73433c8=\"\">\n                            <code _v-f73433c8=\"\">{{ client.secret }}</code>\n                        </td>\n\n                        <!-- Edit Button -->\n                        <td style=\"vertical-align: middle;\" _v-f73433c8=\"\">\n                            <a class=\"action-link\" @click=\"edit(client)\" _v-f73433c8=\"\">\n                                Edit\n                            </a>\n                        </td>\n\n                        <!-- Delete Button -->\n                        <td style=\"vertical-align: middle;\" _v-f73433c8=\"\">\n                            <a class=\"action-link text-danger\" @click=\"destroy(client)\" _v-f73433c8=\"\">\n                                Delete\n                            </a>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>\n\n    <!-- Create Client Modal -->\n    <div class=\"modal fade\" id=\"modal-create-client\" tabindex=\"-1\" role=\"dialog\" _v-f73433c8=\"\">\n        <div class=\"modal-dialog\" _v-f73433c8=\"\">\n            <div class=\"modal-content\" _v-f73433c8=\"\">\n                <div class=\"modal-header\" _v-f73433c8=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-f73433c8=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-f73433c8=\"\">\n                        Create Client\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-f73433c8=\"\">\n                    <!-- Form Errors -->\n                    <div class=\"alert alert-danger\" v-if=\"createForm.errors.length > 0\" _v-f73433c8=\"\">\n                        <p _v-f73433c8=\"\"><strong _v-f73433c8=\"\">Whoops!</strong> Something went wrong!</p>\n                        <br _v-f73433c8=\"\">\n                        <ul _v-f73433c8=\"\">\n                            <li v-for=\"error in createForm.errors\" _v-f73433c8=\"\">\n                                {{ error }}\n                            </li>\n                        </ul>\n                    </div>\n\n                    <!-- Create Client Form -->\n                    <form class=\"form-horizontal\" role=\"form\" _v-f73433c8=\"\">\n                        <!-- Name -->\n                        <div class=\"form-group\" _v-f73433c8=\"\">\n                            <label class=\"col-md-3 control-label\" _v-f73433c8=\"\">Name</label>\n\n                            <div class=\"col-md-7\" _v-f73433c8=\"\">\n                                <input id=\"create-client-name\" type=\"text\" class=\"form-control\" @keyup.enter=\"store\" v-model=\"createForm.name\" _v-f73433c8=\"\">\n\n                                <span class=\"help-block\" _v-f73433c8=\"\">\n                                    Something your users will recognize and trust.\n                                </span>\n                            </div>\n                        </div>\n\n                        <!-- Redirect URL -->\n                        <div class=\"form-group\" _v-f73433c8=\"\">\n                            <label class=\"col-md-3 control-label\" _v-f73433c8=\"\">Redirect URL</label>\n\n                            <div class=\"col-md-7\" _v-f73433c8=\"\">\n                                <input type=\"text\" class=\"form-control\" name=\"redirect\" @keyup.enter=\"store\" v-model=\"createForm.redirect\" _v-f73433c8=\"\">\n\n                                <span class=\"help-block\" _v-f73433c8=\"\">\n                                    Your application's authorization callback URL.\n                                </span>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-f73433c8=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-f73433c8=\"\">Close</button>\n\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"store\" _v-f73433c8=\"\">\n                        Create\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- Edit Client Modal -->\n    <div class=\"modal fade\" id=\"modal-edit-client\" tabindex=\"-1\" role=\"dialog\" _v-f73433c8=\"\">\n        <div class=\"modal-dialog\" _v-f73433c8=\"\">\n            <div class=\"modal-content\" _v-f73433c8=\"\">\n                <div class=\"modal-header\" _v-f73433c8=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-f73433c8=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-f73433c8=\"\">\n                        Edit Client\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-f73433c8=\"\">\n                    <!-- Form Errors -->\n                    <div class=\"alert alert-danger\" v-if=\"editForm.errors.length > 0\" _v-f73433c8=\"\">\n                        <p _v-f73433c8=\"\"><strong _v-f73433c8=\"\">Whoops!</strong> Something went wrong!</p>\n                        <br _v-f73433c8=\"\">\n                        <ul _v-f73433c8=\"\">\n                            <li v-for=\"error in editForm.errors\" _v-f73433c8=\"\">\n                                {{ error }}\n                            </li>\n                        </ul>\n                    </div>\n\n                    <!-- Edit Client Form -->\n                    <form class=\"form-horizontal\" role=\"form\" _v-f73433c8=\"\">\n                        <!-- Name -->\n                        <div class=\"form-group\" _v-f73433c8=\"\">\n                            <label class=\"col-md-3 control-label\" _v-f73433c8=\"\">Name</label>\n\n                            <div class=\"col-md-7\" _v-f73433c8=\"\">\n                                <input id=\"edit-client-name\" type=\"text\" class=\"form-control\" @keyup.enter=\"update\" v-model=\"editForm.name\" _v-f73433c8=\"\">\n\n                                <span class=\"help-block\" _v-f73433c8=\"\">\n                                    Something your users will recognize and trust.\n                                </span>\n                            </div>\n                        </div>\n\n                        <!-- Redirect URL -->\n                        <div class=\"form-group\" _v-f73433c8=\"\">\n                            <label class=\"col-md-3 control-label\" _v-f73433c8=\"\">Redirect URL</label>\n\n                            <div class=\"col-md-7\" _v-f73433c8=\"\">\n                                <input type=\"text\" class=\"form-control\" name=\"redirect\" @keyup.enter=\"update\" v-model=\"editForm.redirect\" _v-f73433c8=\"\">\n\n                                <span class=\"help-block\" _v-f73433c8=\"\">\n                                    Your application's authorization callback URL.\n                                </span>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-f73433c8=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-f73433c8=\"\">Close</button>\n\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"update\" _v-f73433c8=\"\">\n                        Save Changes\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f73433c8", module.exports)
  } else {
    hotAPI.update("_v-f73433c8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
