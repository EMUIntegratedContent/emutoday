...
var __vueify_style__ = __vueify_insert__.insert("\n.action-link[_v-60ce98bd] {\n    cursor: pointer;\n}\n\n.m-b-none[_v-60ce98bd] {\n    margin-bottom: 0;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-60ce98bd=\"\">\n    <div class=\"panel panel-default\" _v-60ce98bd=\"\">\n        <div class=\"panel-heading\" _v-60ce98bd=\"\">\n            <div style=\"display: flex; justify-content: space-between; align-items: center;\" _v-60ce98bd=\"\">\n                <span _v-60ce98bd=\"\">\n                    OAuth Clients\n                </span>\n\n                <a class=\"action-link\" @click=\"showCreateClientForm\" _v-60ce98bd=\"\">\n                    Create New Client\n                </a>\n            </div>\n        </div>\n\n        <div class=\"panel-body\" _v-60ce98bd=\"\">\n            <!-- Current Clients -->\n            <p class=\"m-b-none\" v-if=\"clients.length === 0\" _v-60ce98bd=\"\">\n                You have not created any OAuth clients.\n            </p>\n\n            <table class=\"table table-borderless m-b-none\" v-if=\"clients.length > 0\" _v-60ce98bd=\"\">\n                <thead _v-60ce98bd=\"\">\n                    <tr _v-60ce98bd=\"\">\n                        <th _v-60ce98bd=\"\">Client ID</th>\n                        <th _v-60ce98bd=\"\">Name</th>\n                        <th _v-60ce98bd=\"\">Secret</th>\n                        <th _v-60ce98bd=\"\"></th>\n                        <th _v-60ce98bd=\"\"></th>\n                    </tr>\n                </thead>\n\n                <tbody _v-60ce98bd=\"\">\n                    <tr v-for=\"client in clients\" _v-60ce98bd=\"\">\n                        <!-- ID -->\n                        <td style=\"vertical-align: middle;\" _v-60ce98bd=\"\">\n                            {{ client.id }}\n                        </td>\n\n                        <!-- Name -->\n                        <td style=\"vertical-align: middle;\" _v-60ce98bd=\"\">\n                            {{ client.name }}\n                        </td>\n\n                        <!-- Secret -->\n                        <td style=\"vertical-align: middle;\" _v-60ce98bd=\"\">\n                            <code _v-60ce98bd=\"\">{{ client.secret }}</code>\n                        </td>\n\n                        <!-- Edit Button -->\n                        <td style=\"vertical-align: middle;\" _v-60ce98bd=\"\">\n                            <a class=\"action-link\" @click=\"edit(client)\" _v-60ce98bd=\"\">\n                                Edit\n                            </a>\n                        </td>\n\n                        <!-- Delete Button -->\n                        <td style=\"vertical-align: middle;\" _v-60ce98bd=\"\">\n                            <a class=\"action-link text-danger\" @click=\"destroy(client)\" _v-60ce98bd=\"\">\n                                Delete\n                            </a>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>\n\n    <!-- Create Client Modal -->\n    <div class=\"modal fade\" id=\"modal-create-client\" tabindex=\"-1\" role=\"dialog\" _v-60ce98bd=\"\">\n        <div class=\"modal-dialog\" _v-60ce98bd=\"\">\n            <div class=\"modal-content\" _v-60ce98bd=\"\">\n                <div class=\"modal-header\" _v-60ce98bd=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-60ce98bd=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-60ce98bd=\"\">\n                        Create Client\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-60ce98bd=\"\">\n                    <!-- Form Errors -->\n                    <div class=\"alert alert-danger\" v-if=\"createForm.errors.length > 0\" _v-60ce98bd=\"\">\n                        <p _v-60ce98bd=\"\"><strong _v-60ce98bd=\"\">Whoops!</strong> Something went wrong!</p>\n                        <br _v-60ce98bd=\"\">\n                        <ul _v-60ce98bd=\"\">\n                            <li v-for=\"error in createForm.errors\" _v-60ce98bd=\"\">\n                                {{ error }}\n                            </li>\n                        </ul>\n                    </div>\n\n                    <!-- Create Client Form -->\n                    <form class=\"form-horizontal\" role=\"form\" _v-60ce98bd=\"\">\n                        <!-- Name -->\n                        <div class=\"form-group\" _v-60ce98bd=\"\">\n                            <label class=\"col-md-3 control-label\" _v-60ce98bd=\"\">Name</label>\n\n                            <div class=\"col-md-7\" _v-60ce98bd=\"\">\n                                <input id=\"create-client-name\" type=\"text\" class=\"form-control\" @keyup.enter=\"store\" v-model=\"createForm.name\" _v-60ce98bd=\"\">\n\n                                <span class=\"help-block\" _v-60ce98bd=\"\">\n                                    Something your users will recognize and trust.\n                                </span>\n                            </div>\n                        </div>\n\n                        <!-- Redirect URL -->\n                        <div class=\"form-group\" _v-60ce98bd=\"\">\n                            <label class=\"col-md-3 control-label\" _v-60ce98bd=\"\">Redirect URL</label>\n\n                            <div class=\"col-md-7\" _v-60ce98bd=\"\">\n                                <input type=\"text\" class=\"form-control\" name=\"redirect\" @keyup.enter=\"store\" v-model=\"createForm.redirect\" _v-60ce98bd=\"\">\n\n                                <span class=\"help-block\" _v-60ce98bd=\"\">\n                                    Your application's authorization callback URL.\n                                </span>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-60ce98bd=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-60ce98bd=\"\">Close</button>\n\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"store\" _v-60ce98bd=\"\">\n                        Create\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- Edit Client Modal -->\n    <div class=\"modal fade\" id=\"modal-edit-client\" tabindex=\"-1\" role=\"dialog\" _v-60ce98bd=\"\">\n        <div class=\"modal-dialog\" _v-60ce98bd=\"\">\n            <div class=\"modal-content\" _v-60ce98bd=\"\">\n                <div class=\"modal-header\" _v-60ce98bd=\"\">\n                    <button type=\"button \" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" _v-60ce98bd=\"\">×</button>\n\n                    <h4 class=\"modal-title\" _v-60ce98bd=\"\">\n                        Edit Client\n                    </h4>\n                </div>\n\n                <div class=\"modal-body\" _v-60ce98bd=\"\">\n                    <!-- Form Errors -->\n                    <div class=\"alert alert-danger\" v-if=\"editForm.errors.length > 0\" _v-60ce98bd=\"\">\n                        <p _v-60ce98bd=\"\"><strong _v-60ce98bd=\"\">Whoops!</strong> Something went wrong!</p>\n                        <br _v-60ce98bd=\"\">\n                        <ul _v-60ce98bd=\"\">\n                            <li v-for=\"error in editForm.errors\" _v-60ce98bd=\"\">\n                                {{ error }}\n                            </li>\n                        </ul>\n                    </div>\n\n                    <!-- Edit Client Form -->\n                    <form class=\"form-horizontal\" role=\"form\" _v-60ce98bd=\"\">\n                        <!-- Name -->\n                        <div class=\"form-group\" _v-60ce98bd=\"\">\n                            <label class=\"col-md-3 control-label\" _v-60ce98bd=\"\">Name</label>\n\n                            <div class=\"col-md-7\" _v-60ce98bd=\"\">\n                                <input id=\"edit-client-name\" type=\"text\" class=\"form-control\" @keyup.enter=\"update\" v-model=\"editForm.name\" _v-60ce98bd=\"\">\n\n                                <span class=\"help-block\" _v-60ce98bd=\"\">\n                                    Something your users will recognize and trust.\n                                </span>\n                            </div>\n                        </div>\n\n                        <!-- Redirect URL -->\n                        <div class=\"form-group\" _v-60ce98bd=\"\">\n                            <label class=\"col-md-3 control-label\" _v-60ce98bd=\"\">Redirect URL</label>\n\n                            <div class=\"col-md-7\" _v-60ce98bd=\"\">\n                                <input type=\"text\" class=\"form-control\" name=\"redirect\" @keyup.enter=\"update\" v-model=\"editForm.redirect\" _v-60ce98bd=\"\">\n\n                                <span class=\"help-block\" _v-60ce98bd=\"\">\n                                    Your application's authorization callback URL.\n                                </span>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n\n                <!-- Modal Actions -->\n                <div class=\"modal-footer\" _v-60ce98bd=\"\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" _v-60ce98bd=\"\">Close</button>\n\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"update\" _v-60ce98bd=\"\">\n                        Save Changes\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-60ce98bd", module.exports)
  } else {
    hotAPI.update("_v-60ce98bd", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
