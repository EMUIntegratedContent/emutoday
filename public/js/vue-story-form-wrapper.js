...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-43ae76a1", module.exports)
  } else {
    hotAPI.update("_v-43ae76a1", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../vuex/getters":116,"vue":107,"vue-hot-reload-api":104,"vueify/lib/insert-css":108}],111:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\np[_v-5bce1358] {\n  margin:0;\n}\nlabel[_v-5bce1358] {\n  display: block;\n}\nlabel > span[_v-5bce1358] {\n  display: inline-block;\n  width: 8em;\n  vertical-align: top;\n}\n.valid-titleField[_v-5bce1358] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n.no-input[_v-5bce1358] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n.invalid-input[_v-5bce1358] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n.invalid[_v-5bce1358] {\n  color: #ff0000;\n}\n.user-display[_v-5bce1358] {\n  color: #666;\n  font-size: 16px;\n}\n.user-display .user-name[_v-5bce1358] {\n\n  font-style: italic;\n}\n.user-display .user-info[_v-5bce1358] {\n  font-size: 14px;\n}\n\nfieldset label.radiobtns[_v-5bce1358]  {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n[type='text'][_v-5bce1358], [type='password'][_v-5bce1358], [type='date'][_v-5bce1358], [type='datetime'][_v-5bce1358], [type='datetime-local'][_v-5bce1358], [type='month'][_v-5bce1358], [type='week'][_v-5bce1358], [type='email'][_v-5bce1358], [type='number'][_v-5bce1358], [type='search'][_v-5bce1358], [type='tel'][_v-5bce1358], [type='time'][_v-5bce1358], [type='url'][_v-5bce1358], [type='color'][_v-5bce1358],\ntextarea[_v-5bce1358] {\n  margin: 0;\n  padding: 0;\n  padding-left: 8px;\n  width: 100%;\n}\n[type='file'][_v-5bce1358], [type='checkbox'][_v-5bce1358], [type='radio'][_v-5bce1358] {\n  margin: 0;\n  margin-left: 8px;\n  padding: 0;\n  padding-left: 2px;\n}\n.reqstar[_v-5bce1358] {\n  font-size: .5rem;\n  color: #E33100;\n  vertical-align:text-top;\n}\n\nbutton.button-primary[_v-5bce1358]{\n  margin-top: 1rem;\n}\n\n.form-group[_v-5bce1358]{\n  margin-bottom: 5px;\n}\n\n.callout[_v-5bce1358] {\n  margin-bottom: 8px;\n  padding: 8px 30px 8px 15px;\n}\n.save-author[_v-5bce1358] {\n  vertical-align: bottom;\n}\n")
"use strict";
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-5bce1358=\"\">\n    <slot name=\"csrf\" _v-5bce1358=\"\"></slot>\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-12\" _v-5bce1358=\"\">\n        <div v-show=\"formMessage.isOk\" class=\"alert alert-success alert-dismissible\" _v-5bce1358=\"\">\n          <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-5bce1358=\"\"><i class=\"fa fa-times\" _v-5bce1358=\"\"></i></button>\n          <h5 _v-5bce1358=\"\">{{formMessage.msg}}</h5>\n        </div>\n      </div><!-- /.small-12 columns -->\n    </div><!-- /.row -->\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-12\" _v-5bce1358=\"\">\n        <template v-if=\"singleStype\">\n          <label _v-5bce1358=\"\">Story Type: {{record.story_type | capitalize}}</label>\n          <input v-model=\"record.story_type\" :value=\"s_types\" type=\"hidden\" disabled=\"disabled\" _v-5bce1358=\"\">\n        </template>\n        <template v-else=\"\">\n          <label _v-5bce1358=\"\">Story Type</label>\n          <select v-model=\"record.story_type\" _v-5bce1358=\"\">\n            <option v-for=\"stype in s_types\" v-bind:value=\"stype.shortname\" selected=\"{{ stype.shortname == 'news' }}\" _v-5bce1358=\"\">\n              {{ stype.name }}\n            </option>\n          </select>\n        </template>\n        <hr _v-5bce1358=\"\">\n      </div><!-- /.col-md-6 -->\n    </div><!-- /.row -->\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-12\" _v-5bce1358=\"\">\n        <div class=\"form-group\" _v-5bce1358=\"\">\n          <label _v-5bce1358=\"\">Title <i class=\"fi-star reqstar\" _v-5bce1358=\"\"></i></label>\n          <p class=\"help-text\" id=\"title-helptext\" _v-5bce1358=\"\">Please enter a title</p>\n          <input v-model=\"record.title\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" name=\"title\" type=\"text\" _v-5bce1358=\"\">\n          <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-5bce1358=\"\">\tPlease Include a Title!</p>\n        </div>\n      </div>\n    </div><!-- /.row -->\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-12\" _v-5bce1358=\"\">\n        <div class=\"form-group\" _v-5bce1358=\"\">\n          <label _v-5bce1358=\"\">Slug <i class=\"fi-star reqstar\" _v-5bce1358=\"\"></i></label>\n          <p class=\"help-text\" id=\"slug-helptext\" _v-5bce1358=\"\">Automatic Readable link for sharing and social media</p>\n          <input v-model=\"recordSlug\" v-bind:class=\"[formErrors.slug ? 'invalid-input' : '']\" name=\"slug\" type=\"text\" _v-5bce1358=\"\">\n          <p v-if=\"formErrors.slug\" class=\"help-text invalid\" _v-5bce1358=\"\">needs slug!</p>\n        </div>\n      </div><!-- /.col-md-12 -->\n    </div>\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-12\" _v-5bce1358=\"\">\n        <div class=\"form-group\" _v-5bce1358=\"\">\n          <label _v-5bce1358=\"\">Subtitle</label>\n          <p class=\"help-text\" id=\"subtitle-helptext\" _v-5bce1358=\"\">Visible in some cases</p>\n          <input v-model=\"record.subtitle\" v-bind:class=\"[formErrors.subtitle ? 'invalid-input' : '']\" @blur=\"onBlur\" name=\"subtitle\" type=\"text\" _v-5bce1358=\"\">\n          <p v-if=\"formErrors.subtitle\" class=\"help-text invalid\" _v-5bce1358=\"\"></p>\n        </div>\n        <div class=\"form-group\" v-if=\"this.stype == 'featurephoto'\" _v-5bce1358=\"\">\n          <label _v-5bce1358=\"\">Photo credit</label>\n          <p class=\"help-text\" id=\"photo_credit-helptext\" _v-5bce1358=\"\">e.g. 'submitted by John Smith'</p>\n          <input v-model=\"record.photo_credit\" v-bind:class=\"[formErrors.photo_credit ? 'invalid-input' : '']\" @blur=\"onBlur\" name=\"photo_credit\" type=\"text\" _v-5bce1358=\"\">\n          <p v-if=\"formErrors.photo_credit\" class=\"help-text invalid\" _v-5bce1358=\"\"></p>\n        </div>\n        <div class=\"form-group\" _v-5bce1358=\"\">\n          <label _v-5bce1358=\"\">Content <i v-show=\"this.stype != 'featurephoto'\" class=\"fi-star reqstar\" _v-5bce1358=\"\"></i></label>\n          <p class=\"help-text\" id=\"content-helptext\" _v-5bce1358=\"\">Enter the story content <span v-show=\"this.stype == 'featurephoto'\" _v-5bce1358=\"\">(optional)</span></p>\n          <textarea v-if=\"hasContent\" id=\"content\" name=\"content\" v-ckrte=\"content\" :type=\"editorType\" :content=\"content\" :fresh=\"isFresh\" rows=\"200\" _v-5bce1358=\"\"></textarea>\n          <p v-if=\"formErrors.content\" class=\"help-text invalid\" _v-5bce1358=\"\">Need Content!</p>\n        </div>\n        <div class=\"form-group user-display\" _v-5bce1358=\"\">\n          <div class=\"user-name\" _v-5bce1358=\"\">Author: {{author.first_name}} {{author.last_name}}</div>\n          <div v-if=\"contact.id != 0\" class=\"user-info\" _v-5bce1358=\"\">Contact: {{contact.first_name}} {{contact.last_name}}, {{contact.email}}, {{contact.phone}}</div>\n          <div v-if=\"contact.id == 0\" class=\"user-info\" _v-5bce1358=\"\">Contact: {{defaultcontact.first_name}} {{defaultcontact.last_name}}, {{defaultcontact.email}}, {{defaultcontact.phone}}</div>\n        </div><!-- /.frm-group -->\n      </div><!-- /.small-12 columns -->\n    </div><!-- /.row -->\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-6\" _v-5bce1358=\"\">\n        <div v-show=\"saveAuthorMessage.isOk\" class=\"alert alert-success alert-dismissible\" _v-5bce1358=\"\">\n          <button @click.prevent=\"toggleCallout\" class=\"btn btn-sm close\" _v-5bce1358=\"\"><i class=\"fa fa-times\" _v-5bce1358=\"\"></i></button>\n          <h5 _v-5bce1358=\"\">{{saveAuthorMessage.msg}}</h5>\n        </div>\n        <a v-if=\"!needAuthor\" @click.prevent=\"changeAuthor\" href=\"#\" class=\"btn btn-primary btn-sm\" _v-5bce1358=\"\">Change Author</a>\n        <a v-if=\"hasAuthor\" @click.prevent=\"resetAuthor\" href=\"#\" class=\"btn btn-primary btn-sm\" _v-5bce1358=\"\">Reset Author</a>\n        <a @click.prevent=\"changeContact\" href=\"#\" class=\"btn btn-primary btn-sm\" _v-5bce1358=\"\">Change Contact</a>\n        <div v-if=\"needAuthor &amp;&amp; isAdmin\" class=\"form-inline author\" _v-5bce1358=\"\">\n            <label _v-5bce1358=\"\">Choose existing Author:</label>\n            <v-select :value.sync=\"selectedAuthor\" :options=\"optionsAuthorlist\" :multiple=\"false\" placeholder=\"Author (leaving this blank will set you as the author)\" label=\"name\" _v-5bce1358=\"\"> </v-select>\n        </div>\n        </div>\n      </div><!-- /.col-md-12 -->\n    <!-- /.row -->\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-6\" _v-5bce1358=\"\">\n        <div v-if=\"isAdmin &amp;&amp; needContact\" class=\"form-inline author\" _v-5bce1358=\"\">\n            <label _v-5bce1358=\"\">Story contact:</label>\n            <v-select :value.sync=\"selectedContact\" :options=\"optionsContactlist\" :multiple=\"false\" placeholder=\"Contact (leaving this blank will set the system default as the contact)\" label=\"name\" _v-5bce1358=\"\"> </v-select>\n        </div>\n      </div><!-- /.col-md-6 -->\n    </div>\n    <div class=\"row\" _v-5bce1358=\"\">\n      <div class=\"col-md-6\" _v-5bce1358=\"\">\n        <div class=\"form-group\" _v-5bce1358=\"\">\n          <label for=\"start-date\" _v-5bce1358=\"\">Start Date: <i class=\"fi-star reqstar\" _v-5bce1358=\"\"></i></label>\n          <input v-if=\"fdate\" type=\"text\" :value=\"fdate\" :initval=\"fdate\" v-flatpickr=\"fdate\" _v-5bce1358=\"\">\n          <p _v-5bce1358=\"\">NOTE: For external story with \"video\" tag, treat this field as the END Date.</p>\n          <p v-if=\"formErrors.start_date\" class=\"help-text invalid\" _v-5bce1358=\"\">Need a Start Date</p>\n        </div><!--form-group -->\n      </div><!-- /.small-6 columns -->\n      <div class=\"col-md-6\" _v-5bce1358=\"\">\n        <div v-if=\"isAdmin\" class=\"form-group\" _v-5bce1358=\"\">\n          <label for=\"tags\" _v-5bce1358=\"\">Tags:</label>\n          <v-select :class=\"[formErrors.tags ? 'invalid-input' : '']\" :value.sync=\"tags\" :options=\"taglist\" :multiple=\"true\" placeholder=\"Select tags\" label=\"name\" _v-5bce1358=\"\">\n        </v-select>\n\n      </div><!-- /.form-group -->\n    </div><!-- /.small-6 columns -->\n  </div><!-- /.row -->\n  <div class=\"row\" _v-5bce1358=\"\">\n    <div class=\"col-md-6\" _v-5bce1358=\"\">\n    </div><!-- /.col-md-6-->\n    <div class=\"col-md-6\" _v-5bce1358=\"\">\n    </div><!-- /.col-md-6 -->\n  </div><!-- /.row -->\n\n<div class=\"row\" _v-5bce1358=\"\">\n  <div class=\"col-md-12\" _v-5bce1358=\"\">\n    <div class=\"form-group\" _v-5bce1358=\"\">\n      <button v-on:click=\"submitForm\" type=\"submit\" class=\"btn btn-primary\" _v-5bce1358=\"\">{{submitBtnLabel}}</button>\n    </div>\n  </div><!-- /.column -->\n</div>\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5bce1358", module.exports)
  } else {
    hotAPI.update("_v-5bce1358", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
