...
var __vueify_style__ = __vueify_insert__.insert("\np[_v-3d8fa0a0] {\n  margin: 0;\n}\n\nlabel[_v-3d8fa0a0] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-3d8fa0a0] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-3d8fa0a0] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-3d8fa0a0] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-3d8fa0a0] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.valid[_v-3d8fa0a0]{\n  color:#3c763d;\n}\n\n.invalid[_v-3d8fa0a0] {\n  color: #ff0000;\n}\n\n.reqstar[_v-3d8fa0a0] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nelect[_v-3d8fa0a0] {\n  margin: 0;\n}\n\ninput[type=\"number\"][_v-3d8fa0a0] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-3d8fa0a0] {\n  margin: 0;\n}\n\nh5.form-control[_v-3d8fa0a0] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
...
module.exports = {
  ...
  methods: {
    ...
    nowOnReload: function nowOnReload() {
      var newurl = '/admin/mediahighlights/' + this.recordid + '/edit';
    ...
    submitForm: function submitForm(e) {
      ...
      var route = this.recordexists ? '/api/mediahighlights/' + this.record.id : '/api/mediahighlights';
    ...
    fetchTagsList: function fetchTagsList() {
      ...
      this.$http.get('/api/mediahighlights/taglist/').then(function (response) {
        _this3.$set('taglist', response.data.newdata);
      }, function (response) {
    ...
    fetchCurrentTags: function fetchCurrentTags() {
      ...
      this.$http.get('/api/mediahighlights/taglist/' + this.recordid).then(function (response) {
        _this4.$set('tags', response.data.newdata);
      }, function (response) {
    ...
    saveNewTag: function saveNewTag() {
      ...
      var method = 'post';
      var route = '/api/mediahighlights/tag/store';

      var tagObj = { name: this.newTag
      ...
      // Do this when response gets back.
      .then(function (response) {
        _this5.formSuccess.tags = []; //clear form success
        _this5.formErrors = {};
        _this5.formSuccess.tags.push(response.data.message); //create success message

        _this5.fetchTagsList(); //get updated list of recipients
      }, function (response) {
        // If invalid. error callback
        _this5.formSuccess.tags = [];
        _this5.formErrors = response.data.error.message; // Set errors from validation to vue data
      }).bind(this);
    },
     ...
     */
    toggleAddTag: function toggleAddTag() {
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-3d8fa0a0=\"\">\n    <slot name=\"csrf\" _v-3d8fa0a0=\"\"></slot>\n    <div class=\"row\" _v-3d8fa0a0=\"\">\n      <div v-bind:class=\"md12col\" _v-3d8fa0a0=\"\">\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-3d8fa0a0=\"\">\n          <h5 _v-3d8fa0a0=\"\">{{formMessage.msg}}</h5>\n        </div>\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-3d8fa0a0=\"\">\n          <h5 _v-3d8fa0a0=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-3d8fa0a0=\"\">\n      <div v-bind:class=\"md12col\" _v-3d8fa0a0=\"\">\n        <!-- Title -->\n        <div v-bind:class=\"formGroup\" _v-3d8fa0a0=\"\">\n          <label _v-3d8fa0a0=\"\">\n            Title <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-3d8fa0a0=\"\"></span>\n            <p class=\"help-text\" id=\"title-helptext\" _v-3d8fa0a0=\"\">({{titleChars}} characters left)</p>\n          </label>\n          <input v-model=\"record.title\" class=\"form-control\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" name=\"title\" type=\"text\" _v-3d8fa0a0=\"\">\n          <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-3d8fa0a0=\"\">{{formErrors.title}}</p>\n        </div>\n      </div>\n    </div>\n    <div class=\"row\" _v-3d8fa0a0=\"\">\n      <div v-bind:class=\"md12col\" _v-3d8fa0a0=\"\">\n        <!-- URL -->\n        <div v-bind:class=\"formGroup\" _v-3d8fa0a0=\"\">\n          <label _v-3d8fa0a0=\"\">URL <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-3d8fa0a0=\"\"></span></label>\n          <div class=\"input-group\" _v-3d8fa0a0=\"\">\n            <span class=\"input-group-addon\" _v-3d8fa0a0=\"\">http://</span>\n            <input v-model=\"record.url\" class=\"form-control\" v-bind:class=\"[formErrors.url ? 'invalid-input' : '']\" name=\"url\" type=\"text\" _v-3d8fa0a0=\"\">\n          </div>\n          <p v-if=\"formErrors.url\" class=\"help-text invalid\" _v-3d8fa0a0=\"\">{{formErrors.url}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-3d8fa0a0=\"\">\n      <div v-bind:class=\"md6col\" _v-3d8fa0a0=\"\">\n        <div v-bind:class=\"formGroup\" _v-3d8fa0a0=\"\">\n          <label _v-3d8fa0a0=\"\">Source Name: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-3d8fa0a0=\"\"></span></label>\n          <input v-model=\"record.source\" class=\"form-control\" v-bind:class=\"[formErrors.source ? 'invalid-input' : '']\" type=\"text\" :value=\"record.source\" _v-3d8fa0a0=\"\">\n          <p v-if=\"formErrors.source\" class=\"help-text invalid\" _v-3d8fa0a0=\"\">Need a source</p>\n        </div> <!--form-group -->\n      </div> <!-- /.small-6 columns -->\n      <div v-bind:class=\"md6col\" _v-3d8fa0a0=\"\">\n        <div v-bind:class=\"formGroup\" _v-3d8fa0a0=\"\">\n          <label for=\"start-date\" _v-3d8fa0a0=\"\">Highlight Date: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-3d8fa0a0=\"\"></span></label>\n          <input id=\"start-date\" class=\"form-control\" v-bind:class=\"[formErrors.start_date ? 'invalid-input' : '']\" type=\"text\" v-model=\"record.start_date\" _v-3d8fa0a0=\"\">\n          <p v-if=\"formErrors.start_date\" class=\"help-text invalid\" _v-3d8fa0a0=\"\">Need a highlight date</p>\n        </div> <!--form-group -->\n      </div> <!-- /.small-6 columns -->\n    </div> <!-- /.row -->\n    <div class=\"row\" _v-3d8fa0a0=\"\">\n      <div class=\"col-md-6\" _v-3d8fa0a0=\"\">\n        <div class=\"form-group\" _v-3d8fa0a0=\"\">\n          <label for=\"tags\" _v-3d8fa0a0=\"\">Tags:</label>\n            <v-select :class=\"[formErrors.tags ? 'invalid-input' : '']\" :value.sync=\"record.tags\" :options=\"taglist\" :multiple=\"true\" placeholder=\"Select tags\" label=\"name\" _v-3d8fa0a0=\"\">\n          </v-select>\n        </div><!-- /.form-group -->\n      </div><!-- /.small-6 columns -->\n      <div class=\"col-sm-6\" _v-3d8fa0a0=\"\">\n          <label style=\"visibility:hidden\" _v-3d8fa0a0=\"\">Add unlisted tag</label>\n          <div class=\"input-group\" :class=\"successFailure\" _v-3d8fa0a0=\"\">\n            <span class=\"input-group-btn\" _v-3d8fa0a0=\"\">\n              <button class=\"btn btn-primary\" type=\"button\" @click.prevent=\"toggleAddTag\" _v-3d8fa0a0=\"\">{{ showAddTag ? 'Hide me' : 'Add unlisted tag' }}</button>\n            </span>\n            <input v-show=\"showAddTag\" type=\"text\" v-model=\"newTag\" class=\"form-control\" placeholder=\"new tag name goes here\" _v-3d8fa0a0=\"\">\n            <span v-show=\"showAddTag\" class=\"input-group-btn\" _v-3d8fa0a0=\"\">\n              <button class=\"btn btn-default\" type=\"button\" @click.prevent=\"saveNewTag\" _v-3d8fa0a0=\"\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\" _v-3d8fa0a0=\"\"></i></button>\n            </span>\n          </div><!-- /input-group -->\n          <p v-show=\"showAddTag &amp;&amp; formErrors.name\" class=\"help-text invalid\" _v-3d8fa0a0=\"\">{{ formErrors.name }}</p>\n          <p v-show=\"showAddTag &amp;&amp; formSuccess.tags\" class=\"help-text valid\" _v-3d8fa0a0=\"\">{{ formSuccess.tags }}</p>\n      </div><!-- /.small-6 columns -->\n    </div> <!-- /.row -->\n    <div class=\"row\" _v-3d8fa0a0=\"\">\n      <div v-bind:class=\"md12col\" _v-3d8fa0a0=\"\">\n        <div v-bind:class=\"formGroup\" _v-3d8fa0a0=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-3d8fa0a0=\"\">{{submitBtnLabel}}</button>\n        </div>\n      </div>\n    </div>\n\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3d8fa0a0", module.exports)
  } else {
    hotAPI.update("_v-3d8fa0a0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _MediahighlightForm = require('./components/MediahighlightForm.vue');

var _MediahighlightForm2 = _interopRequireDefault(_MediahighlightForm);
...
var vm = new Vue({
    ...
    components: { MediahighlightForm: _MediahighlightForm2.default },
    ready: function ready() {
        console.log('MediahighlightForm ready');
    }
});

},{"./components/MediahighlightForm.vue":109,"vue":107,"vue-resource":105}]},{},[110]);

//# sourceMappingURL=vue-mediahighlight-form.js.map
