...
var __vueify_style__ = __vueify_insert__.insert("\np[_v-f34ef676] {\n  margin: 0;\n}\n\nlabel[_v-f34ef676] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-f34ef676] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-f34ef676] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-f34ef676] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-f34ef676] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.valid[_v-f34ef676]{\n  color:#3c763d;\n}\n\n.invalid[_v-f34ef676] {\n  color: #ff0000;\n}\n\n.reqstar[_v-f34ef676] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nelect[_v-f34ef676] {\n  margin: 0;\n}\n\ninput[type=\"number\"][_v-f34ef676] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-f34ef676] {\n  margin: 0;\n}\n\nh5.form-control[_v-f34ef676] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form _v-f34ef676=\"\">\n    <slot name=\"csrf\" _v-f34ef676=\"\"></slot>\n    <div class=\"row\" _v-f34ef676=\"\">\n      <div v-bind:class=\"md12col\" _v-f34ef676=\"\">\n        <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-f34ef676=\"\">\n          <h5 _v-f34ef676=\"\">{{formMessage.msg}}</h5>\n        </div>\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-f34ef676=\"\">\n          <h5 _v-f34ef676=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-f34ef676=\"\">\n      <div v-bind:class=\"md12col\" _v-f34ef676=\"\">\n        <!-- Title -->\n        <div v-bind:class=\"formGroup\" _v-f34ef676=\"\">\n          <label _v-f34ef676=\"\">\n            Title <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-f34ef676=\"\"></span>\n            <p class=\"help-text\" id=\"title-helptext\" _v-f34ef676=\"\">({{titleChars}} characters left)</p>\n          </label>\n          <input v-model=\"record.title\" class=\"form-control\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" name=\"title\" type=\"text\" _v-f34ef676=\"\">\n          <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-f34ef676=\"\">{{formErrors.title}}</p>\n        </div>\n      </div>\n    </div>\n    <div class=\"row\" _v-f34ef676=\"\">\n      <div v-bind:class=\"md12col\" _v-f34ef676=\"\">\n        <!-- URL -->\n        <div v-bind:class=\"formGroup\" _v-f34ef676=\"\">\n          <label _v-f34ef676=\"\">URL <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-f34ef676=\"\"></span></label>\n          <div class=\"input-group\" _v-f34ef676=\"\">\n            <span class=\"input-group-addon\" _v-f34ef676=\"\">http://</span>\n            <input v-model=\"record.url\" class=\"form-control\" v-bind:class=\"[formErrors.url ? 'invalid-input' : '']\" name=\"url\" type=\"text\" _v-f34ef676=\"\">\n          </div>\n          <p v-if=\"formErrors.url\" class=\"help-text invalid\" _v-f34ef676=\"\">{{formErrors.url}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-f34ef676=\"\">\n      <div v-bind:class=\"md6col\" _v-f34ef676=\"\">\n        <div v-bind:class=\"formGroup\" _v-f34ef676=\"\">\n          <label _v-f34ef676=\"\">Source Name: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-f34ef676=\"\"></span></label>\n          <input v-model=\"record.source\" class=\"form-control\" v-bind:class=\"[formErrors.source ? 'invalid-input' : '']\" type=\"text\" :value=\"record.source\" _v-f34ef676=\"\">\n          <p v-if=\"formErrors.source\" class=\"help-text invalid\" _v-f34ef676=\"\">Need a source</p>\n        </div> <!--form-group -->\n      </div> <!-- /.small-6 columns -->\n      <div v-bind:class=\"md6col\" _v-f34ef676=\"\">\n        <div v-bind:class=\"formGroup\" _v-f34ef676=\"\">\n          <label for=\"start-date\" _v-f34ef676=\"\">Highlight Date: <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-f34ef676=\"\"></span></label>\n          <input id=\"start-date\" class=\"form-control\" v-bind:class=\"[formErrors.start_date ? 'invalid-input' : '']\" type=\"text\" v-model=\"record.start_date\" _v-f34ef676=\"\">\n          <p v-if=\"formErrors.start_date\" class=\"help-text invalid\" _v-f34ef676=\"\">Need a highlight date</p>\n        </div> <!--form-group -->\n      </div> <!-- /.small-6 columns -->\n    </div> <!-- /.row -->\n    <div class=\"row\" _v-f34ef676=\"\">\n      <div class=\"col-md-6\" _v-f34ef676=\"\">\n        <div class=\"form-group\" _v-f34ef676=\"\">\n          <label for=\"tags\" _v-f34ef676=\"\">Tags:</label>\n            <v-select :class=\"[formErrors.tags ? 'invalid-input' : '']\" :value.sync=\"record.tags\" :options=\"taglist\" :multiple=\"true\" placeholder=\"Select tags\" label=\"name\" _v-f34ef676=\"\">\n          </v-select>\n        </div><!-- /.form-group -->\n      </div><!-- /.small-6 columns -->\n      <div class=\"col-sm-6\" _v-f34ef676=\"\">\n          <label style=\"visibility:hidden\" _v-f34ef676=\"\">Add unlisted tag</label>\n          <div class=\"input-group\" :class=\"successFailure\" _v-f34ef676=\"\">\n            <span class=\"input-group-btn\" _v-f34ef676=\"\">\n              <button class=\"btn btn-primary\" type=\"button\" @click.prevent=\"toggleAddTag\" _v-f34ef676=\"\">{{ showAddTag ? 'Hide me' : 'Add unlisted tag' }}</button>\n            </span>\n            <input v-show=\"showAddTag\" type=\"text\" v-model=\"newTag\" class=\"form-control\" placeholder=\"new tag name goes here\" _v-f34ef676=\"\">\n            <span v-show=\"showAddTag\" class=\"input-group-btn\" _v-f34ef676=\"\">\n              <button class=\"btn btn-default\" type=\"button\" @click.prevent=\"saveNewTag\" _v-f34ef676=\"\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\" _v-f34ef676=\"\"></i></button>\n            </span>\n          </div><!-- /input-group -->\n          <p v-show=\"showAddTag &amp;&amp; formErrors.name\" class=\"help-text invalid\" _v-f34ef676=\"\">{{ formErrors.name }}</p>\n          <p v-show=\"showAddTag &amp;&amp; formSuccess.tags\" class=\"help-text valid\" _v-f34ef676=\"\">{{ formSuccess.tags }}</p>\n      </div><!-- /.small-6 columns -->\n    </div> <!-- /.row -->\n    <div class=\"row\" _v-f34ef676=\"\">\n      <div v-bind:class=\"md12col\" _v-f34ef676=\"\">\n        <div v-bind:class=\"formGroup\" _v-f34ef676=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-f34ef676=\"\">{{submitBtnLabel}}</button>\n        </div>\n      </div>\n    </div>\n\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f34ef676", module.exports)
  } else {
    hotAPI.update("_v-f34ef676", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
