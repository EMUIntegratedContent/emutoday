...
module.exports = {
  ...
  methods: {
    ...
    fetchCurrentTags: function fetchCurrentTags() {
      ...
      this.$http.get('/api/mediahighlights/' + this.recordid + '/tags').then(function (response) {
        _this4.$set('tags', response.data);
      }, function (response) {
...
},{"./components/MediahighlightForm.vue":110,"vue":108,"vue-resource":106}]},{},[111]);
