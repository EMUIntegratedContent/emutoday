...
var __vueify_style__ = __vueify_insert__.insert("\n.row[_v-6d25b2a0]{\n    padding: 5px 0px 5px 0px;\n}\n.list-row[_v-6d25b2a0]{\n    padding: 10px;\n    border: 1px solid #eeeeee;\n}\n.list-row h4[_v-6d25b2a0]{\n    padding: 10px;\n    background: #eeeeee;\n}\n.nofields[_v-6d25b2a0]{\n    padding: 10px;\n    font-style: italic;\n}\n#policies-container[_v-6d25b2a0]{\n    height: 175px;\n    overflow: scroll;\n    padding: 16px;\n    background: #eeeeee;\n    border: 1px solid #999999;\n    margin: 10px;\n}\n#honeypot[_v-6d25b2a0]{\n    display: none;\n}\n.redBtn[_v-6d25b2a0] {\n  background: hsl(0, 90%, 70%);\n}\np[_v-6d25b2a0] {\n  margin: 0;\n}\n\nlabel[_v-6d25b2a0] {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  display: block;\n  /*margin-bottom: 1.5em;*/\n}\n\nlabel > span[_v-6d25b2a0] {\n  display: inline-block;\n  /*width: 8em;*/\n  vertical-align: top;\n}\n\n.valid-titleField[_v-6d25b2a0] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.no-input[_v-6d25b2a0] {\n  background-color: #fefefe;\n  border-color: #cacaca;\n}\n\n.invalid-input[_v-6d25b2a0] {\n  background-color: rgba(236, 88, 64, 0.1);\n  border: 1px dotted red;\n}\n\n.invalid[_v-6d25b2a0] {\n  color: #ff0000;\n}\n\nfieldset label.radiobtns[_v-6d25b2a0] {\n  display: inline;\n  margin: 4px;\n  padding: 2px;\n}\n\n.reqstar[_v-6d25b2a0] {\n  font-size: .6rem;\n  color: #E33100;\n  vertical-align: text-top;\n}\n\nbutton.button-primary[_v-6d25b2a0] {\n  margin-top: 0.8rem;\n}\n\nselect[_v-6d25b2a0] {\n  margin: 0;\n}\n\n[type='submit'][_v-6d25b2a0],\n[type='button'][_v-6d25b2a0] {\n  margin-top: 0;\n}\n\ninput[type=\"number\"][_v-6d25b2a0] {\n  margin: 0;\n}\n\ninput[type=\"text\"][_v-6d25b2a0] {\n  margin: 0;\n}\n\nh5.form-control[_v-6d25b2a0] {\n  margin: 0;\n  display: block;\n  width: 100%;\n  height: 2.4375rem;\n  padding: .5rem;\n  font-size: 14px;\n  line-height: 1.42857143;\n  color: #222222;\n  background-color: #fff;\n  background-image: none;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;\n}\n")
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form v-show=\"!recordexists\" _v-6d25b2a0=\"\">\n    <slot name=\"csrf\" _v-6d25b2a0=\"\"></slot>\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <div v-show=\"formMessage.isErr\" :class=\"calloutFail\" _v-6d25b2a0=\"\">\n          <h5 _v-6d25b2a0=\"\">There are errors.</h5>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Expert -->\n        <div v-if=\"this.expertListError != ''\" _v-6d25b2a0=\"\">\n            {{ this.expertListError }}\n        </div>\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Expert <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <select v-model=\"record.expert_id\" v-bind:class=\"[formErrors.expert_id ? 'invalid-input' : '']\" name=\"expert_id\" _v-6d25b2a0=\"\">\n              <option v-for=\"expert in experts\" value=\"{{ expert.id }}\" _v-6d25b2a0=\"\">{{ expert.last_name }}, {{ expert.first_name}}</option>\n          </select>\n          <p v-if=\"formErrors.expert_id\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.expert_id}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Organization Name -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Name of your organization <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.organization\" class=\"form-control\" v-bind:class=\"[formErrors.organization ? 'invalid-input' : '']\" name=\"organization\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.organization\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.organization}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Organization Description -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Describe your organization</label>\n          <textarea v-model=\"record.org_description\" class=\"form-control\" v-bind:class=\"[formErrors.org_description ? 'invalid-input' : '']\" name=\"org_description\" _v-6d25b2a0=\"\"></textarea>\n          <p v-if=\"formErrors.org_description\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.org_description}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Your organization's website -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Your organization's website</label>\n          <input v-model=\"record.org_website\" class=\"form-control\" v-bind:class=\"[formErrors.org_website ? 'invalid-input' : '']\" name=\"org_website\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.org_website\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.org_website}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md4col\" _v-6d25b2a0=\"\">\n        <!-- Contact Name -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Contact Name <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.contact_name\" class=\"form-control\" v-bind:class=\"[formErrors.contact_name ? 'invalid-input' : '']\" name=\"contact_name\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.contact_name\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.contact_name}}</p>\n        </div>\n      </div>\n      <div v-bind:class=\"md4col\" _v-6d25b2a0=\"\">\n        <!-- Contact Phone -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Contact Phone <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.contact_phone\" class=\"form-control\" v-bind:class=\"[formErrors.contact_phone ? 'invalid-input' : '']\" name=\"contact_phone\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.contact_phone\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.contact_phone}}</p>\n        </div>\n      </div>\n      <div v-bind:class=\"md4col\" _v-6d25b2a0=\"\">\n        <!-- Contact Phone -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Contact Email <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.contact_email\" class=\"form-control\" v-bind:class=\"[formErrors.contact_email ? 'invalid-input' : '']\" name=\"contact_email\" type=\"email\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.contact_email\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.contact_email}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Speaking date -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">When do you need the speaker?  <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.time_needed\" class=\"form-control\" v-bind:class=\"[formErrors.time_needed ? 'invalid-input' : '']\" name=\"time_needed\" id=\"time_needed\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.time_needed\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.time_needed}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Length -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Length of presentation <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.length_of_presentation\" class=\"form-control\" v-bind:class=\"[formErrors.length_of_presentation ? 'invalid-input' : '']\" name=\"length_of_presentation\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.length_of_presentation\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.length_of_presentation}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Event location -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Event location <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.location\" class=\"form-control\" v-bind:class=\"[formErrors.location ? 'invalid-input' : '']\" name=\"location\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.location\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.location}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Deadline -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Describe event</label>\n          <textarea v-model=\"record.event_description\" class=\"form-control\" v-bind:class=\"[formErrors.event_description ? 'invalid-input' : '']\" name=\"event_description\" _v-6d25b2a0=\"\"></textarea>\n          <p v-if=\"formErrors.event_description\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.event_description}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <!-- Topic -->\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <label _v-6d25b2a0=\"\">Preferred lecture topic <span v-bind:class=\"iconStar\" class=\"reqstar\" _v-6d25b2a0=\"\">*</span></label>\n          <input v-model=\"record.topic\" class=\"form-control\" v-bind:class=\"[formErrors.topic ? 'invalid-input' : '']\" name=\"topic\" type=\"text\" _v-6d25b2a0=\"\">\n          <p v-if=\"formErrors.topic\" class=\"help-text invalid\" _v-6d25b2a0=\"\">{{formErrors.topic}}</p>\n        </div>\n      </div>\n      <!-- /.small-12 columns -->\n    </div>\n    <!-- /.row -->\n    <div class=\"row\" _v-6d25b2a0=\"\">\n      <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n        <div v-bind:class=\"formGroup\" _v-6d25b2a0=\"\">\n          <button v-on:click=\"submitForm\" type=\"submit\" v-bind:class=\"btnPrimary\" _v-6d25b2a0=\"\">Send Request</button>\n          <input v-model=\"record.honeypot\" class=\"form-control\" v-bind:class=\"[formErrors.honeypot ? 'invalid-input' : '']\" name=\"honeypot\" type=\"text\" id=\"honeypot\" _v-6d25b2a0=\"\">\n        </div>\n      </div>\n    </div>\n    <!-- /.row -->\n</form>\n    <div class=\"row\" v-show=\"recordexists\" _v-6d25b2a0=\"\">\n        <div v-bind:class=\"md12col\" _v-6d25b2a0=\"\">\n            <div v-show=\"formMessage.isOk\" :class=\"calloutSuccess\" _v-6d25b2a0=\"\">\n              <h5 _v-6d25b2a0=\"\">{{formMessage.msg}}</h5>\n            </div>\n            <p _v-6d25b2a0=\"\"><strong _v-6d25b2a0=\"\">Here are the details of your submission.</strong></p>\n            <ul _v-6d25b2a0=\"\">\n                <li _v-6d25b2a0=\"\">\n                    Expert: {{ selectedExpert.first_name }} {{ selectedExpert.last_name }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Organization: {{ record.organization }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Organization Description: {{ record.org_description }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Organization Website: {{ record.org_website }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Contact Name: {{ record.contact_name }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Contact Phone: {{ record.contact_phone }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Contact Email: {{ record.contact_email }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Date of Event: {{ record.time_needed }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Length of Presentation: {{ record.length_of_presentation }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    EventDescription: {{ record.event_description }}\n                </li>\n                <li _v-6d25b2a0=\"\">\n                    Topic: {{ record.topic }}\n                </li>\n            </ul>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6d25b2a0", module.exports)
  } else {
    hotAPI.update("_v-6d25b2a0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
