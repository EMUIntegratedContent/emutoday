...
Route::group(['prefix' => 'externalapi'], function(){
    ...
    Route::get('eventsprevnext/{limit?}/{referenceDate?}/{previous?}/{miniCalendar?}', 'Api\ExternalApiController@getPrevNextEvents');
    Route::get('eventsbydates/{limit?}/{referenceDate?}/{previous?}/{miniCalendar?}/{includeSelectedDate?}', 'Api\ExternalApiController@getEventsByDates');
