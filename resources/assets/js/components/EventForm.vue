	...
	<form>
		...
		<div class="row">
			<div v-bind:class="md12col">
				...
				<div v-if="record.is_archived == 1" :class="calloutFail">
					<h5>
						This event is archived because it ended more than two years ago. It
						will no longer display publicly.
					</h5>
				</div>
				<div class="form-group">
					<label>Title <span :class="iconStar" class="reqstar"></span></label>
					<p class="help-text" id="title-helptext">
						Please enter a title ({{ titleChars }} characters left)
					</p>
					<input
						v-model="record.title"
						class="form-control"
						:class="[formErrors.title ? 'invalid-input' : '']"
						name="title"
						type="text"
						maxlength="80"
						autofocus
					/>
					<p v-if="formErrors.title" class="help-text invalid">
		...
		<div class="row">
			<div :class="md12col">
				<div :class="formGroup">
					<label
						>Description <span :class="iconStar" class="reqstar"></span>
						<p class="help-text" id="description-helptext">
							({{ descriptionChars }} characters left)
						</p></label
					>
					<textarea
						...
						maxlength="255"
					></textarea>
					<p v-if="formErrors.description" class="help-text invalid">
						Need a Description!
					</p>
				</div>
			</div>
			...
			<div :class="md12col">
				<template v-if="isOnCampus">
					<div class="row">
						...
						<div :class="md4col">
							...
							<input
								v-model="record.room"
								:class="[formErrors.room ? 'invalid-input' : '']"
								name="room"
								type="text"
								class="mockh5"
								maxlength="80"
				...
				<div class="row">
					<div :class="md12col">
						<template v-if="isOnCampus">
							<label
								>Location <span :class="iconStar" class="reqstar"></span
							></label>
							<input
						...
						<template v-else>
							...
							></label>
							<input
								v-model="record.locationoffcampus"
								class="form-control"
								:class="[formErrors.location ? 'invalid-input' : '']"
								name="location"
								type="text"
		...
		<div class="row">
			<div :class="md6col">
				<div class="form-group">
					<label
						>Start Date: <span :class="iconStar" class="reqstar"></span>
						<flatpickr
					...
					<p v-if="formErrors.start_date" class="help-text invalid">
						Need a Start Date
					</p>
				</div>
				<!--form-group -->
			...
			<div :class="md6col">
				<div class="form-group">
					<label
						>End Date: <span :class="iconStar" class="reqstar"></span>
						<flatpickr
					...
					<p v-if="formErrors.end_date" class="help-text invalid">
						Need an End Date
					</p>
				</div>
				<!--form-group -->
		...
		<div class="row">
			<div :class="md6col">
				<div v-if="hasStartTime" class="form-group">
					<label
						>Start Time: <span :class="iconStar" class="reqstar"></span>
						<flatpickr
					...
					<p v-if="formErrors.start_time" class="help-text invalid">
						Need a Start Time
					</p>
				</div>
				<!-- /.form-group -->
			...
			<div :class="md6col">
				<div v-if="hasEndTime" class="form-group">
					<label
						>End Time: <span :class="iconStar" class="reqstar"></span>
						<flatpickr
					...
					<p v-if="formErrors.end_time" class="help-text invalid">
						Need an End Time
					</p>
				</div>
				<!-- /.form-group -->
		...
		<div class="row">
			<div :class="md12col">
				<div class="form-group">
					<label
						>Categories: <span :class="iconStar" class="reqstar"></span
					></label>
					<v-select
		...
		<div class="row">
			<div :class="md6col">
				<div class="form-group">
					<label
						>Contact Person: <span :class="iconStar" class="reqstar"></span
						><em>(Jane Doe)</em></label
					>
					<input
						v-model="record.contact_person"
						class="form-control"
						:class="[formErrors.contact_person ? 'invalid-input' : '']"
						name="contact-person"
						type="text"
						maxlength="80"
					/>
					<p v-if="formErrors.contact_person" class="help-text invalid">
			...
			<div :class="md6col">
				<div class="form-group">
					<label
						>Contact Email: <span :class="iconStar" class="reqstar"></span
						><em>(ex.janedoe@emich.edu)</em></label
					>
					<input
						v-model="record.contact_email"
						class="form-control"
						:class="[formErrors.contact_email ? 'invalid-input' : '']"
						name="contact-email"
						type="text"
						maxlength="80"
					/>
					<p v-if="formErrors.contact_email" class="help-text invalid">
		...
		<div class="row">
			<div :class="md6col">
				<div class="form-group">
					<label
						>Contact Phone: <span :class="iconStar" class="reqstar"></span>
						<em>(ex. 734.487.1849)</em>
						<input
							v-model="record.contact_phone"
							class="form-control"
							:class="[formErrors.contact_phone ? 'invalid-input' : '']"
							name="contact-phone"
							type="text"
							maxlength="80"
						/>
						<p v-if="formErrors.contact_phone" class="help-text invalid">
							Need a Contact Phone!
						</p>
					</label>
				</div>
			</div>
			...
			<div :class="md6col">
				<div class="form-group">
					<label
						>Contact Fax: <em>(ex. 734.487.1849)</em>
						<input
							v-model="record.contact_fax"
							class="form-control"
							:class="[formErrors.contact_fax ? 'invalid-input' : '']"
							name="contact-fax"
							type="text"
							maxlength="80"
						/>
		...
		<div class="row">
			<div :class="md12col">
				<div v-bind:class="formGroup">
					...
					<p class="help-text" id="title-helptext-2">
						Please enter the url for your related web page. (ex.
						www.yourlink.com)
					</p>
					<div class="input-group input-group-flat">
						<span :class="inputGroupLabel">http://</span>
						<input
							v-model="record.related_link_1"
							class="form-control"
							v-bind:class="[formErrors.related_link_1 ? 'invalid-input' : '']"
							name="related_link_1"
							type="text"
							maxlength="255"
						/>
					</div>
					<p v-if="formErrors.related_link_1" class="help-text invalid">
						Please make sure url is properly formed.
					</p>
				</div>
			</div>
			<!-- /.col-md-4 -->
		...
		<div class="row" v-if="record.related_link_1">
			<div :class="md4col">
				<div v-bind:class="formGroup">
					<label
						>Descriptive text for link.<span
							:class="iconStar"
							class="reqstar"
						></span
					></label>
					<p class="help-text" id="link_txt-helptext">
						(ex. The event webpage)
					</p>
					<input
						v-model="record.related_link_1_txt"
						class="form-control"
						v-bind:class="[
							formErrors.related_link_1_txt ? 'invalid-input' : ''
						]"
						name="related_link_1_txt"
						type="text"
						maxlength="80"
					/>
					<p v-if="formErrors.related_link_1_txt" class="help-text invalid">
			...
			<div :class="md8col">
				<div v-bind:class="formGroup">
					...
					<h5 class="form-control">
						...
						<a href="#"> {{ record.related_link_1_txt }}</a
						>.
					</h5>
				</div>
			</div>
		...
		<template v-if="record.related_link_1 && record.related_link_1_txt">
			<div class="row">
				<div :class="md12col">
					<div v-bind:class="formGroup">
						<label>Related Link</label>
						<p class="help-text" id="title-helptext-3">
							Please enter the url for your related web page. (ex.
							www.yourlink.com)
						</p>
						<div class="input-group input-group-flat">
							<span :class="inputGroupLabel">http://</span>
							<input
								v-model="record.related_link_2"
								class="form-control"
								v-bind:class="[
									formErrors.related_link_2 ? 'invalid-input' : ''
								]"
								name="related_link_2"
								type="text"
								maxlength="255"
						...
						<p v-if="formErrors.related_link_2" class="help-text invalid">
							Please make sure url is properly formed.
						</p>
					</div>
				</div>
			...
			<div class="row" v-if="record.related_link_2">
				<div :class="md4col">
					<div v-bind:class="formGroup">
						<label
							...
							></span
						></label>
						<p class="help-text" id="link_txt-helptext-2">
							(ex. The event webpage)
						</p>
						<input
							v-model="record.related_link_2_txt"
							class="form-control"
							v-bind:class="[
								formErrors.related_link_2_txt ? 'invalid-input' : ''
							]"
							name="related_link_2_txt"
							type="text"
							maxlength="80"
						/>
						<p v-if="formErrors.related_link_2_txt" class="help-text invalid">
							Please include a descriptive text for your related link.
						</p>
					</div>
				</div>
				...
				<div :class="md8col">
					<div v-bind:class="formGroup">
						...
						<h5 class="form-control">
							For more information, visit:
							<a href="#"> {{ record.related_link_2_txt }}</a
							>.
						</h5>
					</div>
				</div>
		...
		<template v-if="record.related_link_2 && record.related_link_2_txt">
			<div class="row">
				<div :class="md12col">
					<div v-bind:class="formGroup">
						<label>Related Link</label>
						<p class="help-text" id="title-helptext-4">
							Please enter the url for your related web page. (ex.
							www.yourlink.com)
						</p>
						<div class="input-group input-group-flat">
							<span :class="inputGroupLabel">http://</span>
							<input
								v-model="record.related_link_3"
								class="form-control"
								v-bind:class="[
									formErrors.related_link_3 ? 'invalid-input' : ''
								]"
								name="related_link_3"
								type="text"
								maxlength="255"
						...
						<p v-if="formErrors.related_link_3" class="help-text invalid">
							Please make sure url is properly formed.
						</p>
					</div>
				</div>
			...
			<div class="row" v-if="record.related_link_3">
				<div :class="md4col">
					<div v-bind:class="formGroup">
						<label
							...
							></span
						></label>
						<p class="help-text" id="link_txt-helptext-3">
							(ex. The event webpage)
						</p>
						<input
							v-model="record.related_link_3_txt"
							class="form-control"
							v-bind:class="[
								formErrors.related_link_3_txt ? 'invalid-input' : ''
							]"
							name="related_link_3_txt"
							type="text"
							maxlength="80"
						/>
						<p v-if="formErrors.related_link_3_txt" class="help-text invalid">
							Please include a descriptive text for your related link.
						</p>
					</div>
				</div>
				...
				<div :class="md8col">
					<div v-bind:class="formGroup">
						...
						<h5 class="form-control">
							For more information, visit:
							<a href="#"> {{ record.related_link_3_txt }}</a
							>.
						</h5>
					</div>
				</div>
		...
		<div class="row">
			<div :class="md12col">
				<div class="row">
					...
					<div :class="md10col">
						<label
							>Event Cost <span :class="iconStar" class="reqstar"></span
						></label>
		...
		<div class="row">
			<div :class="md12col">
				<div :class="formGroup">
					...
					<template
						v-if="record.tickets == 'online' || record.tickets == 'all'"
					>
						<label
							>Link: <em>(ex. http://www.emich.edu/calendar)</em>
							<input
								v-model="record.ticket_details_online"
								class="form-control"
								:class="[
									formErrors.ticket_details_online ? 'invalid-input' : ''
								]"
								name="ticket-details-online"
								type="text"
							/>
						</label>
					</template>
					<template v-if="record.tickets == 'phone' || record.tickets == 'all'">
						<label
							>Tickets by Phone <em>(ex. 734.487.1849)</em>
							<input
								v-model="record.ticket_details_phone"
								class="form-control"
								:class="[
									formErrors.ticket_details_phone ? 'invalid-input' : ''
								]"
								name="ticket-details-phone"
								type="text"
							/>
						</label>
					</template>
					<template
						v-if="record.tickets == 'office' || record.tickets == 'all'"
					>
						<label
							>Address
							<input
								v-model="record.ticket_details_office"
								class="form-control"
								:class="[
									formErrors.ticket_details_office ? 'invalid-input' : ''
								]"
								name="ticket-details-office"
								type="text"
							/>
						</label>
					</template>
					<template v-if="record.tickets == 'other'">
						<label
							>Other
							<input
								v-model="record.ticket_details_other"
								class="form-control"
								:class="[
									formErrors.ticket_details_other ? 'invalid-input' : ''
								]"
								name="ticket-details-other"
								type="text"
							/>
						</label>
					</template>
		...
		<div class="row">
			<div :class="md6col">
				<div :class="formGroup">
					<label for="lbc-approved"
						>This event is approved for LBC
						<input
							id="lbc-approved"
							name="lbc-approved"
							type="checkbox"
		...
		<!-- /.row -->
		<div class="row">
			<div :class="md12col"></div>
			<!-- /.md12col -->
			<div :class="md12col">
				<label
					>Select your department's mini calendar(s)
					<v-select
						id="minical"
			...
			<div v-if="isadmin" :class="md4col">
				<div class="checkbox">
					<label
						><input
							type="checkbox"
							v-model="record.admin_pre_approved"
							:true-value="1"
							:false-value="0"
						/>Auto Approve</label
					>
				...
				<div class="checkbox">
					<label
						><input
							type="checkbox"
							v-model="record.is_hidden"
							:true-value="1"
							:false-value="0"
						/>Hide from EMU Today Calendar (will still show on mini calendars,
						if applicable)</label
					>
				</div>
			</div>
			<div :class="md8col">
				<div :class="formGroup">
					<button
						...
						type="submit"
						v-bind:class="btnPrimary"
					>
						{{ submitBtnLabel }}
					</button>
					<button
						v-if="thisRecordExists"
						id="btn-clone"
						v-on:click="cloneEvent"
						type="submit"
						v-bind:class="btnPrimary"
					>
						Clone Event
...
export default {
	...
	computed: {
		...
		hasEndTime: function () {
			return this.record.all_day == 1 || this.record.no_end_time == 1
				? false
				: true
		},
		isAdmin: function () {
	...
	methods: {
		...
		submitForm: function (e, doClone) {
			...
			this.record.minicals = this.record.minicalendars
				? this.record.minicalendars
				: null

			let method = !this.record.id || doClone === true ? "post" : "put"
			let route =
				!this.record.id || doClone === true
					? "/api/event"
					: "/api/event/" + this.record.id
