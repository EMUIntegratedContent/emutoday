...
module.exports  = {
  ...
  ready() {
      ...
      var end_datetime = moment(this.calendarDate(this.item.end_date) + ' ' + '13:00').format("YYYY-MM-DD HH:mm");;
      var start_datetime = moment(this.calendarDate(this.item.start_date) + ' ' + '11:00').format("YYYY-MM-DD HH:mm");
