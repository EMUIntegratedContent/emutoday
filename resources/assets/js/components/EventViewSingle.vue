...
module.exports  = {
  ...
  ready() {
      ...
      var end_datetime = moment(this.calendarDate(this.item.end_date) + 'T13:00:00-04:00').format("YYYY-MM-DD HH:mm:ss");;
      var start_datetime = moment(this.calendarDate(this.item.start_date) + 'T11:00:00-04:00').format("YYYY-MM-DD HH:mm:ss");
