    ...
    <div class="row">
      <div id="calendar-content-bar">
        <div class="medium-9 small-12 columns pull-right">
          ...
          <event-view-content-test :eventid.once="eventid" :elist.sync="eventlist"></event-view-content-test>
        </div>
...
<script>
    ...
    import EventViewContentTest from './EventViewContentTest.vue'
      export default  {
        components: { EventViewSideBar, EventViewContentTest},
