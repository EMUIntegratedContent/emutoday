    ...
    <div id="graybar">
      <div class="calendar-bar row">
        ...
        <div class="medium-6 small-7 columns">
          <h4>Upcoming Events {{ selectedCalendarCategory ? ' - ' + selectedCalendarCategory : '' }}</h4>
        </div>
        <div class="medium-3 small-5 columns">
          <a class="button hollow secondary expanded academic-calednar-button"
             href="https://www.emich.edu/registrar/calendars/">ACADEMIC CALENDAR <i class="fa fa-external-link"
    ...
    <div class="row">
      <div class="large-9 large-push-3 medium-9 medium-push-3 small-12 columns">
        ...
        <div id="annotations">
          ...
          <p>The EMU calendar is maintained by the <a href="https://www.emich.edu/communications">Division of
            Communications</a> and includes events sponsored by University departments and student organizations.</p>
          <p>Eastern Michigan University reserves the right to edit information as necessary for accuracy and
            completeness and to refuse submissions for any reason. Please allow one or two working days for
            approval.</p>
        </div>
      </div>
