  ...
  <div>
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-md-6 col-lg-9">
        ...
        <ul>
          <li>The <strong>featured story</strong> image comes from the
            <mark>emutoday_email</mark>
            image type as defined in the story's admin area.
          </li>
          <li>The <strong>story title</strong> comes from the
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <template v-else>
          <p>There is no featured story set for this email.</p>
        </template>
        <hr/>
        <!-- Date filter -->
        ...
        <p v-if="emailBuilderEmail.mainStories.length >= 1" class="help-text">
          A student email has a single featured story. Remove the current one above to choose a different story.
        </p>
        <div id="email-items">
          <email-story-pod
              pid="email-items"
...
import EmailStoryPod from './StudentEmailStoryPod.vue'
...
export default {
  ...
  methods: {
    ...
    fetchAllRecords: function () {
      ...
      let routeurl = '/api/student-email/stories/main';
