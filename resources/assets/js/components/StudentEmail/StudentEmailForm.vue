      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 text-right">
          <button class="btn btn-success" type="button" @click="submitForm">{{
              newform ? 'Create Student Email' : 'Update Student Email'
            }}
          </button>
          &nbsp;
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="step-1">
            ...
            <div v-if="emailBuilderEmail.clone.length > 0" class="alert alert-info alert-dismissible">
              <p>This email was cloned from <a :href="'/admin/studentemail/'+ emailBuilderEmail.clone[0].id +'/edit'">this
                email</a> on
          ...
          <div class="tab-pane" id="step-2">
            <div class="row">
              ...
              <div v-bind:class="[md12col, lg5col]">
                <h2>Build Your Student Email</h2>
                <!-- Nav tabs -->
                <ul class="nav nav-tabs" role="tablist">
                  <li :class="{ 'active' : activeSubTab === 1 }"><a href="#main-story" role="tab" data-toggle="tab"
                                                                   :class="emailBuilderEmail.mainStories.length != 1 ? 'insufficient' : ''"
                                                                   @click="activeSubTab = 1">Featured
                    Story ({{ emailBuilderEmail.mainStories.length }})</a></li>
                  <li :class="{ 'active' : activeSubTab === 2 }"><a href="#stories" role="tab" data-toggle="tab"
                                                                   ...
                                                                   @click="activeSubTab = 2">More News ({{
                  ...
                  <li :class="{ 'active' : activeSubTab === 4 }"><a href="#events" role="tab" data-toggle="tab"
                                                                   ...
                                                                   @click="activeSubTab = 4">What's Happening at EMU
                  ...
                  <li :class="{ 'active' : activeSubTab === 5 }"><a href="#insidePosts" role="tab" data-toggle="tab"
                                                                   ...
                                                                   @click="activeSubTab = 5">Campus Life
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item"><i
                      :class="emailBuilderEmail.mainStories.length === 1 ? 'fa fa-check-circle fa-3x' : 'fa fa-times-circle fa-3x'"
                      aria-hidden="true"></i> Email
                    {{ emailBuilderEmail.mainStories.length === 1 ? 'has' : 'does not have' }} a featured
                    story.
                  </li>
                  <li class="list-group-item"><i
...
import EmailMainStoriesQueue from './StudentEmailMainStoriesQueue.vue'
import EmailStoryQueue from './StudentEmailStoryQueue.vue'
import { emailMixin } from './email_mixin'
import EmailAnnouncementQueue from './StudentEmailAnnouncementQueue.vue'
import EmailEventQueue from './StudentEmailEventQueue.vue'
import EmailInsideemuPostsQueue from './StudentEmailInsideemuPostsQueue.vue'
import EmailDeleteModal from './StudentEmailDeleteModal.vue'
import EmailStatsModal from './StudentEmailStatsModal.vue'
import EmailCloneModal from './StudentEmailCloneModal.vue'
import EmailLiveView from './StudentEmailLiveView.vue'
...
export default {
  ...
  computed: {
    ...
    progress: function () {
      ...
      let steps = 8 // title, featured, more news, announcements, recipients, schedule, what's happening, campus life
      ...
      this.emailBuilderEmail.mainStories.length === 1 ? progress += stepValue : ''
  ...
  methods: {
    fetchCurrentEmail: function (recid) {
      ...
      this.$http.get('/api/student-email/' + recid + '/edit')
      .then((response) => {
    ...
    fetchRecipientsList: function () {
      this.$http.get('/api/student-email/recipients')
      .then((response) => {
    ...
    nowOnReload: function () {
      let newurl = '/admin/studentemail/' + this.currentRecordId + '/edit';
    ...
    submitForm: function () {
      ...
      let route = (this.existingEmail) ? '/api/student-email/' + this.emailBuilderEmail.id : '/api/student-email';
    ...
    saveUnlistedRecipient: function () {
      let method = 'post'
      let route = '/api/student-email/recipients';
