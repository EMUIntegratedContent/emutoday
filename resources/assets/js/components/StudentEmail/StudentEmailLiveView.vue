                ...
                <td valign="top" class="full-width-image">
                  ...
                  <template v-else>
                    <div
                      ...
                      <p style="position:absolute; left:143px; top:121px; font-size:3rem;">Featured story image here.</p>
                    </div>
                    <h2 style="padding:0 5px" class="insufficient">No featured story set yet.</h2>
                    <p style="padding:0 5px">Select a featured story from the "Featured Story" tab.</p>
                  </template>
                </td>
              </tr>
              <tr>
                <td valign="top">
                  <div>
                    ...
                    <template v-else>
                      <p style="padding:0 5px" class="insufficient">No More News stories set yet. Select at least one from
                        the "More News" tab.</p>
                    </template>
                  </div>
                </td>
              ...
              <tr v-if="!emailBuilderEmail.exclude_insideemu">
                <td valign="middle">
                  <div style="padding-top: 5px;">
                    <h2 class="moveover" style="border-top: 3px double #97D700;"><a href="/insideemu">Campus Life
                      &#10137;</a></h2>
                    ...
                    <template v-else>
                      <p style="padding:5px" class="insufficient">No Campus Life posts set yet. Select at least one from
                        the "Campus Life" tab.</p>
                    </template>
                  </div>
                </td>
              </tr>
                    ...
                    <tr style="border:none; background-color: #333333; color: #ffffff;">
                      <td valign="top" style="padding:5px; border:0; background-color: #333333; color: #ffffff;">
                        <ul style="padding-left: 5px; text-align:center; padding-bottom: 0px; margin-bottom: 0;">
                          ...
                          <li style="display: inline-block; list-style-type:none; padding-right:7px; margin: 0;">
                            <a href="https://www.tiktok.com/@easternmichiganu"><img
                                class="img-circle" alt="TikTok"
                                src="https://www.emich.edu/today/icons/tiktok.png"></a>
                          </li>
                          <li style="display: inline-block; list-style-type:none; padding-right:7px; margin: 0;">
