...
export default {
  ...
  computed: {
    mainStoriesFull: function () {
      ...
      // A student email has a single featured story: grey out other checkboxes once one is set.
      return !this.checked && this.emailBuilderEmail.mainStories.length >= 1 ? true : false
    },
