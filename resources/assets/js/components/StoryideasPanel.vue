    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <ul class="ideapanel-nav-tabs nav nav-tabs">
                <li role="presentation" class="active"><a data-toggle="tab" :href="'#future-' + slugify(storyIdeaType)">Future
                    ({{ paginatedFutureStories ? paginatedFutureStories.length : '0' }})</a></li>
                <li role="presentation"><a data-toggle="tab" :href="'#completed-' + slugify(storyIdeaType)">Completed
                    ({{ paginatedCompletedStories ? paginatedCompletedStories.length : '0' }})</a></li>
                <li role="presentation"><a data-toggle="tab" :href="'#past-' + slugify(storyIdeaType)">Past Due ({{
