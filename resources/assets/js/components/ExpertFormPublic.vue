  ...
  <form>
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div class="checkbox">
          <label><input type="checkbox" :true-value="1" :false-value="0" v-model="record.is_community_speaker">Community
            Speaker</label>
        </div>
        <div class="checkbox">
          <label><input type="checkbox" :true-value="1" :false-value="0" v-model="record.is_media_expert">Media
            Expert</label>
        </div>
      </div>
      <!-- /.small-12 columns -->
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <h4>I will</h4>
        <div class="checkbox">
          <label><input type="checkbox" v-model="record.do_print_interviews" :true-value="1" :false-value="0">Do
            interviews for print media</label>
        </div>
        <div class="checkbox">
          <label><input type="checkbox" v-model="record.do_broadcast_interviews" :true-value="1" :false-value="0">Do
            interviews for broadcast media</label>
        </div>
      </div>
      <!-- /.small-12 columns -->
    </div>
    ...
    <div class="row" v-if="!currentRecordId">
      <div v-bind:class="md12col" id="policies-container">
        ...
        <p>Business dress is appropriate for most speaking engagements. If you are in doubt about what to wear, ask the
          person who requested you as a speaker what would be appropriate.</p>
      </div>
      <!-- /.small-12 columns -->
      <div v-bind:class="md12col">
        <!-- Is approved? -->
        <div v-bind:class="formGroup">
          <label><input type="checkbox" :true-value="1" :false-value="0" v-model="record.accept_policies">I have read
            and accepted the policies <span v-bind:class="iconStar" class="reqstar">*</span></label>
        </div>
