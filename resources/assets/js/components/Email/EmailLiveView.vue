                    ...
                    <table border="0" style="max-width: 100%;" id="emailContainer">
                        <tr height="54px">
                            <td class="full-width-image">
                                <a href="http://www.emich.edu/" style="margin: 0; padding: 0;"><img src="/assets/imgs/email/topsection.png" alt="EMU Today email blast logo" /></a>
                            </td>
                        </tr>
                                                          ...
                                                          <td class="inner">
                                                            <template v-if="email.mainStories[1]">
                                                              <table class="contents">
                                                                  <tr>
                                                                    <!-- -->
                                                                      <td style="text-align:left;"><img class="col-img" :alt="email.mainStories[1].email_images[0].caption" :src="'/imagecache/ddfront/' + email.mainStories[1].email_images[0].filename" />
                                                                      </td>
                                                                  </tr>
                                                                  <tr>
                                                                          <td class="text" style="text-align:left;">
                                                                                  <h3><a :href="email.mainStories[1].full_url">{{ email.mainStories[1].email_images[0].title }}</a></h3>
                                                                                  <p>{{ email.mainStories[1].email_images[0].teaser | truncate '105' }}</p>
                                                                          </td>
                                                                  </tr>
                                                              </table>
                                                            </template>
                                                        ...
                                                        <tr>
                                                            <td class="inner">
                                                              <template v-if="email.mainStories[2]">
                                                                <table class="contents">
                                                                    <tr>
                                                                        <td><img class="col-img" :alt="email.mainStories[2].email_images[0].caption" :src="'/imagecache/ddfront/' + email.mainStories[2].email_images[0].filename" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                            <td class="text">
                                                                                    <h3><a :href="email.mainStories[2].full_url">{{ email.mainStories[2].email_images[0].title }}</a></h3>
                                                                                    <p>{{ email.mainStories[2].email_images[0].teaser | truncate '105' }}</p>
                                                                            </td>
                                                                    </tr>
                                                                </table>
                                                              </template>
                                    ...
                                    <tr style="border:none; background-color: #333333; color: #ffffff;">
                                        <td valign="top" style="padding:5px; border:0; background-color: #333333; color: #ffffff;">
                                            <ul style="padding-left: 5px; text-align:center; padding-bottom: 0px; margin-bottom: 0;">
                                                ...
                                                <li style="display: inline-block; list-style-type:none; padding-right:7px;margin: 0;">
                                                    <a href="https://instagram.com/easternmichigan/"><img class="img-circle" alt="Instagram" src="/assets/imgs/icons/instagram-base-icons-new.png"></a>
                                                </li>
                                                <li style="display: inline-block; list-style-type:none; padding-right:7px;margin: 0;">
