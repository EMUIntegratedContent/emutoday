...
export default {
  ...
  computed: {
    ...
    progress: function () {
      ...
      if (!this.emailBuilderEmail.is_president_included && !this.emailBuilderEmail.exclude_events) {
      ...
      else if (this.emailBuilderEmail.is_president_included && !this.emailBuilderEmail.exclude_events) {
