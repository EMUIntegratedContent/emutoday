  ...
  <form v-if="!recordexists">
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.organization" class="form-control"
                 v-bind:class="[formErrors.organization ? 'invalid-input' : '']" name="organization" type="text">
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <textarea v-model="record.org_description" class="form-control"
                    v-bind:class="[formErrors.org_description ? 'invalid-input' : '']"
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.org_website" class="form-control"
                 v-bind:class="[formErrors.org_website ? 'invalid-input' : '']" name="org_website" type="text">
    ...
    <div class="row">
      <div v-bind:class="md4col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.contact_name" class="form-control"
                 v-bind:class="[formErrors.contact_name ? 'invalid-input' : '']" name="contact_name" type="text">
      ...
      <div v-bind:class="md4col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.contact_phone" class="form-control"
                 v-bind:class="[formErrors.contact_phone ? 'invalid-input' : '']" name="contact_phone" type="text">
      ...
      <div v-bind:class="md4col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.contact_email" class="form-control"
                 v-bind:class="[formErrors.contact_email ? 'invalid-input' : '']" name="contact_email" type="email">
    ...
    <div class="row">
      <div v-bind:class="md12col">
        <!-- Speaking date -->
        <div v-bind:class="formGroup">
          <label for="time_needed">When do you need the speaker? <span v-bind:class="iconStar" class="reqstar">*</span></label>
          <flatpickr
              v-model="record.time_needed"
              id="time_needed"
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.length_of_presentation" class="form-control"
                 v-bind:class="[formErrors.length_of_presentation ? 'invalid-input' : '']" name="length_of_presentation"
                 type="text">
          <p v-if="formErrors.length_of_presentation" class="help-text invalid">
            {{ formErrors.length_of_presentation }}</p>
        </div>
      </div>
      <!-- /.small-12 columns -->
    </div>
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.location" class="form-control"
                 v-bind:class="[formErrors.location ? 'invalid-input' : '']" name="location" type="text">
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <textarea v-model="record.event_description" class="form-control"
                    v-bind:class="[formErrors.event_description ? 'invalid-input' : '']"
    ...
    <div class="row">
      <div v-bind:class="md12col">
        ...
        <div v-bind:class="formGroup">
          ...
          <input v-model="record.topic" class="form-control" v-bind:class="[formErrors.topic ? 'invalid-input' : '']"
...
export default {
  ...
  methods: {
    ...
    submitForm (e) {
      ...
      // Submit form.
      this.$http.post(route, this.record) //
