...
<li class="treeview {{ set_active('admin/email*') }}">
  <a href="#"><i class="fa fa-envelope"></i> <span>Main Email Builder</span></a>
  <ul class="treeview-menu">
...
<li class="treeview {{ set_active('admin/studentemail*') }}">
  <a href="#"><i class="fa fa-envelope"></i> <span>Student Email Builder</span></a>
  <ul class="treeview-menu">
    <li class="{{ set_active('admin/studentemail*') }}"><a href="/admin/studentemail"><i class="fa fa-list"></i> <span>List</span></a></li>
    <li class="{{ set_active('admin/studentemail*') }}"><a href="/admin/studentemail/show"><i class="fa fa-plus-square"></i> <span>Create</span></a></li>
  </ul>
</li>
@endif
