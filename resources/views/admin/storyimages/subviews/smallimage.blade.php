<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <span class="help-block">Describe this image so visually-impaired users can understand it. 11111</span>
        </div>
        ...
        @elseif($storyImage->group == 'article')
            ...
            <div class="form-group">
                ...
                <span class="help-block">Large Bold text limited to a couple of words visible when article is featured on main magazine page and current issue page</span>
            </div>
            <div class="form-group">
                {!! html()->label('Caption/Subtitle', 'caption') !!}
                {!! html()->text('caption')->class('form-control input-sm') !!}
            ...
            <div class="form-group">
                {!! html()->label('External Link (if tagging an article as \'external\')', 'link') !!}
                {!! html()->text('link')->class('form-control input-sm') !!}
                <span class="help-block">Fully qualified URL of the link.</span>
            </div>
            <div class="form-group">
                {!! html()->label('More Text Link', 'moretext') !!}
                {!! html()->text('moretext')->class('form-control input-sm') !!}
            ...
            <div class="form-group">
                ...
                <span class="help-block">Small to Medium size text for brief paragraph about the article on current issue page</span>
            </div>
        ...
        @elseif($storyImage->group == 'external')
            ...
            <div class="form-group">
                ...
                {!! html()->text('link')->class('form-control input-sm') !!}
                <span class="help-block">Fully qualified URL of the YouTube video</span>
            </div>
            <div class="form-group">
