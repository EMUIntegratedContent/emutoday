...
@section('title','The Week at EMU: Students')
...
@endsection
@section('content')
<h1 class="page-header">The Week at EMU: Students — Email Builder</h1>
...
<div class="row">
  <div class="col-xs-8 col-xs-offset-4 text-right">
    <a class="btn btn-info" href="/admin/studentemail/show">+ New Student Email</a>
  </div>
</div>
<h2>Future Emails</h2>
<div class="row">
                            ...
                            @if(isset($emails_notready_current))
                                @foreach($emails_notready_current as $email)
                                    <tr class="{{ $email->present()->emailScheduleStatus }}">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('studentemail.edit', $email->id) }}">
