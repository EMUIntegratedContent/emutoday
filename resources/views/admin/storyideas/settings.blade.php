...
@section('title', 'Story idea email settings')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <div id="vue-emailsettings">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">Story idea email settings</h3>
                  </div>	<!-- /.box-header -->
                  <div class="box-body">
                      <!--<storyideas-settings></storyideas-settings>-->
                  </div><!-- /.box-body -->
                </div><!-- /.box-body -->
            </div><!-- /.box -->
      </div>
...
@section('footer-app')
    @parent
    <!--<script type="text/javascript" src="/js/vue-storyideas-settings.js"></script>-->
@endsection
