  ...
  >
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        {!! html()->select('type', ['bug' => 'bug', 'design' => 'design', 'comment' => 'comment', 'other' => 'other'])->placeholder('Type...') !!}
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        {!! html()->select('priority', ['0' => 'low', '3' => 'medium', '6' => 'high', '9' => 'critical'])->placeholder('Priority...') !!}
      </div>
    </div>
    <!-- /.box-body -->
