<footer id="basebar">
    <section class="lightgrey-section" aria-label="subscribe-area">
        <div class="row">
        ...
        <div class="row">
            <div id="social-links" class="small-12 medium-centered small-centered columns">
                <ul class="social-icons">
                    ...
                    <li><a class="twitter" title="External link to EMU's Twitter page." href="https://www.emich.edu/communications/expertise/social-media//"><span class="visuallyhidden">Twitter</span></a></li>
