        ...
        <tr>
            <td align="center" valign="top">
                <table border="0" width="600" id="emailContainer">
                    <tr>
                        <td style="padding-bottom: 0; position: relative; border-bottom: 3px solid #97D700; display: block;" colspan="2">
                            <a href="http://www.emich.edu/"><img style="position: absolute; padding-bottom: -16px; margin-bottom:-16px; padding-left: 10px;" src="{{ url('/') }}/assets/imgs/email/inline-eastern-email2.png" alt="EMU Today email blast logo" /></a>
                        </td>

                    </tr>
                    <tr valign="top" id="header-row" style="text-align:center">
                        <td colspan="2">
                            <h2 style="padding: 0; margin-left: auto; margin-right: auto; font-size: 30px; font-weight: 600;"><span style="color: #046A38">EMU</span> Today Digest</h2>
                        </td>
                    </tr>
                    {{--
