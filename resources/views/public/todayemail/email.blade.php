                ...
                <table border="0" width="600" id="emailContainer">
                    <tr>
                        <td style="padding-bottom: 0; margin-bottom 0; position: relative; border-bottom: 3px solid #97D700;" colspan="2">
                            <a href="http://www.emich.edu/" style="padding-bottom:0; margin-bottom: 0;"><img style="position: absolute; bottom: 0;  padding-left: 10px;" src="{{ url('/') }}/assets/imgs/email/inline-eastern-email2.png" alt="EMU Today email blast logo" /></a>
                        </td>
