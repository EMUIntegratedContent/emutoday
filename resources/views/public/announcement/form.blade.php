      ...
      <div class="small-12 column">
        ...
        <div class="row">
          <div class="large-6 medium-12 small-12 columns">
            ...
            <div id="vue-announcements" style="margin-bottom: 2rem">
              <announcement-form ref="aform" framework="foundation"
                                 recordexists="{{$announcement->exists ? true: false}}"
                                 editid="{{$announcement->exists ? $announcement->id : null }}">
          ...
          <div class="large-6 medium-12 small-12 columns">
            <div class="row">
              ...
              <div class="small-12 columns" id="preview-container"></div>
              <div class="small-12 columns" id="user-announcement-tables">
                @endsection
                  ...
                  @unless(empty($submitteditems[0]))
                    <div class="row">
                      <div class="small-12 column">
                        ...
                        <table id="user-events-submitted-table"
                  ...
                  @unless(empty($approveditems[0]))
                    <div class="row">
                      <div class="small-12 column">
                        ...
                        <table id="user-events-approved-table"
                               class="table table-bordered table-hover">
                          <thead>
                          <tr>
                            <th class="text-left">Title</th>
