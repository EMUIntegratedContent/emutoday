      ...
      <div class="medium-12 column">
        ...
        <div class="row">
          <div class="large-6 medium-12 small-12 columns">
            ...
            <div id="vue-event-form" style="margin-bottom: 2rem;">
              <event-form ref="eform" eventexists="{{$event->exists ? true: false}}"
                          editeventid="{{$event->exists ? $event->id : null }}">
                <input slot="csrf" type="hidden" name="_token" value="{{ csrf_token() }}">
              </event-form>
            </div><!-- /#vue-event-form -->
          </div><!-- /.medium-6 column -->
          <div class="large-6 medium-12 small-12 columns" id="user-events-tables">
            @endsection
